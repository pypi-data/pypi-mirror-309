import time
from variables import machine_configs, show_welcome_banner
from Ruleta import RouletteGame
from blackjack import Blackjack
from higher_lower import HigherOrLowerGame
from tragaperras import SlotMachine
