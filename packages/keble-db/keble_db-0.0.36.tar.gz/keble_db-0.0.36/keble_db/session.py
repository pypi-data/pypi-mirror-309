...
class Db:
    ...
    def get_redis(self) -> Optional[R]:
        ...
        if self._redis_instance is not None: return self._redis_instance
    ...
    def get_mongo(self) -> Optional[MongoClient]:
        ...
        if self._mongo_instance is not None: return self._mongo_instance
    ...
    def get_qdrant_client(self) -> Optional[QdrantClient]:
        ...
        if self._qdrant_instance is not None: return self._qdrant_instance
    ...
    def get_sql_write_client(self) -> Optional[Session]:
        ...
        if self._sql_write_instance is not None: return self._sql_write_instance
    ...
    def get_sql_read_client(self) -> Optional[Session]:
        ...
        if self._sql_read_instance is not None: return self._sql_read_instance
