...
class Db:
    ...
    def get_mongo(self, *, new_instance: bool = True) -> Optional[MongoClient]:
        ...
        if new_instance: return MongoClient(self.__settings.mongo_db_uri, uuidRepresentation="standard")
        if not new_instance and self._mongo_instance is not None: return self._mongo_instance
