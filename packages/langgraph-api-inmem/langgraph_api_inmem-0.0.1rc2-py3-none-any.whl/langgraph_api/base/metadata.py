...
from langgraph_api.base.config import LANGGRAPH_CLOUD_LICENSE_KEY, LANGSMITH_API_KEY
from langgraph_api.base.http import http_request
...
def append_log(log: dict) -> None:
    if not LANGGRAPH_CLOUD_LICENSE_KEY or not LANGSMITH_API_KEY:
        return
