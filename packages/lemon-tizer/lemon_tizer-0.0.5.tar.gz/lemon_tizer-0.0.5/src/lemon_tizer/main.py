...
class LemonTizer:
    ...
    def set_lemma_settings(
        self,
        filter_out_non_alpha: bool = False,
    ...
    def lemmatize_sentence(
        ...
        # Pre-process input. Converting to lower can provide better results with some languages
        ...
        try:
            ...
            # Fail silently, let calling function check for empty
            return [{"": ""}]
