...
# TODO: Move this below to a better place or remove it
...
class MoviepyMovementPath:
    ...
    def __init__(self, positions: list[Union[Position, VideoPosition]]):
        ...
        for position in positions:
            if PythonValidator.is_instance(position, Position):
                ...
                tmp_positions.append(position.as_array())
