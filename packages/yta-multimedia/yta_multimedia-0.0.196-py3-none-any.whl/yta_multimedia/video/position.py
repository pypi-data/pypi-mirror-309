...
from yta_multimedia.video.edition.effect.moviepy import DEFAULT_BACKGROUND_VIDEO
...
class Position(Enum):
    ...
    def as_video_position(self, position: 'Position') -> 'VideoPosition':
        """
        ...
        """
        return Position.to_video_position(position)
    ...
    def to_moviepy_position(position: 'Position'):
        ...
        return position.get_moviepy_position(DEFAULT_BACKGROUND_VIDEO, DEFAULT_BACKGROUND_VIDEO)
