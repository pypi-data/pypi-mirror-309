...
class CoordinateCorner:
    ...
    def to_array(coordinate):
        # TODO: Check if coordinate is 'CoordinateCorner' (?)
    ...
    def as_normalized_coordinate(self, min_value = -10000, max_value = 10000) -> NormalizedCoordinate:
        ...
        """
        return CoordinateCorner.to_normalized_coordinate(self, min_value, max_value)
    ...
    # TODO: Create a 'to_coordinate_center' by receiving a 'video'
    # and a 'video_background', but it will generate a loop if I
    # do the same in CoordinateCenter to this one
