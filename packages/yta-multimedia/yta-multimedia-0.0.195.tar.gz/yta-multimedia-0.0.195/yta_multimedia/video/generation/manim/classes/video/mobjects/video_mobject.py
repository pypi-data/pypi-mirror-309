...
class VideoMobjectTest(ImageMobject):
    ...
    def __init__(self, video, **kwargs):
        ...
        self.frame_number = 0
        self.video = video
        self.filename = VideoFrameExtractor.get_frame_by_frame_number(video, self.frame_number)
    ...
    def frame_by_frame_updater(self, mobj: Mobject, dt):
        ...
        mobj.pixel_array = change_to_rgba_array(
            VideoFrameExtractor.get_frame_by_frame_number(self.video, self.frame_number), mobj.pixel_array_dtype
        )