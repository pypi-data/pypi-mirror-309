...
class ShakeAtPositionMoviepyEffect(BasePositionMoviepyEffect):
    ...
    """
    @classmethod
    def apply(cls, video: VideoClip, position: Union[Position, CoordinateCenter, CoordinateCorner] = Position.RANDOM_INSIDE):
        """
    ...
    @classmethod
    def apply_over_video(cls, video: VideoClip, background_video: Union[str, VideoFileClip, CompositeVideoClip, ImageClip, ColorClip], position: Union[Position, CoordinateCorner, CoordinateCenter] = Position.RANDOM_INSIDE):
        """
