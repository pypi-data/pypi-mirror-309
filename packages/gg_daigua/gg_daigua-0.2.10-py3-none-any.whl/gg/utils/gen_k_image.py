...
from gg.utils.common import ppt_temp01_path, ColorPrinter, delete_file, tmp_dir_path, get_path_str
...
def create_ppt_from_template(image_list, output_pptx_path):
    # 复制模板文件到目标路径
    shutil.copy(ppt_temp01_path, output_pptx_path)
