...
# makemessages
parser_makemessages  = subparsers.add_parser('makemessages ', help='i18N Makemessages ')
parser_makemessages.add_argument("-l")

# compilemessages
parser_compilemessages = subparsers.add_parser('compilemessages', help='i18N Compilemessages')
