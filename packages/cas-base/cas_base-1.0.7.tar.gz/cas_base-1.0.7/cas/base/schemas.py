...
class UserLoginSoftwareOut(BaseModel):
    ...
    software_data_1: str = Field(None, title="扩展数据1")
    software_data_2: str = Field(None, title="扩展数据2")
    software_data_3: str = Field(None, title="扩展数据3")
    software_data_4: str = Field(None, title="扩展数据4")
    software_data_5: str = Field(None, title="扩展数据5")
