...
def display_image_preprocess(extracted_image_path: str, num_patches_per_side:int = 3, index_img = 0, 
                                            crop_list: Dict[str,int] = {'top': 0.05, 'bottom':0.05, 'left':0.05, 'right':0.05}) -> tuple[np.ndarray, List[np.ndarray]]:
...
def plot_processed_image(extracted_image_path: str, num_patches_per_side:int = 3, index_img = 0, 
    ...
    large_image, large_processed_image, small_images = display_image_preprocess(extracted_image_path, num_patches_per_side = num_patches_per_side, crop_list=crop_list, index_img =index_img)
