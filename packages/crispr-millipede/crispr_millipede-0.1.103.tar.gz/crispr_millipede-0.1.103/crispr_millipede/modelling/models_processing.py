            ...
            def retrieve_sample_parameter(parameter_input, experiment_index, replicate_index):
                if type(parameter_input) is list:
                    ...
                    if type(parameter_input[0] is list):
                        ...
                        assert parameter_input[experiment_index] is list, f"{parameter_input[experiment_index]} is not a list with experiment_index={experiment_index} and replicate_index={replicate_index}"
