...
def calculate1(pssm_file, seq_file, positions_file, email, username, password):
    """
    ...
    - api_url (str): URL of the Calculate1 API.
...
if __name__ == "__main__":
    ...
    result_url = calculate1(pssm_file, seq_file, positions_file, email, username, password)
    if result_url:
