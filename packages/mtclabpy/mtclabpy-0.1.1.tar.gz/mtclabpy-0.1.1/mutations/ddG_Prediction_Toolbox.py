...
def thermoDDG(pdb_file_path, chain, email,  username, password,outfile=None):
    """
    ...
    - api_url (str): URL of the ThermoDDG API.
    - username (str): Username for basic authentication.
    - password (str): Password for basic authentication.
    
    Returns:
    - None: The function prints the status of the request and any relevant URLs or error messages.
    """
    ...
    if response.status_code == 200:
        ...
        if result['success']:
            ...
            print(f"Downloaded file saved to: {download_url}")
            return download_url
        else:
...
if __name__ == "__main__":
    ...
    thermoDDG(pdb_file_path, chain, email, username, password,outfile)
