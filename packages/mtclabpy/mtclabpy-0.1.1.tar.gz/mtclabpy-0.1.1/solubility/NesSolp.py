...
def create_chemical_compound_2(fasta_file_path, email, username, password,output_file_name=None):
...
if __name__ == "__main__":
    ...
    result_url = create_chemical_compound_2(fasta_file_path, email, username, password,output_file_name)
    if result_url:
