...
__all__ = [
    ...
    "iterdir_raw", "iterdir", "iter_files", "iter_files_raw", "dict_files", "traverse_files", "iter_dupfiles", 
    "dict_dupfiles", "iter_image_files", "dict_image_files", "iter_dangling_files", "share_extract_payload", 
    ...
    **request_kwargs, 
    ...
    def gen_step():
        ...
        if cid and (refresh or cid not in id_to_dirnode):
            resp = yield client.fs_files_app({"cid": cid, "limit": 16}, async_=async_, **request_kwargs)
            check_response(resp)
    ...
    def gen_step():
        ...
        if i == 1:
            ...
            if j > i:
                ...
                resp = yield client.fs_dir_getid_app(dirname, async_=async_, **request_kwargs)
            ...
            try:
                if cid := get():
                    ...
                    try:
                        ...
                        resp = check_response((yield client.fs_files_app(
                            payload, 
                            async_=async_, 
                            **{
                                **request_kwargs, 
...
def iter_dangling_files(
    ...
    **request_kwargs, 
    ...
    def gen_step():
        ...
        while True:
            resp = yield client.fs_files(payload, app="android", async_=async_, **request_kwargs)
            if cid and int(resp["path"][-1]["cid"]) != cid:
                break
