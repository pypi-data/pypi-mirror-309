...
def sentiment_analysis(text):
    ...
    try:
        ...
        # Extract the predicted emotion and score from the result
        emotion = result[0][0]['label']
        score = result[0][0]['score']
        
        # Create a descriptive sentence
        return f"The model has predicted that this text expresses '{emotion}' with an accuracy of {score:.2%}."
...
# print(sentiment_analysis(texto2))