...
# texto = 'Happiness is always a grand event; it is often found in the small moments of everyday life. It’s the warmth of the sun on your face, the aroma of coffee in the morning, an unexpected laugh that makes you lose track of time, or the comfort of knowing you’re surrounded by love. Happiness lives in the here and now, waiting to be embraced.'
...
# print(text_similarity(texto, texto2, method = 'TF-IDF'))