...
def complete_analyzer(texto_principal, nombre_archivo="resultado_completo.html", language='spanish', mark_text_html="resultado.html", tokenizar=True):
    ...
    try:
        ...
        def mark_key_terms(texto, num_palabras=5, language=language, formato="html", nombre_archivo="resultado.html"):
            """
            ...
            Returns:
            - str: Path to the generated HTML file, with standard slashes (`/`).
            """
            try:
                ...
                for i, oracion in enumerate(oraciones):
                    for palabra, palabra_negrita in palabras_negrita.items():
                        if palabra in oracion.lower() and palabra not in palabras_resaltadas:
