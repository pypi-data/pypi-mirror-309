...
'''
    ...
    $FileInfo: pycatfile.py - Last Update: 11/17/2024 Ver. 0.14.4 RC 1 - Author: cooldude2k $
'''
...
__version_info__ = (0, 14, 4, "RC 1", 1)
__version_date_info__ = (2024, 11, 17, "RC 1", 1)
__version_date__ = str(__version_date_info__[0]) + "." + str(
    __version_date_info__[1]).zfill(2) + "." + str(__version_date_info__[2]).zfill(2)
__revision__ = __version_info__[3]
__revision_id__ = "$Id: a3b73d5aa307fac8e9dcb607ab975d4df22817d5 $"
