...
class InputPage(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.mango_cascade = MangoCascade('多级选择', [CascaderModel(**i) for i in self.cascade_data])
        self.layout.addWidget(self.mango_cascade)

        self.mango_checkbox = MangoCheckBox()
        self.layout.addWidget(self.mango_checkbox)

        self.mango_combobox = MangoComboBox('选择框', [ComboBoxDataModel(**i) for i in self.combo_box_data])
