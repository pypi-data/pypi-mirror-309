...
class AtomPositionOperator:
    ...
    # ====== KDTREE ======
    def self_colition(self, p=2., factor=.5):
        """
        ...
        for index, atom_position in enumerate(self.atomPositions):
            ...
            for cl_i, cl in enumerate(closest_distance[0][1:]):
                ...
                if closest_distance[0][cl_i+1] < (self.covalent_radii[self.atomLabelsList[index_cl]] + self.covalent_radii[self.atomLabelsList[index]]) * factor:
                    return True
