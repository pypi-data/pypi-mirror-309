...
def generate_project_structure():
    ...
    with open("./templates/gitignore_template.py", "r") as f:
        gitignore_content = f.read()
    with open("./templates/main_template.py", "r") as f:
        main_content = f.read()
    with open("./templates/data_base_session_middleware_template.py", "r") as f:
        data_base_session_middleware_content = f.read()
    with open("./templates/token_schema_template.py", "r") as f:
        token_schema_content = f.read()
    with open("./templates/user_model_template.py", "r") as f:
        user_model_content = f.read()
    with open("./templates/user_controller_template.py", "r") as f:
        user_controller_content = f.read()
    with open("./templates/is_authenticated_middleware_template.py", "r") as f:
        is_authenticated_middleware_content = f.read()
    with open("./templates/migration_template.py", "r") as f:
        migration_content = f.read()
    with open("./templates/connection_template.py", "r") as f:
