...
class GetInsertHandlerGraphGraphNameInsertRequestIDGetRequestTypedDict(TypedDict):
    graph_name: Nullable[str]
    request_id: str
    request_time: int


class GetInsertHandlerGraphGraphNameInsertRequestIDGetRequest(BaseModel):
