...
class _DMConfig:
    def __init__(self,
        ...
        self.store_all_dfs = store_all_df
    ...
    def from_setup(cls,
                   ...
                   override_store_all_df:bool = None,
        ...
        _jinja_repo_source = override_jinja_repo_source if override_jinja_repo_source is not None else getattr(_user_setup, 'set_jinja_repo', None)
        _insert_table_type = override_insert_table_type if override_insert_table_type is not None else getattr(_user_setup, 'set_insert_table_type', None)
        _insert_table_name = override_insert_table_name if override_insert_table_name is not None else getattr(_user_setup, 'set_insert_table_name', None)
        _store_all_dfs = override_store_all_df if override_store_all_df is not None else getattr(_user_setup, 'set_store_all_dfs', None)
        _store_base_df = override_store_base_df if override_store_base_df is not None else getattr(_user_setup, 'set_store_base_df', None)
        ...
        if override_default_format_func_dict:
            ...
            if extend_default_format_func_dict:
                raise ValueError("Invalid parameter combination. Can not use override and extend default_format_func_dict together.")
        else:
...
class DataManager:
    ...
    def from_jinja_repo(cls, inner_path: str,
        ...
        Args:
            ...
            store_all_df: If `True`, each `DM.Frame` stores a full DataFrame for both the `df_query` and `df_target`.
    ...
    def from_jinja_repo_preset(cls, inner_path: str,
                        ...
                        setup_path=None) -> Self:

        """
        Behaves the same as [from_jinja_repo][mipi_datamanager.DataManager.from_jinja_repo] except that the optional
        arguments can be globally configured using a [mipi_setup.py file](../home/mipi_setup_py.md).
        ...
        _setup = _DMConfig.from_setup(override_jinja_repo_source, override_store_all_dfs, override_store_base_df,
                                      override_default_format_func_dict,extend_default_format_func_dict,override_insert_table_type, override_insert_table_name,override_dialect,setup_path)
        config = _get_config_from_master(inner_path, _setup.jinja_repo_source)
    ...
    def from_dataframe_preset(cls, df: pd.DataFrame, frame_name: str = None,
        ...
        _setup = _DMConfig.from_setup(override_jinja_repo_source, override_store_all_dfs, override_store_base_df,override_default_format_func_dict,
                                      extend_default_format_func_dict,override_insert_table_type, override_insert_table_name,override_dialect,setup_path)
    ...
    def from_sql_preset(cls, script_path: str, connection: connection.Odbc, format_parameters_list: list = None,
        ...
        _setup = _DMConfig.from_setup(override_jinja_repo_source, override_store_all_dfs, override_store_base_df,
                                      override_default_format_func_dict,extend_default_format_func_dict, override_insert_table_type,
    ...
    def join_from_jinja_repo(self, inner_path: str, how: JoinLiterals = "left", frame_name = None,jinja_parameters_dict: dict = None,
    ...
    def join_from_excel(self, excel_path: str, on: str = None, how: JoinLiterals = "left",excel_sheet: str | int = None, frame_name: str = None,
                         format_func_dict: FormatDict | dict = None,
                        left_on: str | tuple = None, right_on: str | tuple = None,
                        left_index: bool = False, right_index: bool = False):
        """
    ...
    def resolve_dimension_format_sql_string(self, sql: str, key: str, format_parameters_list=None, frame=None,
    ...
    def resolve_dimension_format_sql_file(self, file_path: str, key: str, format_parameters_list=None, frame=None,
                                          rename_columns_dict: dict | None = None) -> str:
        """
