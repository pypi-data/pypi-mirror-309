...
#############################################  pip3.8 install kcweb==6.4.11 -i https://pypi.org/simple
import os,sys
...
confkcw={}
confkcw['name']=kcweb['name']                             #项目的名称 
confkcw['version']=kcweb['version']							#项目版本
confkcw['description']=kcweb['description']       #项目的简单描述
confkcw['long_description']=kcweb['long_description']     #项目详细描述
confkcw['license']=kcweb['license']                    #开源协议   mit开源
confkcw['url']=kcweb['url']
confkcw['author']=kcweb['author']  					 #名字
confkcw['author_email']=kcweb['author_email'] 	     #邮件地址
confkcw['maintainer']=kcweb['maintainer'] 						 #维护人员的名字
confkcw['maintainer_email']=kcweb['maintainer_email']    #维护人员的邮件地址
