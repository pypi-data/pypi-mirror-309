...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, content_guard=None, base_url=None, name=None, base_path=None, pulp_labels=None, prn=None, hidden=False, no_content_change_since=None, pulp_href=None, pulp_created=None, local_vars_configuration=None):  # noqa: E501
