...
@typing.final
class ActiveClusterInfo(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    ZONE_ID_FIELD_NUMBER: builtins.int
    SERVICE_ACCOUNT_ID_FIELD_NUMBER: builtins.int
    CLUSTER_STATUS_FIELD_NUMBER: builtins.int
    cid: builtins.str
    """Unique ID of the Hadoop cluster."""
    folder_id: builtins.str
    """ID of the folder that the Hadoop cluster belongs to."""
    zone_id: builtins.str
    """ID of the availability zone."""
    service_account_id: builtins.str
    """ID of the service account for Dataproc manager agent."""
    cluster_status: global___Cluster.Status.ValueType
    """Cluster status."""
    def __init__(
        self,
        *,
    ...
    def ClearField(self, field_name: typing.Literal["cid", b"cid", "cluster_status", b"cluster_status", "folder_id", b"folder_id", "service_account_id", b"service_account_id", "zone_id", b"zone_id"]) -> None: ...

global___ActiveClusterInfo = ActiveClusterInfo

@typing.final
class Topology(google.protobuf.message.Message):
    """Hadoop cluster topology info."""
    ...
    """Topology revision."""
    folder_id: builtins.str
    """ID of the folder that Topology belongs to."""
    ui_proxy: builtins.bool
    """Whether UI Proxy feature is enabled."""
    service_account_id: builtins.str
    """ID of the service account for Dataproc manager agent."""
    ...
    @property
    def subclusters(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[yandex.cloud.priv.dataproc.v1.subcluster_pb2.TopologySubcluster]:
        """List of Subclusters in Topology."""
    ...
    def __init__(
        ...
        *,
        ...
        subclusters: collections.abc.Iterable[yandex.cloud.priv.dataproc.v1.subcluster_pb2.TopologySubcluster] | None = ...,
        ui_proxy: builtins.bool = ...,
        service_account_id: builtins.str = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["folder_id", b"folder_id", "revision", b"revision", "service_account_id", b"service_account_id", "services", b"services", "subclusters", b"subclusters", "ui_proxy", b"ui_proxy"]) -> None: ...
