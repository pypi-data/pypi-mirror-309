...
class AutoGUI:
    ...
    def search_image(self, image_path: str, click_left: bool = True, clicks: int = 1,
        ...
        self.show_subtitle(f'搜索 {image_path}...')
        ...
        while True:
            ...
            if location:
                ...
                if click_left:
                    ...
                    self.show_subtitle(f'找到 {image_path} 的位置：{location}，点击左键 {clicks} 次...')
                    ...
                    self.show_subtitle(f'找到 {image_path} 的位置：{location}，点击右键 {clicks} 次...')
            ...
            if auto_adjust_to_min_confidence and current_confidence >= auto_adjust_to_min_confidence:
                ...
                self.show_subtitle(f'未找到 {image_path}，降低相似度到 {current_confidence}...')
                continue
    ...
    def wait_for_image_to_appear(self, image_path: str, confidence: float = 0.7, grayscale: bool = False,
        ...
        self.show_subtitle(f'等待图片出现：{image_path}')
        ...
        while True:
            ...
            if location:
                ...
                self.show_subtitle(f'找到图片：{image_path} 位置：{location}')
                return location
    ...
    def wait_for_image_to_disappear(self, image_path: str, confidence: float = 0.6, grayscale: bool = False,
        ...
        self.show_subtitle(f'等待图片消失：{image_path}')
        ...
        while True:
            if not self.get_image_center_pos(image_path, grayscale=grayscale, confidence=confidence, **kwargs):
                ...
                if not self.get_image_center_pos(image_path, grayscale=grayscale, confidence=confidence, **kwargs):
                    ...
                    self.show_subtitle(f'图片已消失：{image_path}')
                    return True
