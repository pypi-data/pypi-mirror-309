...
class ShortIdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            f"For bash commands, ensure they are compatible with {platform.system()}. Use:\n"
            f"```bash\n"
            f"command here # Must be valid for {platform.system()} OS\n"
            f"```\n"
            ...
            f"DO NOT INCLUDE ANY CODE SNIPPETS OR BASH COMMANDS THAT ARE NOT COMPATIBLE WITH {platform.system()}. "
