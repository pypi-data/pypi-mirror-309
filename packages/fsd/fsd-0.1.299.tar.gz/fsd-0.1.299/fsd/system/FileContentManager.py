...
class FileContentManager:
    ...
    async def log_result(cls, result: str):
        ...
        try:
            ...
            logger.info(f"Creating new log file at: {str(log_path)}")
            ...
            logger.info(f"#### Successfully created and wrote to new log file at {full_log_path}")
        except Exception as e:
            logger.error(f"#### Error creating/writing to log file {full_log_path}: {str(e)}")
