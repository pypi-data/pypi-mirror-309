...
class CompileProjectAnalysAgent:
    ...
    def initial_setup(self, dependency_files, OS_architecture):
        ...
        system_prompt = (
            ...
            "   For Windows paths: Use backslashes and enclose paths with spaces in double quotes (e.g. cd \"C:\\Program Files\\MyApp\")\n"
            "   For macOS/Linux paths: Use forward slashes and enclose paths with spaces in single quotes (e.g. cd '/Users/name/My App')\n"
