        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "Rules:\n"
                    "1. Start with 'cd' to project directory as a separate step. For Windows, use backslashes and enclose paths with spaces in double quotes. For macOS/Linux, use forward slashes and enclose paths with spaces in single quotes.\n"
                    ...
                    '    "commits": ""\n'
                    "}\n\n"
                    "Provide only valid JSON. No additional text or Markdown. Include only essential steps. For Windows paths with spaces use double quotes, for macOS/Linux use single quotes."
                )
            },
            {
                "role": "user",
