        ...
        messages = [
            ...
            },
            {
                ...
                "content": f"Create a focused plan to resolve this error:\n\n"
                           ...
                           f"Only include concrete dependency configuration and installation steps needed to resolve the error, such as:\n"
                           f"- Add specific missing dependencies to package.json\n"
                           f"- Add specific missing build/dev scripts to package.json\n" 
                           f"- Add specific missing Vite configuration options\n"
                           f"- Install specific required dependencies\n"
                           f"- Fix specific configuration syntax errors\n\n"
                           f"Do not include generic verification steps or checks. Every step must be an actionable command or configuration change. "
