...
class IdeaDevelopment:
    ...
    async def get_idea_plan(self, user_prompt, original_prompt_language):
        ...
        prompt = (
            ...
            f"IMPORTANT: All commands and operations must be strictly compatible with {platform.system()} OS only:\n"
            f"```bash\n"
            f"# Commands must be 100% valid and tested for {platform.system()} OS\n"
            f"# Do not provide commands for other operating systems\n"
            f"```\n"
            f"IMPORTANT: THIS IS A NO-CODE PLANNING PHASE. DO NOT INCLUDE ANY CODE SNIPPETS OR IMPLEMENTATION DETAILS.\n"
            ...
            f"IMPORTANT: ALL FILE PATHS AND OPERATIONS MUST BE 100% COMPATIBLE WITH {platform.system()} OS.\n"
