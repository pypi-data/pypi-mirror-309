    ...
    async def get_coding_request(self, file, techStack):
        ...
        if is_svg:
            ...
            user_prompt += (
                ...
                "- Ensure proper alignment, spacing and responsive layout\n"
                "- Make interactions smooth and intuitive\n"
                "For logic code:\n"
                "- Follow existing code conventions and use established libraries\n"
                "- Only modify specified parts while preserving overall structure\n"
                "- Maintain function/class names to avoid breaking references\n"
