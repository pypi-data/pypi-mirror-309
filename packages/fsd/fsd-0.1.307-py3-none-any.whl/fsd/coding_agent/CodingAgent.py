...
class CodingAgent:
    ...
    async def get_coding_request(self, file, techStack):
        ...
        user_prompt += f"Implement code for {file_name} according to the development plan, ensuring strict compliance with all file dependencies, integrations, and asset requirements specified in the plan. All changes must maintain perfect compatibility with related files and components:\n"
        ...
        if is_svg:
            ...
            user_prompt += (
                ...
                "- Leverage design patterns and SOLID principles appropriately\n"
                "- Ensure thread-safety and proper resource management\n"
                "- Follow language-specific best practices and idioms\n"
                "- Add input validation and defensive programming\n"
                "- Use proper dependency injection and inversion of control\n"
                "- Implement proper null checks and boundary conditions\n"
                "- Ensure consistent state management and data integrity\n"
                "- Write self-documenting code with clear intent\n"
                "- Follow project's linting rules and code style guidelines\n"
                "- Ensure code passes all linter checks without warnings or errors"
            )
