# NOTE: Generated By AutoRunner v3.1.9
# FROM: request_methods/request_with_variables.yml


from autorunner import AutoRunner, Config, Step, RunRequest, RunTestCase


class TestCaseRequestWithVariables(AutoRunner):
    ...
    teststeps = [
        Step(
            ...
            .with_headers(**{"User-Agent": "AutoRunner/3.0"})
            .extract()
        ...
        Step(
            ...
            .post("/post")
            .with_headers(
                **{"User-Agent": "AutoRunner/3.0", "Content-Type": "text/plain"}
            )
            .with_data(
        ...
        Step(
            ...
            .post("/post")
            .with_headers(
                **{"User-Agent": "AutoRunner/3.0", "Content-Type": "application/json"}
            )
            .with_json("$jsondata")
            .validate()
            .assert_equal("status_code", 200)
