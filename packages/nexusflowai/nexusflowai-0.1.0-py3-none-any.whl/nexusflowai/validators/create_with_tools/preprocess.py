...
from nexusflowai.validators.create_with_tools.utils import ALLOWED_ROLES
...
"""
    ...
    def format_turns(self, messages: List[Any]) -> str:
        ...
        for message in messages:
            ...
            tool_call_id_to_result[message["tool_call_id"]] = json.loads(
                message["content"]
            )
        ...
        for message in shifted_uqs:
            ...
            if message["role"] == "assistant":
                if is_new_assistant_turn:
                    previous_original_plan = message["content"]
                    if is_last_turn:
...
"""
        ...
        missing_tool_call_id_str = "', '".join(tool_call_id_to_result)
        assert (
            not tool_call_id_to_result
        ), f"Invalid parameter: 'tool_call_id' of '{missing_tool_call_id_str}' not found in any 'tool_calls' of previous messages."
