...
class AsyncCompletions(AsyncAPIResource):
    ...
    def batch_create(
        self, batch: List[CompletionCreateParams]
    ) -> List[Union[NexusflowAICompletion, Exception]]:
        """
        Will run the batched prompts in an async manner.
        """
        return batch_call(self.create, batch)

    def batch_create_with_tools(
        self, batch: List[ChatCompletionCreateParams]
    ) -> List[Union[NexusflowAIChatCompletion, Exception]]:
        """
        Will run the batched prompts in an async manner.
        """
        return batch_call(self.create_with_tools, batch)

    def batch_run_prompts(
        self, batch_prompts_str: List[str], params: CompletionCreateParams
        ...
        return self.batch_create(batched_prompts)
