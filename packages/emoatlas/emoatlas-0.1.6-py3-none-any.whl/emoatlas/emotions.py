...
def emo_params(emotion):
    ...
    *angle*:
    ...
    if emotion == "joy":
        ...
        raise Exception(
            """Bad input: {} is not an accepted emotion.
            Must be one of 'joy', 'trust', 'fear', 'surprise', 'sadness', 'disgust', 'anger', 'anticipation'""".format(
                emotion
            )
        )
...
def _petal_spine_emotion(
    ...
    *offset*:
    ...
    if iterable:
        ...
        ax.annotate(
            text="{0:.2f}".format(round(emotion_score[0], 2)),
            xy=p5,
            rotation=angle2,
            ha="center",
            va="center",
        ...
        ax.annotate(
            text="{0:.2f}".format(round(emotion_score[1], 2)),
            xy=p6,
            rotation=angle2,
            ha="center",
            va="center",
        ...
        ax.annotate(
            text="{0:.2f}".format(round(emotion_score[2], 2)),
            xy=p7,
            rotation=angle2,
            ha="center",
            va="center",
        ...
        ax.annotate(
            text="{0:.2f}".format(round(emotion_score, 2)),
            xy=p5,
            rotation=angle2,
            ha="center",
            va="center",
...
def _draw_emotion_petal(
    ...
    *rescale*:
    ...
    if not iterable:
        ...
        label = (
            emotion_score
            if ((show_intensity_levels == "all") or (emotion in show_intensity_levels))
            else length
        )
        ...
        # Draw petal
        petal_shape = _petal_shape_emotion(
            ax,
            length,
            color,
            angle,
