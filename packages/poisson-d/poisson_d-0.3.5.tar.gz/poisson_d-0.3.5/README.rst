...
Usage examples
--------------
* Use poisson_d module, from Grasshoper Python Script Component, to generate points of poisson disk 
...
* Use poisson_d module, from Grasshoper Python Script Component, to generate points of poisson disk on C, M, Y, K channels 
