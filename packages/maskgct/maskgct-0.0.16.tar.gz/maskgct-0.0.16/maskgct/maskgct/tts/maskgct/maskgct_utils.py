...
import numpy as np
import librosa
from maskgct.utils.util import load_config
from tqdm import tqdm
import os
from maskgct.maskgct.codec.kmeans.repcodec_model import RepCodec
from .maskgct_s2a import MaskGCT_S2A
from .maskgct_t2s import MaskGCT_T2S
from maskgct.maskgct.codec.amphion_codec.codec import CodecEncoder, CodecDecoder
from transformers import Wav2Vec2BertModel

from .g2p.g2p_generation import g2p, chn_eng_g2p
...
def build_semantic_model(device):
    ...
    stat_mean_var = torch.load(
        os.path.join(os.path.dirname(__file__), "ckpt/wav2vec2bert_stats.pt")
    )
