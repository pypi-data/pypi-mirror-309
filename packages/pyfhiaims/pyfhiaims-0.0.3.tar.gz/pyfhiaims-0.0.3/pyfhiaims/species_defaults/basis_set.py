...
from pyfhiaims.species_defaults.basis_function import BasisFunction, BASIS_TYPES
    ...
    def from_string(cls, string: str) -> "BasisSet":
        ...
        for line in lines:
            ...
            if line.startswith("#"):
                ...
                words = line[1:].split()
                if len(words) < 1 or (not any([bt in words[0] for bt in BASIS_TYPES])
                        or is_number_string(line)):
                    continue
