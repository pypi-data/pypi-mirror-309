...
only intended to save serialized byte arrays used by other Ataraxis project (notably: ataraxis-video-system and
ataraxis-transport-layer).

See serialized_data_logger.py for more details on the class and its methods.
"""

from .serialized_data_logger import DataLogger
