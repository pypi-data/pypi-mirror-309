...
from autorunner.models import TStep, FunctionsMapping
from autorunner.parser import parse_variables_mapping, parse_data
...
def ensure_upload_ready():
    ...
    or you can install autorunner with optional upload dependencies:
    $ pip install "autorunner[upload]"
    """
    logger.error(msg)
    sys.exit(1)
...
def multipart_encoder(**kwargs):
    ...
    for key, value in kwargs.items():
        ...
        if os.path.isabs(value):
            ...
            from autorunner.loader import load_project_meta
