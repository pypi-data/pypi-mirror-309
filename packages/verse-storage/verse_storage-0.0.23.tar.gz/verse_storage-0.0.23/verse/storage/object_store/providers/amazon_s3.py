...
class AmazonS3(StoreProvider):
    ...
    def _get_ncall(
        ...
        elif op_parser.op_equals(StoreOperation.GET) and (
            op_parser.is_metadata_attribute()
            or op_parser.is_properties_attribute()
        ):
        ...
        # GET versions
            ...
            op_parser.is_versions_attribute()
        ):
        ...
        # UPDATE
            ...
            args = op_converter.convert_update(
                ...
                properties=op_parser.get_updated_properities(),
                match_condition=op_parser.get_match_condition(),
            )
...
class ResultConverter:
    ...
    def convert_copy_result(self, id: str, nresult: Any) -> ObjectItem:
        ...
        if "CopyObjectResult" in nresult:
            ...
            last_modified = nresult["CopyObjectResult"]["LastModified"]
        return ObjectItem(
            key=ObjectKey(id=id, version=version),
            properties=ObjectProperties(
...
class OperationConverter:
    ...
    def convert_match_condition(self, match_condition: MatchCondition) -> dict:
        ...
        if match_condition.if_modified_since is not None:
            args["IfModifiedSince"] = match_condition.if_modified_since
        if match_condition.if_unmodified_since is not None:
            args["IfUnmodifiedSince"] = match_condition.if_unmodified_since
        return args
    ...
    def convert_copy_match_condition(
        ...
        if match_condition.if_modified_since is not None:
            args["CopySourceIfModifiedSince"] = (
                match_condition.if_modified_since
            )
        if match_condition.if_unmodified_since is not None:
            args["CopySourceIfUnmodifiedSince"] = (
                match_condition.if_unmodified_since
            )
        return args
