...
class ResourceHelper:
    ...
    def create_collection(
        ...
        if exists is False:
            func = database_client.create_container
        else:
            func = database_client.create_container_if_not_exists
        NCall(
            func,
            args,
            container_nargs,
    ...
    def drop_collection(self, container: str, exists: bool | None, nargs: Any):
        try:
            NCall(
