...
class Pinecone(StoreProvider):
    ...
    def _get_index_name(self, op_parser: StoreOperationParser) -> str | None:
        ...
        index = collection_name if collection_name is not None else self.index
        return index
...
class ResourceHelper:
    ...
    def create_collection(
        ...
        return NCall(self.database_client.create_index, args, nargs).invoke()

    def drop_collection(self, index: str, nargs: Any):
        args = {"name": index}
        return NCall(self.database_client.delete_index, args, nargs).invoke()
