...
class SourceAddCommand(Command):
    ...
    def handle(self) -> int:
        ...
        from openfund.utils.source import source_to_table
        ...
        try:
            pool = Factory.create_pool(self.openfund.config, sources, NullIO())
        ...
        self.openfund.pyproject.poetry_config["source"] = sources
        self.openfund.pyproject.save()
