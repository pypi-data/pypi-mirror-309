...
if TYPE_CHECKING:
    ...
    from openfund.repositories.repository import Repository
...
lists all packages available."""
    ...
    def _display_packages_information(
        ...
        from openfund.repositories.installed_repository import (
            InstalledRepository,
        )
        from openfund.repositories.repository_pool import RepositoryPool
        from openfund.utils.helpers import get_package_version_display_string

        locked_packages = locked_repository.packages
        pool = RepositoryPool.from_packages(locked_packages, self.openfund.config)
        solver = Solver(
            root,
            pool=pool,
            installed=[],
