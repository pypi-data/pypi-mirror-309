...
from openfund.console.commands.init import InitCommand
from openfund.console.commands.show import ShowCommand
...
class DebugResolveCommand(InitCommand):
    ...
    loggers = [
        "openfund.repositories.pypi_repository",
    ...
    def handle(self) -> int:
        ...
        if self.option("install"):
            ...
            pool = RepositoryPool(config=self.openfund.config)
