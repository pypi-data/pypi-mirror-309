...
class ProjectFilter(_message.Message):
    ...
    node_name: str
    project_id: str
    def __init__(self, filter: _Optional[_Union[_filter_pb2.Filter, _Mapping]] = ..., analysis_config_id: _Optional[str] = ..., node_name: _Optional[str] = ..., project_id: _Optional[str] = ...) -> None: ...
