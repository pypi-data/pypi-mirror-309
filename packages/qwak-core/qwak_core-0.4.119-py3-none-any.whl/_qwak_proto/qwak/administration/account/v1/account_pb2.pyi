...
class Account(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["accepted_terms", b"accepted_terms", "created_at", b"created_at", "last_modified_at", b"last_modified_at", "preferences", b"preferences"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["accepted_terms", b"accepted_terms", "created_at", b"created_at", "default_environment_id", b"default_environment_id", "id", b"id", "last_modified_at", b"last_modified_at", "name", b"name", "preferences", b"preferences", "status", b"status", "tier", b"tier", "type", b"type"]) -> None: ...
