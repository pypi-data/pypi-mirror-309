...
class CreateAccountRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["account_name", b"account_name", "jfrog_tenant_details", b"jfrog_tenant_details", "preferences", b"preferences", "tier", b"tier", "type", b"type"]) -> None: ...
...
class UpdateAccountRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["accepted_terms", b"accepted_terms", "account_id", b"account_id", "jfrog_tenant_details", b"jfrog_tenant_details", "preferences", b"preferences", "tier", b"tier", "type", b"type"]) -> None: ...
