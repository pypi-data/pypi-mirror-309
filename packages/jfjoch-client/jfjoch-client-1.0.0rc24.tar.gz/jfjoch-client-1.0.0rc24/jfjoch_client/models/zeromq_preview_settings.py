...
class ZeromqPreviewSettings(BaseModel):
    ...
    send_start_message: Optional[StrictBool] = Field(default=True, description="Publish start message on the preview ZeroMQ stream ")
    ...
    __properties: ClassVar[List[str]] = ["enabled", "period_ms", "send_start_message", "socket_address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "send_start_message": obj.get("send_start_message") if obj.get("send_start_message") is not None else True,
