...
class ReviewApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateReviewDescription = channel.unary_unary(
                '/ReviewApi/UpdateReviewDescription',
                request_serializer=global__vo__grpc__service_dot_protos_dot_review__api__pb2.UpdateReviewDescriptionRequest.SerializeToString,
                response_deserializer=global__vo__grpc__service_dot_protos_dot_review__api__pb2.UpdateReviewDescriptionResponse.FromString,
                )
...
class ReviewApiServicer(object):
    ...
    def UpdateReviewDescription(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ReviewApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'UpdateReviewDescription': grpc.unary_unary_rpc_method_handler(
                    servicer.UpdateReviewDescription,
                    request_deserializer=global__vo__grpc__service_dot_protos_dot_review__api__pb2.UpdateReviewDescriptionRequest.FromString,
                    response_serializer=global__vo__grpc__service_dot_protos_dot_review__api__pb2.UpdateReviewDescriptionResponse.SerializeToString,
            ),
    }
...
class ReviewApi(object):
    ...
    @staticmethod
    def UpdateReviewDescription(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ReviewApi/UpdateReviewDescription',
            global__vo__grpc__service_dot_protos_dot_review__api__pb2.UpdateReviewDescriptionRequest.SerializeToString,
            global__vo__grpc__service_dot_protos_dot_review__api__pb2.UpdateReviewDescriptionResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
