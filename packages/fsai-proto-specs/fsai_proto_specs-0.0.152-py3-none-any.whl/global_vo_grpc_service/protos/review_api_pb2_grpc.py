...
class ReviewApiStub(object):
    ...
    def __init__(self, channel):
        ...
        self.DeleteReivewJobs = channel.unary_unary(
                '/ReviewApi/DeleteReivewJobs',
                request_serializer=global__vo__grpc__service_dot_protos_dot_review__api__pb2.DeleteReivewJobsRequest.SerializeToString,
                response_deserializer=global__vo__grpc__service_dot_protos_dot_review__api__pb2.DeleteReivewJobsResponse.FromString,
                )
...
class ReviewApiServicer(object):
    ...
    def DeleteReivewJobs(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_ReviewApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'DeleteReivewJobs': grpc.unary_unary_rpc_method_handler(
                    servicer.DeleteReivewJobs,
                    request_deserializer=global__vo__grpc__service_dot_protos_dot_review__api__pb2.DeleteReivewJobsRequest.FromString,
                    response_serializer=global__vo__grpc__service_dot_protos_dot_review__api__pb2.DeleteReivewJobsResponse.SerializeToString,
            ),
    }
...
class ReviewApi(object):
    ...
    def DeleteReivewJobs(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ReviewApi/DeleteReivewJobs',
            global__vo__grpc__service_dot_protos_dot_review__api__pb2.DeleteReivewJobsRequest.SerializeToString,
            global__vo__grpc__service_dot_protos_dot_review__api__pb2.DeleteReivewJobsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
