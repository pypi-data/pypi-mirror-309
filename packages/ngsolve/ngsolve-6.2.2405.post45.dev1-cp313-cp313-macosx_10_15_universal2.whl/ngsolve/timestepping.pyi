...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('c', 'gfu_old', '_lin_solver_cls', 'dt', 'time', 'bfmstar', '_lin_solver_args')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('gfv_old', 'c', 'gfu_old', 'gfa_old', '_lin_solver_cls', 'dt', 'time', 'bfmstar', '_lin_solver_args')
