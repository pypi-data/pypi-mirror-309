...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('pre', 'display', 'callback_sol', 'plt', 'sol', 'ress', 'iterations', 'ax', 'tol', 'fig', 'atol', 'plotrates', 'its', 'mat', 'maxiter', 'callback', '_final_residual', 'printrates', 'clear_output', 'residuals')
