...
class fft_type_descriptor(f90wrap.runtime.FortranDerivedType):
    ...
    def __init__(self, at, bg, gcutm, comm, fft_fact=None, nyfft=None, handle=None):
        ...
        result = libqepy_fftxlib.f90wrap_fft_types__fft_type_allocate(at=at, bg=bg, \
    ...
    def __del__(self):
        ...
        """
        if self._alloc:
            libqepy_fftxlib.f90wrap_fft_types__fft_type_deallocate(desc=self._handle)
...
def fft_stick_index(self, i, j):
    ...
    """
    fft_stick_index = \
        libqepy_fftxlib.f90wrap_fft_types__fft_stick_index(desc=self._handle, i=i, \
        j=j)
...
def fft_index_to_3d(ir, dfft):
    ...
    """
    i, j, k, offrange = libqepy_fftxlib.f90wrap_fft_types__fft_index_to_3d(ir=ir, \
        dfft=dfft._handle)
