...
class IdentityData(BaseModel):
    ...
    attachment_access_keys: Optional[AttachmentAccessKeys] = Field(default=None, description="Attachment Access Keys for attachments (eg document / selfie images)", alias="attachmentAccessKeys")
    __properties: ClassVar[List[str]] = ["originatingProviderId", "person", "document", "attachmentAccessKeys"]
