def choice():
    ...
    print("Press 10 to print the code for 3 Water Jug Problem using DFS")  # Added option
...
'''
    ...
    '''
        ...
        code = '''
    def waterJugSolver(capacities, target):
        def dfs(state):
            if target in state or sum(state) == target:
                return True
    ...
    if waterJugSolver(capacities, target):
