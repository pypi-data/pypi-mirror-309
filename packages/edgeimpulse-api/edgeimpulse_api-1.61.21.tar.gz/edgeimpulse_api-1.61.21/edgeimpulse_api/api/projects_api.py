...
class ProjectsApi(object):
    ...
    @validate_arguments
    def list_public_projects(self, limit : Annotated[Optional[StrictInt], Field(description="Maximum number of results")] = None, offset : Annotated[Optional[StrictInt], Field(description="Offset in results, can be used in conjunction with LimitResultsParameter to implement paging.")] = None, project : Annotated[Optional[StrictStr], Field(description="Only include projects that contain this string")] = None, project_types : Annotated[Optional[StrictStr], Field(description="Comma separated list of project types to filter on. Supported values are 'audio', 'object-detection', 'image', 'accelerometer', 'other'.")] = None, sort : Annotated[Optional[StrictStr], Field(description="Fields and order to sort query by")] = None, **kwargs) -> ListPublicProjectsResponse:  # noqa: E501
