...
class _Function(typing.Generic[P, ReturnType, OriginalReturnType], modal.object._Object):
    ...
    def _hydrate_function_and_method_functions(
        ...
        handle_metadata: modal_proto.api_pb2.FunctionHandleMetadata,
    ): ...
    @staticmethod
    def from_args(
...
class Function(typing.Generic[P, ReturnType, OriginalReturnType], modal.object.Object):
    ...
    def _hydrate_function_and_method_functions(
        self, function_id: str, client: modal.client.Client, handle_metadata: modal_proto.api_pb2.FunctionHandleMetadata
    ): ...
    @staticmethod
    def from_args(
        info: modal._utils.function_utils.FunctionInfo,
