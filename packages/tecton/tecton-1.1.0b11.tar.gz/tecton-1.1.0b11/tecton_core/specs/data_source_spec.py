...
def create_batch_source_from_data_proto(
    ...
    if proto.HasField("hive_table"):
        ...
        return PyArrowBatchSourceSpec.from_data_proto(proto, deserialize_funcs_to_main)
...
class PyArrowBatchSourceSpec(BatchSourceSpec):
    ...
    def from_data_proto(
        ...
        if proto.pyarrow_data_source_function.HasField("function"):
            if deserialize_funcs_to_main:
                function = function_deserialization.from_proto_to_main(proto.pyarrow_data_source_function.function)
            else:
                function = function_deserialization.from_proto(proto.pyarrow_data_source_function.function)
