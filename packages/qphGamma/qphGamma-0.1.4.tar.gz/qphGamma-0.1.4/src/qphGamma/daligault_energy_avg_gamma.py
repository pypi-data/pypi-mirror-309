...
class DaligaultAvgGamma:
    ...
    def __init__(
        ...
        daligault_data = DaligaultGamma(self.E, self.Te, self.n)
        self.E_gamma = daligault_data.gamma()
    ...
    def get_fg_dos(self):
        ...
        mu = get_mu(self.n, self.theta, self.theta_cutoff)
