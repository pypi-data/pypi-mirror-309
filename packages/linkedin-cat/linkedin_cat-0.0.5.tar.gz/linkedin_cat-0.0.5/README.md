...
# 添加自定义模块路径
# import sys
# sys.path.append(r'C:\Users\pyfunc')
# from llm import llm
...
def search_recruiter(keywords, company=None, title=None, school=None, first_name=None, last_name=None,chinese_detect=True,message=message):
    page = 1
    while True:
        # 生成LinkedIn搜索URL
        ...
        for result in results:
            ...
            try:
                ...
                # 判断是否需要检测中文
                should_send = not chinese_detect or detector.detect_chinese_word(name) or detector.detect_family_name(name)
...
# 使用示例
search_recruiter('security', company='google',last_name='jiang',chinese_detect=True,message=message)
```
