...
class LinkedinSearch(LinkedinMessage):
    ...
    def parse_linkedin_results(self,html_text):
        ...
        for profile in profiles:
            ...
            link_tag = profile.find("span", class_="entity-result__title-text t-16")
            profile_data['linkedin_url'] = profile.find("span", class_="entity-result__title-text t-16").find("a")["href"] if link_tag else None
