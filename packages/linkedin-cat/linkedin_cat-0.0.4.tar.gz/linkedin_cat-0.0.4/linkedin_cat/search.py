...
class LinkedinSearch(LinkedinBase):
    ...
    def parse_linkedin_results(self,html_text):
        ...
        for profile in profiles:
            ...
            company_tag = profile.find('div', class_='entity-result__primary-subtitle')
            ...
            link_tag = profile.find('a', class_='app-aware-link')
            ...
            if img_tag and img_tag.has_attr('src'):
                profile_data['image_url'] = img_tag['src']
            else:
    ...
    def search_keywords(self,keywords):
        try:
            ...
            html = self.open_linkedin_url(url)
    ...
    def search_linkedin_profile(self,url,save_folder='./linkedin'):
        ...
        try:
            ...
            profile_data = extract_profile(self.driver,url)
            if not profile_data:
