...
class SimpleModelWrapper(ModelWrapper):
	...
	Examples
	--------
	>>> from model_wrapper import SimpleModelWrapper
...
class ClassModelWrapper(ModelWrapper):
	...
	Examples
	--------
	>>> from model_wrapper import ClassModelWrapper
	...
	def _predict_classes(self, pred: np.ndarray) -> np.ndarray:
		if self.classes:
			...
			log_utils.warn('classes not be specified')
			return pred
...
class SimpleClassModelWrapper(ClassModelWrapper):
	...
	Examples
	--------
	>>> from model_wrapper import SimpleClassModelWrapper
...
class SimpleRegressModelWrapper(RegressModelWrapper):
	...
	Examples
	--------
	>>> from model_wrapper import SimpleRegressModelWrapper
