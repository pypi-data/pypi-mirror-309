    ...
    def real_info_of_photo(self, photo: bytes):
        ...
        with Image.open(io.BytesIO(photo)) as img:
            ...
            try:
                ...
                json = r.json()
                return {"country":json["address"]["country"], "region":json["address"]["state"], "district":json["address"]["district"], 'city':json["address"]["city"], "full_address":json["display_name"], 'postcode':json["address"]["postcode"]}
            except:
                if lat_ref != 'E':
                    latitude = -latitude
                longitude = -longitude
