...
class RedirectViewServletContextJspConfigDescriptorJspPropertyGroupsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["trimDirectiveWhitespaces", "errorOnUndeclaredNamespace", "elIgnored", "scriptingInvalid", "pageEncoding", "isXml", "includePreludes", "includeCodas", "deferredSyntaxAllowedAsLiteral", "buffer", "defaultContentType", "urlPatterns"]
