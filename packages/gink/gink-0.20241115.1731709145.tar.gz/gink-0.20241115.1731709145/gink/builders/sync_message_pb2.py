...
_SYNCMESSAGE_GREETING_GREETINGENTRY = _descriptor.Descriptor(
  name='GreetingEntry',
  full_name='gink.SyncMessage.Greeting.GreetingEntry',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='medallion', full_name='gink.SyncMessage.Greeting.GreetingEntry.medallion', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='chain_start', full_name='gink.SyncMessage.Greeting.GreetingEntry.chain_start', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='seen_through', full_name='gink.SyncMessage.Greeting.GreetingEntry.seen_through', index=2,
...
_SYNCMESSAGE_GREETING = _descriptor.Descriptor(
  name='Greeting',
  full_name='gink.SyncMessage.Greeting',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='entries', full_name='gink.SyncMessage.Greeting.entries', index=0,
...
_SYNCMESSAGE_ACK = _descriptor.Descriptor(
  name='Ack',
  full_name='gink.SyncMessage.Ack',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='medallion', full_name='gink.SyncMessage.Ack.medallion', index=0,
      number=1, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='chain_start', full_name='gink.SyncMessage.Ack.chain_start', index=1,
      number=2, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timestamp', full_name='gink.SyncMessage.Ack.timestamp', index=2,
      number=3, type=4, cpp_type=4, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='previous', full_name='gink.SyncMessage.Ack.previous', index=3,
...
_SYNCMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='bundle', full_name='gink.SyncMessage.bundle', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='greeting', full_name='gink.SyncMessage.greeting', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='ack', full_name='gink.SyncMessage.ack', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='contents', full_name='gink.SyncMessage.contents',
...
SyncMessage = _reflection.GeneratedProtocolMessageType('SyncMessage', (_message.Message,), {
  ...
  'Greeting' : _reflection.GeneratedProtocolMessageType('Greeting', (_message.Message,), {
    ...
    'GreetingEntry' : _reflection.GeneratedProtocolMessageType('GreetingEntry', (_message.Message,), {
      ...
      '__module__' : 'proto.sync_message_pb2'
      # @@protoc_insertion_point(class_scope:gink.SyncMessage.Greeting.GreetingEntry)
      })
    ,
    'DESCRIPTOR' : _SYNCMESSAGE_GREETING,
    '__module__' : 'proto.sync_message_pb2'
    # @@protoc_insertion_point(class_scope:gink.SyncMessage.Greeting)
    })
  ,
  ...
  'Ack' : _reflection.GeneratedProtocolMessageType('Ack', (_message.Message,), {
    ...
    '__module__' : 'proto.sync_message_pb2'
    # @@protoc_insertion_point(class_scope:gink.SyncMessage.Ack)
    })
  ,
  'DESCRIPTOR' : _SYNCMESSAGE,
  '__module__' : 'proto.sync_message_pb2'
  # @@protoc_insertion_point(class_scope:gink.SyncMessage)
  })
