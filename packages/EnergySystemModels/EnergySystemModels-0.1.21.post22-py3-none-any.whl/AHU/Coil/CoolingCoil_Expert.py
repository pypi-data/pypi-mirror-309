...
class Object:
    ...
    def calculate(self):
        ...
        self.w_sat=air_humide.w(air_humide.func_Pv_sat(self.T_sat), 100, self.Inlet.P)
      ...
      #  Test du calcul de point de Outlet à 90% d'humidité 7.5 g/kg, 12°C
        ...
        self.Inlet_RH=air_humide.RH(air_humide.func_Pv_sat(self.T_inlet),self.Inlet.w,self.Inlet.P)
        ...
        if self.Inlet.w>=self.w_target and self.w_target>=self.w_sat: 
            ...
            if self.Inlet_RH<=90 :
                ...
                def syst(var): # définition du système
                    ...
                    eq1 =self.Outlet_RH-air_humide.RH(self.Outlet_Pvsat,self.w_target,self.Inlet.P)  #calcul de Pvsat
                ...
                def syst(var): # définition du système
                    self.Outlet_Pvsat,self.T_Outlet, = var[0], var[1] # définition des variables
                    eq1 =100-air_humide.RH(self.Outlet_Pvsat,self.w_target,self.Inlet.P)  #calcul de Pvsat
                    eq2 =self.Outlet_Pvsat-air_humide.func_Pv_sat(self.T_Outlet) #calcul de T      
                    #eq2=self.T_Outlet-12          
                    #eq3 =self.Outlet.w-air_humide.w(self.Outlet_Pvsat, self.Outlet_RH, self.Inlet.P) #recalcul de w
                    res = [eq1,eq2]
