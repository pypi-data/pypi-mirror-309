...
__all__ = ["RuntimeException", "GLOBAL_DEBUG", "SessionUser", "Context", "LangType", "GenderType", "PlatType",
           "BaseInfo", "RewardItem", "ConsumeItem", "get_base_info_key", "get_openid_uid_key"]
...
def get_openid_uid_key(game:str, channel:str, open_id:str, redis_key:str)->str:
    return "#".join([game, channel, redis_key, open_id])
