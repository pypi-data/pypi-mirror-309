...
engine = create_engine(os.getenv("ONEAPI_SQL_URL"), pool_recycle=3600, echo=True)
#
# #
# SQLModel.metadata.create_all(engine)
#
# with Session(engine) as session:
#     statement = update(Tasks).where(Tasks.id == 2).values(
#         progress=100,
#         status='500',
#         fail_reason="测试",
#         platform="chatfire",
...
#         remote_task_id='666',
#
#         data={"url": "https://api.chatfire.cn/task", "status": "ok"},
#         properties={"url": "https://api.chatfire.cn/task", "status": "ok"},
#     )
#
