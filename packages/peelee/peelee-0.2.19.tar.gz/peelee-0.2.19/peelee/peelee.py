...
def generate_slice_colors(
    ...
    if palette_mode == PaletteMode.DARK:
        ...
        color_slice_type = SliceType.LIGHTER
    random_colors_map = {}
    for base_color in ColorName:
        if base_color == ColorName.RANDOM:
            continue
        ...
        random_colors_map[base_color] = slice_colors
...
def main():
    ...
    dark_colors_min=15
    dark_colors_max=40
    dark_colors_saturation=0.35
    dark_colors_lightness=0.35

    dark_base_color_name=ColorName.BLUE
