...
@app.command(
    "run",
    help="""
Usage: cerebrium run APP_NAME --data '{"prompt": "your value here"} --function FUNCTION_NAME'
...
def run_user_app(
    ...
    """
    Calls a user application with the specified data.
    """
    ...
    try:
        response = requests.post(base_url, headers=headers, json=json_data, params=params)
