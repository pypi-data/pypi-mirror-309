...
def gemini_interaction_chat_with_prompt(
    ...
    logger.info(f"generated_history  ssssssss: {generated_history}")
    # Prepare the message to send
    last_message_parts = generated_history[-1]
    logger.info(f"last_message_parts qqqqqqqq  ssssssss: {last_message_parts}")
    ...
    if not any(isinstance(part, str) and part.strip() for part in last_message_parts):
        ...
        logger.info(f"last_message_parts  ssssssss: {last_message_parts}")
