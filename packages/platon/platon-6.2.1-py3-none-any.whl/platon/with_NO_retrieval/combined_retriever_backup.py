...
class CombinedRetriever:
    ...
    def _ln_like(self, params, transit_calc, eclipse_calc, fit_info, measured_transit_depths,
        ...
        log_CH4_factor = params_dict["log_CH4_factor"]
        ...
        custom_abunds = AbundanceGetter(include_condensation=True).get(logZ, CO_ratio)
        custom_abunds["SO2"] *= 0
        custom_abunds["SO2"] += 10**log_SO2
        custom_abunds["CH4"] *= 10**log_CH4_factor
        ...
        try:
            if measured_transit_depths is not None:
                ...
                transit_wavelengths, calculated_transit_depths, transit_info_dict = transit_calc.compute_depths(
                    Rs, Mp, Rp, temperature=T, logZ=None, CO_ratio=None,
