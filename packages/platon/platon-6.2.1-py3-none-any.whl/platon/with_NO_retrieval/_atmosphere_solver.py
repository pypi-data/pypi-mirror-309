...
class AtmosphereSolver:
    ...
    def _get_abundances_array(self, logZ, CO_ratio, NO_ratio, CH4_mult, custom_abundances, gases, vmrs):
        if custom_abundances is None and logZ is not None and CO_ratio is not None:
            abunds = self.abundance_getter.get(logZ, CO_ratio, NO_ratio)
            abunds["CH4"] *= CH4_mult
            return abunds
    ...
    def compute_params(self, star_radius, planet_mass, planet_radius,
                       P_profile, T_profile,
                       logZ=0, CO_ratio=0.53, NO_ratio=0.14, CH4_mult=1,
        ...
        abundances = self._get_abundances_array(
            logZ, CO_ratio, NO_ratio, CH4_mult, custom_abundances, gases, vmrs)
