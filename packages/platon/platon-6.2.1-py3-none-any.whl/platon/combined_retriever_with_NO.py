...
class CombinedRetriever:
        ...
        try:
            if measured_transit_depths is not None:
                ...
                transit_wavelengths, calculated_transit_depths, transit_info_dict = transit_calc.compute_depths(
                    Rs, Mp, Rp, T, logZ, CO_ratio, NO_ratio, CH4_mult, gases, vmrs,
    ...
    @staticmethod
    def get_default_fit_info(Rs, Mp, Rp, T=None, logZ=0, CO_ratio=0.53, NO_ratio=0.14, log_CH4_mult=0,
