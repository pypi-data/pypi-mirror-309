...
class CartaoCredito:
    ...
    Attributes:
        ...
        card_network (BandeirasCartao): Rede do cartão (ex: Visa, MasterCard).
        ...
        created_at (str): Data de criação do cartão no formato ISO (`YYYY-MM-DD`).
        updated_at (str): Data da última atualização do cartão no formato ISO (`YYYY-MM-DD`).
    """

    id: int
    name: str
    description: str
    card_network: BandeirasCartao
    closing_day: int
    due_day: int
    limit_cents: int
    type: str
...
def addCartaoCredito(sessao: API, nome: str, bandeira: BandeirasCartao, diaVencimento: int, diaFechamento: int, limite: int):
    """
    ...
    Args:
        ...
        bandeira (BandeirasCartao): Rede do cartão de crédito (ex: Visa, MasterCard).
...
def updCartaoCredito(sessao: API, idCartao: int, nome: str = None, diaVencimento: int = None, diaFechamento: int = None,
                     atualizarFaturasDesde: str = None, bandeira: BandeirasCartao = None, limite: int = None):
    """
    ...
    Args:
        ...
        bandeira (BandeirasCartao): Bandeira do cartão, aceita os inputs VISA ou MASTERCARD
