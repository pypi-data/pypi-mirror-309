...
def addConta(sessao: API, nome: str, descricao: str, default: bool, tipo: TipoConta):
    """
    ...
    Args:
        ...
        tipo (TipoConta): O tipo da conta, deve ser 'checking', 'savings' ou 'other'.
    """
