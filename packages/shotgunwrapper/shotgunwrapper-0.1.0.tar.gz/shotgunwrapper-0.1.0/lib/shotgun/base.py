...
from shotgun.dotdictify import dotdictify
...
class Entity(object):
    ...
    def __init__(self, parent, data=None):
        """
        :param parent: shotgun parent object
    ...
    def api(self):
        """Returns Shotgun api object."""
        parent = self.parent()
        while parent:
            if parent.type() == "Shotgun":
                return parent
            parent = parent.parent()

    def create(self, entity_type, data):
        """Creates a new entity in shotgun."""
        data.update({"project": self.get_project().data})
        return self.api().create(entity_type, data)

    def delete(self):
        """Deletes this entity from shotgun."""
    ...
    def get_versions(self, code=None, filters=None, fields=None):
        """Returns a list of versions from shotgun given a shot and task dictionary.
    ...
    def refetch(self, fields=None):
        """Refetches entity data from shotgun. Used to update an entity
    ...
    def undelete(self):
        """Restores previously deleted entity from shotgun."""
