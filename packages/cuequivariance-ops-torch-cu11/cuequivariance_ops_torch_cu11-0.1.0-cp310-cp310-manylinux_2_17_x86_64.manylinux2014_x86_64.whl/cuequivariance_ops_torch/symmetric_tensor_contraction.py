...
@dataclass
class SymmetricTensorContractionArgs:
    correlation: int
...
def _(
    ...
    accum_type = torch.float32 if tensor_a.element_size() <= 4 else torch.float64

    grad_tensor_w = torch.empty_like(tensor_w, dtype=accum_type, device=tensor_w.device)
...
def symmetric_tensor_contraction_fwd(tensor_a, tensor_w, tensor_w_id, args):
    return (
        torch.ops.cuequivariance_ops_torch.symmetric_tensor_contraction_fwd_primitive(
            tensor_a,
            tensor_w,
            tensor_w_id,
            args.fwd_info.path_vals,
            args.fwd_info.path_indices,
            args.fwd_info.path_offsets,
            args.bwd_info.path_vals_da,
            args.bwd_info.path_indices_da,
            args.bwd_info.path_offsets_da,
            args.bwd_info.path_vals_dw,
            args.bwd_info.path_indices_dw,
            args.bwd_info.path_offsets_dw,
            args.bwd_bwd_info.path_vals_da_da,
            args.bwd_bwd_info.path_indices_da_da,
            args.bwd_bwd_info.path_offsets_da_da,
            args.bwd_bwd_info.path_vals_da_db,
            args.bwd_bwd_info.path_indices_da_db,
            args.bwd_bwd_info.path_offsets_da_db,
            args.bwd_bwd_info.path_vals_da_dw,
            args.bwd_bwd_info.path_indices_da_dw,
            args.bwd_bwd_info.path_offsets_da_dw,
            args.bwd_bwd_info.path_vals_dw_da,
            args.bwd_bwd_info.path_indices_dw_da,
            args.bwd_bwd_info.path_offsets_dw_da,
            args.bwd_bwd_info.path_vals_dw_db,
            args.bwd_bwd_info.path_indices_dw_db,
            args.bwd_bwd_info.path_offsets_dw_db,
            args.bwd_info.num_in_segments,
            args.fwd_info.num_out_segments,
            args.bwd_info.num_coupling_paths,
            args.correlation,
        )
    )
...
def symmetric_tensor_contraction(tensor_a, tensor_w, tensor_w_id, args):
    return symmetric_tensor_contraction_fwd(tensor_a, tensor_w, tensor_w_id, args)
...
class SymmetricTensorContraction(nn.Module):
    ...
    def forward(self, tensor_a, tensor_w, tensor_w_id):
        ...
        args = SymmetricTensorContractionArgs(
            self.correlation, self.fwd_info, self.bwd_info, self.bwd_bwd_info
        )
        return symmetric_tensor_contraction(tensor_a, tensor_w, tensor_w_id, args)
