...
class APIServer:
    ...
    def remove_credits(self, key, value): if value is not None: update_credits(self.db, key, -value, self.LOG)
    ...
    async def check(self, request):  # GET request
        """Check async proc. response has task status and if DONE has also the results url."""
