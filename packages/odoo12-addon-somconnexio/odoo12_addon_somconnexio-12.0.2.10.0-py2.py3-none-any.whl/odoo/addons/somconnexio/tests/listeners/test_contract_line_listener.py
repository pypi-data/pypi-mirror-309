...
class TestContractLineListener(SavepointCase, ComponentMixin):
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.switchboard_service = self.browse_ref("somconnexio.AgentCentraletaVirtualApp500") # noqa
        ...
        self.switchboard_contract = self.env.ref("somconnexio.contract_switchboard_app_500") # noqa
