...
class TestCreateLeadfromPartnerWizard(SCTestCase):
    ...
    def setUp(self, *args, **kwargs):
        ...
        self.all_product_templs = self.env["product.template"].search(
            [
        ...
        self.product_templs = coop_agreement.products
    ...
    def test_products_filtered_when_partner_has_coop_agreement(
        ...
        self.assertEquals(
            ...
            self.env["product.product"].search(
                [
                    ("product_tmpl_id", "in", self.product_templs.ids),
                    ("pack_ok", "=", False),
                    (
                        "attribute_value_ids",
                        "not in",
    ...
    def test_create_new_mobile_lead_with_business_team(
        ...
        expected_domain = [
            ("product_tmpl_id", "in", self.all_product_templs.ids),
            ("pack_ok", "=", False),
            (
                "attribute_value_ids",
                "in",
