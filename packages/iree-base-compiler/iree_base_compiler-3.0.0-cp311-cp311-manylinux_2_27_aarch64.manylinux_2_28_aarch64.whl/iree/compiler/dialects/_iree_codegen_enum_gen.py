...
class DispatchLoweringPassPipeline(IntEnum):
    ...
    LLVMGPUMatmulSimt = 104
    LLVMGPUMatmulTensorCore = 105
    LLVMGPUTransposeSharedMem = 106
    LLVMGPUWarpReduction = 107
    LLVMGPUPackUnPack = 108
    LLVMGPUMatmulTensorCoreMmaSync = 109
    LLVMGPUVectorDistribute = 110
    LLVMGPUPadAndVectorDistribute = 111
    LLVMGPUWinogradVectorize = 112
    LLVMGPUTileAndFuse = 113
    ...
    def __str__(self):
        ...
        if self is DispatchLoweringPassPipeline.LLVMGPUMatmulSimt:
            return "LLVMGPUMatmulSimt"
