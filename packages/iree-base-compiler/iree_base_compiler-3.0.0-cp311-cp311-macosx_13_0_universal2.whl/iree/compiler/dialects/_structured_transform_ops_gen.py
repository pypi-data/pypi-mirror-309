...
def structured_split(first, second, target, dimension, static_chunk_sizes, *, dynamic_chunk_sizes=None, multiway=None, loc=None, ip=None) -> _Sequence[_ods_ir.Value]:
  return SplitOp(first=first, second=second, target=target, dimension=dimension, static_chunk_sizes=static_chunk_sizes, dynamic_chunk_sizes=dynamic_chunk_sizes, multiway=multiway, loc=loc, ip=ip).results
