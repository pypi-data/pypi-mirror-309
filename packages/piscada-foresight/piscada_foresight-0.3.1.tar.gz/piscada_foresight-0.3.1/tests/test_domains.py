...
def test_get_parent_traits():
    ...
    parent_traits = get_parent_traits(trait, brick_domain)
    expected_ids = {
...
def test_get_parent_traits_exceptions():
    ...
    parent_traits = get_parent_traits(trait_no_parents, brick_domain)
    ...
    with raises(RecursionError):
        get_parent_traits(cyclic_domain.get_trait_by_id("cyclic:trait1"), cyclic_domain)
