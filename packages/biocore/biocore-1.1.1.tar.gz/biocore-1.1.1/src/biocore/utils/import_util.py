...
_biosets_available = _is_package_available("biosets")
...
def is_biosets_available():
    return _biosets_available
...
BIOSETS_IMPORT_ERROR = """
{0} requires the biosets library but it was not found in your environment. You can
install it with:
```
pip install biosets
```
...
BACKENDS_MAPPING = OrderedDict(
    [
        ...
        ("biosets", (is_biosets_available, BIOSETS_IMPORT_ERROR)),
