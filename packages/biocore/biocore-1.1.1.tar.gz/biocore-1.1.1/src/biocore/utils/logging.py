...
def silence():
    if sys.modules.get("datasets") is not None:
        ...
        datasets_verb = datasets.logging.get_verbosity()
    ...
    datasets.disable_progress_bars()
    return verb, datasets_verb, is_pb_enabled, is_ds_pb_enabled


def unsilence(verbosity, dataset_verbosity, is_pb_enabled, is_ds_pb_enabled):
    warnings.filterwarnings("default")
    set_verbosity(verbosity)
    if sys.modules.get("datasets") is not None and dataset_verbosity is not None:
        import datasets
