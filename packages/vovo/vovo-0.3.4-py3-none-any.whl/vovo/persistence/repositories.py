...
class GenericRepository(Generic[T], ABC):
    ...
    @abstractmethod
    async def get_list(self, limit: int = 100, order_by: str | List[str] | None = None, **filters) -> list[T]:
...
class GenericSqlRepository(GenericRepository[T], ABC):
    ...
    async def get_list(self, limit: int = 100, order_by: str | List[str] | None = None, filters: dict = None,
                       **kwargs: Any) -> list[T]:
