...
[![LatestPyPIrelease](
    https://img.shields.io/gitlab/pipeline/aedev-group/aedev_tpl_app/release0.3.8?logo=python)](
    https://gitlab.com/aedev-group/aedev_tpl_app/-/tree/release0.3.8)
[![PyPIVersions](https://img.shields.io/pypi/v/aedev_tpl_app)](
    https://pypi.org/project/aedev-tpl-app/#history)

>aedev_tpl_app package 0.3.9.
