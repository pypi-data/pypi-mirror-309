...
def create_service_structure():
    try:
        ...
        create_handler_files(current_path, handler_files, language_choice, file_extension)

        # Process template files and replace placeholders
        process_templates(template_files, current_path, service_name, runtime)

        # Create .env file with environment variables
        create_env_file(current_path)
