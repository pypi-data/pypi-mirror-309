...
from retinafacex.log import Logger
import retinafacex.constants as const


def verify_model_weights(model_name: str, root: str = '~/.retinafacex/models') -> str:
    """
    ...
    Args:
        ...
        root (str, optional): Directory to store the model weights. Defaults to '~/.retinafacex/models'.
    ...
    Examples:
        ...
        '/home/user/.retinafacex/models/retinaface_mnet025.onnx'
