...
from dexsdk.utils.value_type_util import convert_to_type
import requests
import getpass
import dexsdk.utils.file_util as fu
import json
...
def handle_config_info_command():
    ...
    if fu.check_path_exists(config_file):
        ...
        print("未找到配置文件. 请先运行命令进行配置: dexsdk config")


def main():
    parser = argparse.ArgumentParser(description='1DexBot SDK Command Line Interface')
