...
class DataCheckInfo(DataCheckMessage):
    """DataCheckMessage subclass for infos returned by data checks."""

    message_type = DataCheckMessageType.INFO
    """DataCheckMessageType.INFO"""
