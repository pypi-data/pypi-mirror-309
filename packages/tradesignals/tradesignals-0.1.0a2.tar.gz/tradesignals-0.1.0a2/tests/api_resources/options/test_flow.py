...
from tradesignals.types.options import FlowListResponse, FlowRetrieveResponse
...
class TestFlow:
    ...
    def test_method_retrieve(self, client: TradesignalsIo) -> None:
        flow = client.options.flow.retrieve(
            symbol="AAPL",
        )
    ...
    def test_raw_response_retrieve(self, client: TradesignalsIo) -> None:
        response = client.options.flow.with_raw_response.retrieve(
            symbol="AAPL",
        )
    ...
    def test_streaming_response_retrieve(self, client: TradesignalsIo) -> None:
        with client.options.flow.with_streaming_response.retrieve(
            symbol="AAPL",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: TradesignalsIo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `symbol` but received ''"):
            client.options.flow.with_raw_response.retrieve(
                symbol="",
            )

    @parametrize
    def test_method_list(self, client: TradesignalsIo) -> None:
        flow = client.options.flow.list()
    ...
    def test_raw_response_list(self, client: TradesignalsIo) -> None:
        response = client.options.flow.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: TradesignalsIo) -> None:
        with client.options.flow.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncFlow:
    ...
    async def test_method_retrieve(self, async_client: AsyncTradesignalsIo) -> None:
        flow = await async_client.options.flow.retrieve(
            symbol="AAPL",
        )
        assert_matches_type(FlowRetrieveResponse, flow, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncTradesignalsIo) -> None:
        response = await async_client.options.flow.with_raw_response.retrieve(
            symbol="AAPL",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncTradesignalsIo) -> None:
        async with async_client.options.flow.with_streaming_response.retrieve(
            symbol="AAPL",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncTradesignalsIo) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `symbol` but received ''"):
            await async_client.options.flow.with_raw_response.retrieve(
                symbol="",
            )

    @parametrize
    async def test_method_list(self, async_client: AsyncTradesignalsIo) -> None:
        flow = await async_client.options.flow.list()
        assert_matches_type(FlowListResponse, flow, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncTradesignalsIo) -> None:
        response = await async_client.options.flow.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncTradesignalsIo) -> None:
        async with async_client.options.flow.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
