...
class TestClass:
    ...
    def test_Instantiation(self):
        self.sample_columns_to_test_p_col.method_IQR()
        self.sample_columns_to_test_p_col.method_IQR(distance = 2.7)
        self.sample_columns_to_test_p_col.method_IQR(threshold_included=True)
