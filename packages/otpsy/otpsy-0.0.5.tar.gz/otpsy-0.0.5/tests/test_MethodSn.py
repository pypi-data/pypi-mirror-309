...
class TestClass:
    ...
    outliers = sample_columns_to_test_p_col.method_Sn(distance=2.9, threshold_included=True)

    def test_Instantiation(self):
        self.sample_columns_to_test_p_col.method_Sn()
        self.sample_columns_to_test_p_col.method_Sn(distance = 2.4)
        self.sample_columns_to_test_p_col.method_Sn(threshold_included=True)
    ...
    def test_threshold_value(self):
        threshold = {'art_looking_time': 1018.0773999233261, 
                     'discrimination_performance': 0.14928289969748035}
