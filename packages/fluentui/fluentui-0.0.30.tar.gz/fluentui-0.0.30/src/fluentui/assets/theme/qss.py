...
class LightQss:
    ...
    Input = {
        ...
        ':focus': {'border-bottom': f'1 solid {Light.Primary}'}
    }
    ...
    SpinBox = {
        ...
        'border-bottom': f'1 solid {Light.StrokeAccessible}',
        'border-radius': 4,
        '::up-arrow': {'image': f'url(:/icons/chevron-up-16.svg)'},
        '::down-arrow': {'image': f'url(:/icons/chevron-down-16.svg)'},
        '::up-button': {
            'width': 24,
            'padding-top': '2',
    ...
    ComboBox = {
        ...
        '::down-arrow': {'image': f'url(:/icons/chevron_down-20.svg)'}
    }
