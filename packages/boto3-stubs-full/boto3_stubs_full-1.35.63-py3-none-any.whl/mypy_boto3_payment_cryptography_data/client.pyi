...
class PaymentCryptographyDataPlaneClient(BaseClient):
    ...
    def generate_mac_emv_pin_change(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/payment-cryptography-data.html#PaymentCryptographyDataPlane.Client.generate_mac_emv_pin_change)
