...
class PinpointSMSVoiceV2Client(BaseClient):
    ...
    def delete_protect_configuration_rule_set_number_override(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint-sms-voice-v2.html#PinpointSMSVoiceV2.Client.delete_protect_configuration_rule_set_number_override)
    ...
    def list_protect_configuration_rule_set_number_overrides(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint-sms-voice-v2.html#PinpointSMSVoiceV2.Client.list_protect_configuration_rule_set_number_overrides)
    ...
    def put_message_feedback(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint-sms-voice-v2.html#PinpointSMSVoiceV2.Client.put_message_feedback)
    ...
    def put_protect_configuration_rule_set_number_override(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint-sms-voice-v2.html#PinpointSMSVoiceV2.Client.put_protect_configuration_rule_set_number_override)
    ...
    def set_default_message_feedback_enabled(
        ...
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/pinpoint-sms-voice-v2.html#PinpointSMSVoiceV2.Client.set_default_message_feedback_enabled)
