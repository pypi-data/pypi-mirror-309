...
class CertificateValidator:
    # A aurora_certvalidator.path.ValidationPath object - only set once validated
    _path = None
    ...
    def __init__(
        ...
        :param validation_context:
            A aurora_certvalidator.context.ValidationContext() object that
        ...
        :param pkix_params:
            A aurora_certvalidator.context.PKIXValidationParams() object that
    ...
    async def async_validate_path(self) -> ValidationPath:
        ...
        :raises:
            aurora_certvalidator.errors.PathBuildingError - when an error occurs building the path
    ...
    def validate_usage(
        ...
        :return:
            A aurora_certvalidator.path.ValidationPath object of the validated
