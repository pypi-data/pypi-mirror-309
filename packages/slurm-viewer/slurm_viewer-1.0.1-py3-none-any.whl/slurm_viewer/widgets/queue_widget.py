...
from slurm_viewer.widgets.screens import SelectColumnsScreen, DetailScreen
    ...
    def compose(self) -> ComposeResult:
        with Vertical():
            with Horizontal(id='queue_horizontal'):
                ...
                yield Label('Auto refresh', id='queue_auto_refresh')
                yield Switch(name='auto_refresh', value=False)
