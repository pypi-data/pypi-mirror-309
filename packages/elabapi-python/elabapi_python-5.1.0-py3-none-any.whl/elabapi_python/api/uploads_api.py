...
class UploadsApi(object):
    ...
    def post_upload(self, entity_type, id, **kwargs):  # noqa: E501
        ...
        :param str file:
        :param str comment:
        :param str archived: Include archived uploads in the response if the value is truthy.
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def post_upload_with_http_info(self, entity_type, id, **kwargs):  # noqa: E501
        ...
        all_params = ['entity_type', 'id', 'file', 'comment', 'archived']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def read_uploads_with_http_info(self, entity_type, id, **kwargs):  # noqa: E501
        ...
        all_params = ['entity_type', 'id', 'archived']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
