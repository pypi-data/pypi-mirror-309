...
class TeamTagsApi(object):
    ...
    def patch_tags(self, id, **kwargs):  # noqa: E501
        """Actions on tags.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_tags(id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param int id: ID of the team. (required)
        :param IdTagsBody1 body: Parameters for modifying team tags.
        :return: list[Tag]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_tags_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_tags_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def patch_tags_with_http_info(self, id, **kwargs):  # noqa: E501
        """Actions on tags.   # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_tags_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `patch_tags`")  # noqa: E501
