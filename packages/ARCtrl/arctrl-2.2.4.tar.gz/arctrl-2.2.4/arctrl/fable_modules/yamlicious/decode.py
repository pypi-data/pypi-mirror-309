...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        ...
        def _arrow455(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr454(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow455()
        def _arrow458(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr457(IMultipleOptionalGetter):
        ...
        self.multiple_optional: IMultipleOptionalGetter = _arrow458()
