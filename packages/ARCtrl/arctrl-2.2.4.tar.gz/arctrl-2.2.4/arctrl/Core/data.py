...
class Data:
    ...
    def Name(self, __unit: None=None) -> str | None:
        ...
        def _arrow624(__unit: None=None) -> str | None:
            p_1: str = match_value
            return p_1

        def _arrow625(__unit: None=None) -> str | None:
            p: str = match_value
            s: str = match_value_1
            return DataAux_nameFromPathAndSelector(p, s)

        return None if (match_value is None) else (_arrow624() if (match_value_1 is None) else _arrow625())
