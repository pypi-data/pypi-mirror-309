...
class ProcessParameterValue(Record):
    ...
    def SetCategory(self, c: OntologyAnnotation) -> ProcessParameterValue:
        this: ProcessParameterValue = self
        def _arrow667(__unit: None=None) -> ProtocolParameter | None:
        ...
        return ProcessParameterValue(_arrow667(), this.Value, this.Unit)
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow668(__unit: None=None) -> str:
            value_2: str = value
            return value_2
        ...
        def _arrow670(__unit: None=None) -> str:
            category_1: str = category
            value_1: str = value
            return (category_1 + ":") + value_1

        return ("" if (value is None) else _arrow668()) if (category is None) else (_arrow669() if (value is None) else _arrow670())
...
ProcessParameterValue_reflection = _expr671
