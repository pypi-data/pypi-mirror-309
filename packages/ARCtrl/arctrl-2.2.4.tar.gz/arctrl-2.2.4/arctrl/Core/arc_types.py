...
class ArcAssay(ArcTables):
    def __init__(self, identifier: str, measurement_type: OntologyAnnotation | None=None, technology_type: OntologyAnnotation | None=None, technology_platform: OntologyAnnotation | None=None, tables: Array[ArcTable] | None=None, datamap: DataMap | None=None, performers: Array[Person] | None=None, comments: Array[Comment] | None=None) -> None:
        ...
        self.identifier_0040109: str = _arrow939()
            ...
            def predicate(s: ArcStudy) -> bool:
                ...
                class ObjectExpr891:
                    ...
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow890(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(this.Identifier, source, ObjectExpr891())
    ...
    def add_table(table: ArcTable, index: int | None=None) -> Callable[[ArcAssay], ArcAssay]:
        def _arrow892(assay: ArcAssay) -> ArcAssay:
    ...
    def init_table(table_name: str, index: int | None=None) -> Callable[[ArcAssay], tuple[ArcAssay, ArcTable]]:
        def _arrow894(assay: ArcAssay) -> tuple[ArcAssay, ArcTable]:
            c: ArcAssay = assay.Copy()
    ...
    def get_table_at(index: int) -> Callable[[ArcAssay], ArcTable]:
        def _arrow896(assay: ArcAssay) -> ArcTable:
    ...
    def get_column_at(table_index: int, column_index: int) -> Callable[[ArcAssay], CompositeColumn]:
        def _arrow914(assay: ArcAssay) -> CompositeColumn:
            new_assay: ArcAssay = assay.Copy()
    ...
    def get_row_at(table_index: int, row_index: int) -> Callable[[ArcAssay], Array[CompositeCell]]:
        def _arrow922(assay: ArcAssay) -> Array[CompositeCell]:
            new_assay: ArcAssay = assay.Copy()
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_1_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_1, combined_1, ObjectExpr927()):
            ...
            if not append_sequences_1:
                ...
                try: 
                    while enumerator_3.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_3, combined_2, ObjectExpr928()):
                ...
                try: 
                    while enumerator_1_2.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains_1(e_1_2, combined_2, ObjectExpr929()):
    ...
    def StructurallyEquals(self, other: ArcAssay) -> bool:
        ...
        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.MeasurementType, other.MeasurementType), equals(this.TechnologyType, other.TechnologyType), equals(this.TechnologyPlatform, other.TechnologyPlatform), equals(this.DataMap, other.DataMap), _arrow932(), _arrow935(), _arrow938()]))
...
class ArcStudy(ArcTables):
    def __init__(self, identifier: str, title: str | None=None, description: str | None=None, submission_date: str | None=None, public_release_date: str | None=None, publications: Array[Publication] | None=None, contacts: Array[Person] | None=None, study_design_descriptors: Array[OntologyAnnotation] | None=None, tables: Array[ArcTable] | None=None, datamap: DataMap | None=None, registered_assay_identifiers: Array[str] | None=None, comments: Array[Comment] | None=None) -> None:
        ...
        comments_1: Array[Comment] = default_arg(comments, [])
        def _arrow1004(__unit: None=None) -> str:
            identifier_1: str = identifier.strip()
            check_valid_characters(identifier_1)
            return identifier_1

        self.identifier_0040533: str = _arrow1004()
        self.investigation: ArcInvestigation | None = None
    ...
    def add_registered_assay(assay: ArcAssay) -> Callable[[ArcStudy], ArcStudy]:
        def _arrow941(study: ArcStudy) -> ArcStudy:
    ...
    def init_registered_assay(assay_identifier: str) -> Callable[[ArcStudy], tuple[ArcStudy, ArcAssay]]:
        def _arrow942(study: ArcStudy) -> tuple[ArcStudy, ArcAssay]:
    ...
    def RegisterAssay(self, assay_identifier: str) -> None:
        ...
        class ObjectExpr944:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow943(x: str, y: str) -> bool:
                    return x == y
        ...
        if contains(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr944()):
    ...
    def DeregisterAssay(self, assay_identifier: str) -> None:
        ...
        ignore(remove_in_place(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr947()))

    @staticmethod
    def deregister_assay(assay_identifier: str) -> Callable[[ArcStudy], ArcStudy]:
        def _arrow948(study: ArcStudy) -> ArcStudy:
            copy: ArcStudy = study.Copy()
    ...
    def GetRegisteredAssay(self, assay_identifier: str) -> ArcAssay:
        ...
        class ObjectExpr950:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow949(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains(assay_identifier, this.RegisteredAssayIdentifiers, ObjectExpr950()):
    ...
    def get_registered_assay(assay_identifier: str) -> Callable[[ArcStudy], ArcAssay]:
        def _arrow951(study: ArcStudy) -> ArcAssay:
            copy: ArcStudy = study.Copy()
    ...
    def get_registered_assays(__unit: None=None) -> Callable[[ArcStudy], Array[ArcAssay]]:
        def _arrow952(study: ArcStudy) -> Array[ArcAssay]:
            copy: ArcStudy = study.Copy()
    ...
    def get_registered_assays_or_identifier(__unit: None=None) -> Callable[[ArcStudy], Array[ArcAssay]]:
        def _arrow953(study: ArcStudy) -> Array[ArcAssay]:
            copy: ArcStudy = study.Copy()
    ...
    def add_table(table: ArcTable, index: int | None=None) -> Callable[[ArcStudy], ArcStudy]:
        def _arrow954(study: ArcStudy) -> ArcStudy:
    ...
    def add_tables(tables: IEnumerable_1[ArcTable], index: int | None=None) -> Callable[[ArcStudy], ArcStudy]:
        def _arrow955(study: ArcStudy) -> ArcStudy:
            c: ArcStudy = study.Copy()
            c.AddTables(tables, index)
            return c
    ...
    def init_table(table_name: str, index: int | None=None) -> Callable[[ArcStudy], tuple[ArcStudy, ArcTable]]:
        def _arrow956(study: ArcStudy) -> tuple[ArcStudy, ArcTable]:
            c: ArcStudy = study.Copy()
            return (c, c.InitTable(table_name, index))
    ...
    def get_table_at(index: int) -> Callable[[ArcStudy], ArcTable]:
        def _arrow958(study: ArcStudy) -> ArcTable:
    ...
    def get_table(name: str) -> Callable[[ArcStudy], ArcTable]:
        def _arrow959(study: ArcStudy) -> ArcTable:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetTable(name)
    ...
    def get_column_at(table_index: int, column_index: int) -> Callable[[ArcStudy], CompositeColumn]:
        def _arrow976(study: ArcStudy) -> CompositeColumn:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetColumnAt(table_index, column_index)
    ...
    def get_column(table_name: str, column_index: int) -> Callable[[ArcStudy], CompositeColumn]:
        def _arrow977(study: ArcStudy) -> CompositeColumn:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetColumn(table_name, column_index)
    ...
    def get_row_at(table_index: int, row_index: int) -> Callable[[ArcStudy], Array[CompositeCell]]:
        def _arrow984(study: ArcStudy) -> Array[CompositeCell]:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetRowAt(table_index, row_index)
    ...
    def get_row(table_name: str, row_index: int) -> Callable[[ArcStudy], Array[CompositeCell]]:
        def _arrow985(study: ArcStudy) -> Array[CompositeCell]:
            new_assay: ArcStudy = study.Copy()
            return new_assay.GetRow(table_name, row_index)
    ...
    def StructurallyEquals(self, other: ArcStudy) -> bool:
        ...
        def _arrow988(__unit: None=None) -> bool:
            ...
            def _arrow987(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow986(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow986, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow987))) if (length(a) == length(b)) else False

        def _arrow991(__unit: None=None) -> bool:
            ...
            def _arrow990(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow989(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow989, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow990))) if (length(a_1) == length(b_1)) else False

        def _arrow994(__unit: None=None) -> bool:
            ...
            def _arrow993(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow992(i_3: int) -> bool:
                    return equals(item(i_3, a_2), item(i_3, b_2))

                return map_1(_arrow992, range_big_int(0, 1, length(a_2) - 1))

            return fold(folder_2, True, to_list(delay(_arrow993))) if (length(a_2) == length(b_2)) else False

        def _arrow997(__unit: None=None) -> bool:
            ...
            def _arrow996(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow995(i_4: int) -> bool:
                    return equals(item(i_4, a_3), item(i_4, b_3))

                return map_1(_arrow995, range_big_int(0, 1, length(a_3) - 1))

            return fold(folder_3, True, to_list(delay(_arrow996))) if (length(a_3) == length(b_3)) else False
        ...
        def _arrow1000(__unit: None=None) -> bool:
            ...
            def _arrow999(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow998(i_5: int) -> bool:
                    return item(i_5, a_4) == item(i_5, b_4)

                return map_1(_arrow998, range_big_int(0, 1, length(a_4) - 1))

            return fold(folder_4, True, to_list(delay(_arrow999))) if (length(a_4) == length(b_4)) else False
        ...
        def _arrow1003(__unit: None=None) -> bool:
            ...
            def _arrow1002(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1001(i_6: int) -> bool:
                    return equals(item(i_6, a_5), item(i_6, b_5))

                return map_1(_arrow1001, range_big_int(0, 1, length(a_5) - 1))

            return fold(folder_5, True, to_list(delay(_arrow1002))) if (length(a_5) == length(b_5)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.SubmissionDate, other.SubmissionDate), equals(this.PublicReleaseDate, other.PublicReleaseDate), equals(this.DataMap, other.DataMap), _arrow988(), _arrow991(), _arrow994(), _arrow997(), _arrow1000(), _arrow1003()]))
...
class ArcInvestigation:
    ...
    def UnregisteredAssays(self, __unit: None=None) -> Array[ArcAssay]:
        ...
        def f(a: ArcAssay) -> bool:
            def predicate(s: ArcStudy, a: Any=a) -> bool:
                def _arrow1006(i: str, s: Any=s) -> bool:
                    return i == a.Identifier

                return exists(_arrow1006, s.RegisteredAssayIdentifiers)
    ...
    def add_assay(assay: ArcAssay, register_in: Array[ArcStudy] | None=None) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1007(inv: ArcInvestigation) -> ArcInvestigation:
    ...
    def init_assay(assay_identifier: str, register_in: Array[ArcStudy] | None=None) -> Callable[[ArcInvestigation], ArcAssay]:
        def _arrow1008(inv: ArcInvestigation) -> ArcAssay:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def delete_assay_at(index: int) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1009(inv: ArcInvestigation) -> ArcInvestigation:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def delete_assay(assay_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1010(inv: ArcInvestigation) -> ArcInvestigation:
    ...
    def GetAssayIndex(self, assay_identifier: str) -> int:
        this: ArcInvestigation = self
        def _arrow1016(a: ArcAssay) -> bool:
            return a.Identifier == assay_identifier

        index: int = find_index(_arrow1016, this.Assays) or 0
        if index == -1:
    ...
    def get_assay_index(assay_identifier: str) -> Callable[[ArcInvestigation], int]:
        def _arrow1017(inv: ArcInvestigation) -> int:
    ...
    def get_assay_at(index: int) -> Callable[[ArcInvestigation], ArcAssay]:
        def _arrow1018(inv: ArcInvestigation) -> ArcAssay:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def get_assay(assay_identifier: str) -> Callable[[ArcInvestigation], ArcAssay]:
        def _arrow1019(inv: ArcInvestigation) -> ArcAssay:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def TryGetAssay(self, assay_identifier: str) -> ArcAssay | None:
        ...
        return try_find(_arrow1020, this.Assays)

    @staticmethod
    def try_get_assay(assay_identifier: str) -> Callable[[ArcInvestigation], ArcAssay | None]:
        def _arrow1021(inv: ArcInvestigation) -> ArcAssay | None:
            new_investigation: ArcInvestigation = inv.Copy()
    ...
    def contains_assay(assay_identifier: str) -> Callable[[ArcInvestigation], bool]:
        def _arrow1022(inv: ArcInvestigation) -> bool:
    ...
    def UnregisteredStudies(self, __unit: None=None) -> Array[ArcStudy]:
        ...
        def f(s: ArcStudy) -> bool:
            def _arrow1025(__unit: None=None, s: Any=s) -> bool:
                source: Array[str] = this.RegisteredStudyIdentifiers
                def _arrow1024(__unit: None=None) -> Callable[[str], bool]:
                    x: str = s.Identifier
                    def _arrow1023(y: str) -> bool:
                        return x == y

                    return _arrow1023

                return exists(_arrow1024(), source)

            return not _arrow1025()
    ...
    def init_study(study_identifier: str) -> Callable[[ArcInvestigation], tuple[ArcInvestigation, ArcStudy]]:
        def _arrow1027(inv: ArcInvestigation) -> tuple[ArcInvestigation, ArcStudy]:
            copy: ArcInvestigation = inv.Copy()
    ...
    def RegisterStudy(self, study_identifier: str) -> None:
        ...
        if contains(study_ident_1, this.RegisteredStudyIdentifiers, ObjectExpr1029()):
    ...
    def delete_study_at(index: int) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1032(i: ArcInvestigation) -> ArcInvestigation:
    ...
    def remove_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1036(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def rename_study(old_identifier: str, new_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1037(inv: ArcInvestigation) -> ArcInvestigation:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def set_study_at(index: int, study: ArcStudy) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1038(inv: ArcInvestigation) -> ArcInvestigation:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def GetStudyIndex(self, study_identifier: str) -> int:
        this: ArcInvestigation = self
        def _arrow1041(s: ArcStudy) -> bool:
            return s.Identifier == study_identifier

        index: int = find_index(_arrow1041, this.Studies) or 0
        if index == -1:
    ...
    def get_study_index(study_identifier: str) -> Callable[[ArcInvestigation], int]:
        def _arrow1042(inv: ArcInvestigation) -> int:
    ...
    def get_study_at(index: int) -> Callable[[ArcInvestigation], ArcStudy]:
        def _arrow1044(inv: ArcInvestigation) -> ArcStudy:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def get_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcStudy]:
        def _arrow1045(inv: ArcInvestigation) -> ArcStudy:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def try_get_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcStudy | None]:
        def _arrow1047(inv: ArcInvestigation) -> ArcStudy | None:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def contains_study(study_identifier: str) -> Callable[[ArcInvestigation], bool]:
        def _arrow1048(inv: ArcInvestigation) -> bool:
    ...
    def register_assay(study_identifier: str, assay_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1054(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def DeregisterStudy(self, study_identifier: str) -> None:
        ...
        ignore(remove_in_place(study_identifier, this.RegisteredStudyIdentifiers, ObjectExpr1060()))

    @staticmethod
    def deregister_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1061(i: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = i.Copy()
    ...
    def GetAllPersons(self, __unit: None=None) -> Array[Person]:
        ...
        return Array_distinct(list(persons), ObjectExpr1062())
    ...
    def GetAllPublications(self, __unit: None=None) -> Array[Publication]:
        ...
        return Array_distinct(list(pubs), ObjectExpr1063())
            ...
            while enumerator.System_Collections_IEnumerator_MoveNext():
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        if not contains(registered_assay, existing_assays, ObjectExpr1065()):
    ...
    def UpdateIOTypeByEntityID(self, __unit: None=None) -> None:
        this: ArcInvestigation = self
        def _arrow1070(__unit: None=None) -> IEnumerable_1[ArcTable]:
            def _arrow1067(study: ArcStudy) -> IEnumerable_1[ArcTable]:
                return study.Tables

            def _arrow1069(__unit: None=None) -> IEnumerable_1[ArcTable]:
                def _arrow1068(assay: ArcAssay) -> IEnumerable_1[ArcTable]:
                    return assay.Tables

                return collect(_arrow1068, this.Assays)

            return append_3(collect(_arrow1067, this.Studies), delay(_arrow1069))

        io_map: Any = ArcTablesAux_getIOMap(list(to_list(delay(_arrow1070))))
        enumerator: Any = get_enumerator(this.Studies)
        try: 
            while enumerator.System_Collections_IEnumerator_MoveNext():
    ...
    def StructurallyEquals(self, other: ArcInvestigation) -> bool:
        ...
        def _arrow1073(__unit: None=None) -> bool:
            ...
            def _arrow1072(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1071(i_1: int) -> bool:
                    return equals(item(i_1, a), item(i_1, b))

                return map_1(_arrow1071, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow1072))) if (length(a) == length(b)) else False

        def _arrow1076(__unit: None=None) -> bool:
            a_1: IEnumerable_1[Person] = this.Contacts
            b_1: IEnumerable_1[Person] = other.Contacts
            def folder_1(acc_1: bool, e_1: bool) -> bool:
                if acc_1:
            ...
            def _arrow1075(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1074(i_2: int) -> bool:
                    return equals(item(i_2, a_1), item(i_2, b_1))

                return map_1(_arrow1074, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow1075))) if (length(a_1) == length(b_1)) else False

        def _arrow1079(__unit: None=None) -> bool:
            ...
            def _arrow1078(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1077(i_3: int) -> bool:
                    return equals(item(i_3, a_2), item(i_3, b_2))

                return map_1(_arrow1077, range_big_int(0, 1, length(a_2) - 1))

            return fold(folder_2, True, to_list(delay(_arrow1078))) if (length(a_2) == length(b_2)) else False

        def _arrow1082(__unit: None=None) -> bool:
            ...
            def _arrow1081(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1080(i_4: int) -> bool:
                    return equals(item(i_4, a_3), item(i_4, b_3))

                return map_1(_arrow1080, range_big_int(0, 1, length(a_3) - 1))

            return fold(folder_3, True, to_list(delay(_arrow1081))) if (length(a_3) == length(b_3)) else False

        def _arrow1085(__unit: None=None) -> bool:
            ...
            def _arrow1084(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1083(i_5: int) -> bool:
                    return equals(item(i_5, a_4), item(i_5, b_4))

                return map_1(_arrow1083, range_big_int(0, 1, length(a_4) - 1))

            return fold(folder_4, True, to_list(delay(_arrow1084))) if (length(a_4) == length(b_4)) else False

        def _arrow1088(__unit: None=None) -> bool:
            ...
            def _arrow1087(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1086(i_6: int) -> bool:
                    return item(i_6, a_5) == item(i_6, b_5)

                return map_1(_arrow1086, range_big_int(0, 1, length(a_5) - 1))

            return fold(folder_5, True, to_list(delay(_arrow1087))) if (length(a_5) == length(b_5)) else False

        def _arrow1091(__unit: None=None) -> bool:
            ...
            def _arrow1090(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1089(i_7: int) -> bool:
                    return equals(item(i_7, a_6), item(i_7, b_6))

                return map_1(_arrow1089, range_big_int(0, 1, length(a_6) - 1))

            return fold(folder_6, True, to_list(delay(_arrow1090))) if (length(a_6) == length(b_6)) else False

        def _arrow1094(__unit: None=None) -> bool:
            ...
            def _arrow1093(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1092(i_8: int) -> bool:
                    return equals(item(i_8, a_7), item(i_8, b_7))

                return map_1(_arrow1092, range_big_int(0, 1, length(a_7) - 1))

            return fold(folder_7, True, to_list(delay(_arrow1093))) if (length(a_7) == length(b_7)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.SubmissionDate, other.SubmissionDate), equals(this.PublicReleaseDate, other.PublicReleaseDate), _arrow1073(), _arrow1076(), _arrow1079(), _arrow1082(), _arrow1085(), _arrow1088(), _arrow1091(), _arrow1094()]))
...
ArcInvestigation_reflection = _expr1095
