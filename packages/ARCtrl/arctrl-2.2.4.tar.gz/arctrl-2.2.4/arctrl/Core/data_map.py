...
def DataMap__GetExplicationColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow747(dc: DataContext, this: Any=this) -> OntologyAnnotation | None:
        return DataContext__get_Explication(dc)

    return DataMapAux_getOntologyColumn(_arrow747, this.data_contexts_0040108)


def DataMap__SetExplicationColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow748(dc: DataContext, oa: OntologyAnnotation | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Explication_279AAFF2(dc, oa)

    DataMapAux_setOntologyColumn(_arrow748, cells, this.data_contexts_0040108)


def DataMap__GetUnitColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow749(dc: DataContext, this: Any=this) -> OntologyAnnotation | None:
        return DataContext__get_Unit(dc)

    return DataMapAux_getOntologyColumn(_arrow749, this.data_contexts_0040108)


def DataMap__SetUnitColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow750(dc: DataContext, oa: OntologyAnnotation | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Unit_279AAFF2(dc, oa)

    DataMapAux_setOntologyColumn(_arrow750, cells, this.data_contexts_0040108)
...
def DataMap__GetLabelColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow753(dc: DataContext, this: Any=this) -> str | None:
        return dc.Name

    return DataMapAux_getStringColumn(_arrow753, this.data_contexts_0040108)


def DataMap__SetLabelColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow754(dc: DataContext, s: str | None=None, this: Any=this, cells: Any=cells) -> None:
        dc.Name = s

    DataMapAux_setStringColumn(_arrow754, cells, this.data_contexts_0040108)


def DataMap__GetDescriptionColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow755(dc: DataContext, this: Any=this) -> str | None:
        return DataContext__get_Description(dc)

    return DataMapAux_getStringColumn(_arrow755, this.data_contexts_0040108)


def DataMap__SetDescriptionColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow756(dc: DataContext, s: str | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Description_6DFDD678(dc, s)

    DataMapAux_setStringColumn(_arrow756, cells, this.data_contexts_0040108)
...
def DataMap_getDataContext_Z58338566(row: int, SkipValidation: Any | None=None) -> Callable[[DataMap], DataContext]:
    def _arrow757(dm: DataMap, row: Any=row, SkipValidation: Any=SkipValidation) -> DataContext:
