...
def _arrow1996(get: IGetters) -> Publication:
    ...
    def _arrow1995(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = resize_array(decoder_2)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Publication(_arrow1986(), _arrow1987(), _arrow1988(), _arrow1991(), _arrow1993(), _arrow1995())


decoder: Decoder_1[Publication] = object(_arrow1996)
...
def ROCrate_encoder(oa: Publication) -> IEncodable:
    ...
    def _arrow2004(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2012(author_list: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2004()), ("@type", ObjectExpr2006()), try_include("pubMedID", _arrow2009, oa.PubMedID), try_include("doi", _arrow2011, oa.DOI), try_include("authorList", _arrow2012, oa.Authors), try_include("title", _arrow2014, oa.Title), try_include("status", _arrow2015, oa.Status), try_include_seq("comments", _arrow2016, oa.Comments), ("@context", context_jsonvalue)]))
