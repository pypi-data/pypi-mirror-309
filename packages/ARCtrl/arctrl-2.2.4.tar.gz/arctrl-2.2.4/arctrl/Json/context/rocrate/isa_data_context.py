...
IContext_reflection = _expr1449

def _arrow1458(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1450()), ("Data", ObjectExpr1451()), ("type", ObjectExpr1452()), ("encodingFormat", ObjectExpr1453()), ("usageInfo", ObjectExpr1454()), ("name", ObjectExpr1455()), ("comments", ObjectExpr1456())])
    ...
    return ObjectExpr1457()


context_jsonvalue: IEncodable = _arrow1458()
