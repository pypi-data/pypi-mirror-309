...
def _arrow2384(Item_1: Data) -> ProcessOutput:
    return ProcessOutput(1, Item_1)


def _arrow2386(Item_2: Material) -> ProcessOutput:
    return ProcessOutput(2, Item_2)


ROCrate_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow2382, ROCrate_decoder_1), map(_arrow2384, ROCrate_decoder_2), map(_arrow2386, ROCrate_decoder_3)]))
...
def _arrow2390(Item: Sample) -> ProcessOutput:
    return ProcessOutput(0, Item)


def _arrow2393(Item_1: Data) -> ProcessOutput:
    return ProcessOutput(1, Item_1)


def _arrow2394(Item_2: Material) -> ProcessOutput:
    return ProcessOutput(2, Item_2)


ISAJson_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow2390, ISAJson_decoder_1), map(_arrow2393, ISAJson_decoder_2), map(_arrow2394, ISAJson_decoder_3)]))
