...
def encoder(id_map: Any | None, value: MaterialAttribute) -> IEncodable:
    def f(value_1: MaterialAttribute, id_map: Any=id_map, value: Any=value) -> IEncodable:
        ...
        def _arrow2189(value_2: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow2190(oa: OntologyAnnotation, value_1: Any=value_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2189, gen_id(value_1)), try_include("characteristicType", _arrow2190, value_1.CharacteristicType)]))
