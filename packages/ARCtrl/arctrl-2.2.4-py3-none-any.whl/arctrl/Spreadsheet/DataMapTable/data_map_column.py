        ...
        def _arrow1308(__unit: None=None) -> IEnumerable_1[FSharpList[FsCell]]:
            def _arrow1307(dc_4: DataContext) -> FSharpList[FsCell]:
                ...
                def _arrow1306(__unit: None=None) -> IEnumerable_1[FsCell]:
                    def _arrow1297(__unit: None=None) -> FSharpList[FsCell]:
                    ...
                    def _arrow1305(__unit: None=None) -> IEnumerable_1[FsCell]:
                        def _arrow1304(__unit: None=None) -> IEnumerable_1[FsCell]:
                            def _arrow1303(__unit: None=None) -> IEnumerable_1[FsCell]:
                                def _arrow1302(__unit: None=None) -> IEnumerable_1[FsCell]:
                                    def _arrow1301(__unit: None=None) -> IEnumerable_1[FsCell]:
                                        ...
                                        return append(create_text(DataContext__get_GeneratedBy(dc_3)), delay(_arrow1300))

                                    return append(create_text(DataContext__get_Description(dc_3)), delay(_arrow1301))

                                return append(create_term(DataContext__get_ObjectType(dc_3)), delay(_arrow1302))

                            return append(create_term(DataContext__get_Unit(dc_3)), delay(_arrow1303))

                        return append(create_term(DataContext__get_Explication(dc_3)), delay(_arrow1304))

                    return append(_arrow1297(), delay(_arrow1305))
