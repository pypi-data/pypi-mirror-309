...
def _arrow518(value_1: YAMLElement) -> OutputBinding:
    def getter(get: IGetters) -> OutputBinding:
        def _arrow517(__unit: None=None, get: Any=get) -> str | None:
            object_arg: IOptionalGetter = get.Optional
            return object_arg.Field("glob", string)

        return OutputBinding(_arrow517())

    return object(getter, value_1)


Decode_outputBindingGlobDecoder: Callable[[YAMLElement], OutputBinding] = _arrow518

def _arrow519(value: YAMLElement) -> OutputBinding | None:
...
Decode_outputBindingDecoder: Callable[[YAMLElement], OutputBinding | None] = _arrow519

def _arrow523(value_1: YAMLElement) -> CWLType:
    def getter(get: IGetters) -> CWLType:
        def _arrow520(__unit: None=None, get: Any=get) -> str:
        ...
        def _arrow522(__unit: None=None, get: Any=get) -> bool | None:
            object_arg_2: IOptionalGetter = get.Optional
            return object_arg_2.Field("writable", bool_1)

        return CWLType(2, DirentInstance(_arrow520(), _arrow521(), _arrow522()))

    return object(getter, value_1)


Decode_direntDecoder: Callable[[YAMLElement], CWLType] = _arrow523

def _arrow525(value_1: YAMLElement) -> CWLType:
    def getter(get: IGetters) -> CWLType:
        items: str
        object_arg: IRequiredGetter = get.Required
        ...
        if items == "File":
            ...
            def _arrow524(__unit: None=None, get: Any=get) -> CWLType:
                object_arg_1: IRequiredGetter = get.Required
                return object_arg_1.Field("listing", Decode_direntDecoder)

            return CWLType(11, _arrow524())
...
Decode_cwlArrayTypeDecoder: Callable[[YAMLElement], CWLType] = _arrow525
...
def Decode_cwlTypeStringMatcher(t: str, get: IGetters) -> tuple[CWLType, bool]:
    ...
    def _arrow526(__unit: None=None, t: Any=t, get: Any=get) -> CWLType:
        object_arg: IRequiredGetter = get.Required
...
def _arrow530(value_1: YAMLElement) -> tuple[CWLType, bool]:
    def getter(get: IGetters) -> tuple[CWLType, bool]:
        ...
        if cwl_type is None:
            def _arrow529(__unit: None=None, get: Any=get) -> CWLType:
                object_arg_1: IRequiredGetter = get.Required
                return object_arg_1.Field("type", Decode_cwlArrayTypeDecoder)

            return (_arrow529(), False)
...
Decode_cwlTypeDecoder: Callable[[YAMLElement], tuple[CWLType, bool]] = _arrow530

def _arrow537(value_2: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow536(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLOutput]:
            def _arrow535(key: str) -> IEnumerable_1[CWLOutput]:
                ...
                def _arrow534(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                    ...
                    def _arrow533(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                        return singleton(output)

                    return append(_expr532() if (output_source is not None) else empty_1(), delay(_arrow533))

                return append(_expr531() if (output_binding is not None) else empty_1(), delay(_arrow534))

            return collect(_arrow535, dict_1.keys())

        return list(to_array(delay(_arrow536)))

    return object(getter, value_2)


Decode_outputArrayDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow537

def _arrow538(value: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        object_arg: IRequiredGetter = get.Required
...
Decode_outputsDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow538

def Decode_dockerRequirementDecoder(get: IGetters) -> DockerRequirement:
    def _arrow539(__unit: None=None, get: Any=get) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("dockerPull", string)

    def _arrow541(__unit: None=None, get: Any=get) -> Any | None:
        object_arg_1: IOptionalGetter = get.Optional
        def arg_3(value_1: YAMLElement) -> Any:
            def key_decoder(x: str, value_1: Any=value_1) -> str:
                return x

            def _arrow540(value_2: YAMLElement, value_1: Any=value_1) -> str:
                return string(value_2)

            return map_1(key_decoder, _arrow540, value_1)
    ...
    return DockerRequirement(_arrow539(), _arrow541(), _arrow542())
    ...
    def arg_1(value_3: YAMLElement, get: Any=get) -> Array[EnvironmentDef]:
        def decoder(value_2: YAMLElement, value_3: Any=value_3) -> EnvironmentDef:
            def getter(get2: IGetters, value_2: Any=value_2) -> EnvironmentDef:
                ...
                def _arrow544(__unit: None=None, get2: Any=get2) -> str:
                    object_arg_2: IRequiredGetter = get2.Required
                    return object_arg_2.Field("envValue", string)

                return EnvironmentDef(_arrow543(), _arrow544())
            ...
            def getter(get2: IGetters, value_5: Any=value_5) -> SoftwarePackage:
                ...
                def _arrow547(__unit: None=None, get2: Any=get2) -> Array[str] | None:
                    ...
                    def arg_5(value_1: YAMLElement) -> Array[str]:
                        def _arrow546(value_2: YAMLElement, value_1: Any=value_1) -> str:
                            return string(value_2)

                        return resizearray(_arrow546, value_1)

                    return object_arg_2.Field("version", arg_5)

                def _arrow549(__unit: None=None, get2: Any=get2) -> Array[str] | None:
                    object_arg_3: IOptionalGetter = get2.Optional
                    def arg_7(value_3: YAMLElement) -> Array[str]:
                        def _arrow548(value_4: YAMLElement, value_3: Any=value_3) -> str:
                            return string(value_4)

                        return resizearray(_arrow548, value_3)

                    return object_arg_3.Field("specs", arg_7)

                return SoftwarePackage(_arrow545(), _arrow547(), _arrow549())
