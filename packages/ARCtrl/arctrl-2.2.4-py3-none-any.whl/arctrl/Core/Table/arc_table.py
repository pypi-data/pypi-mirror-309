...
class ArcTable:
    ...
    def init(name: str) -> ArcTable:
        ...
        return ArcTable(name, [], Dictionary([], ObjectExpr780()))
    ...
    def create_from_headers(name: str, headers: Array[CompositeHeader]) -> ArcTable:
        ...
        return ArcTable.create(name, headers, Dictionary([], ObjectExpr781()))
    ...
    def validate(raise_exception: bool | None=None) -> Callable[[ArcTable], bool]:
        def _arrow782(table: ArcTable) -> bool:
    ...
    def Columns(self, __unit: None=None) -> Array[CompositeColumn]:
        this: ArcTable = self
        def _arrow784(__unit: None=None) -> IEnumerable_1[CompositeColumn]:
            def _arrow783(i: int) -> CompositeColumn:
                return this.GetColumn(i)

            return map(_arrow783, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow784))
    ...
    def Copy(self, __unit: None=None) -> ArcTable:
        ...
        next_values: Any = Dictionary([], ObjectExpr785())
    ...
    def try_get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell | None]:
        def _arrow786(table: ArcTable) -> CompositeCell | None:
    ...
    def get_cell_at(column: int, row: int) -> Callable[[ArcTable], CompositeCell]:
        def _arrow787(table: ArcTable) -> CompositeCell:
    ...
    def iteri_columns(action: Callable[[int, CompositeColumn], None]) -> Callable[[ArcTable], ArcTable]:
        def _arrow789(table: ArcTable) -> ArcTable:
            copy: ArcTable = table.Copy()
    ...
    def update_cell_at(column_index: int, row_index: int, cell: CompositeCell, skip_validation: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow790(table: ArcTable) -> ArcTable:
    ...
    def set_cell_at(column_index: int, row_index: int, cell: CompositeCell, skip_validation: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow791(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def update_cell_by(column_index: int, row_index: int, f: Callable[[CompositeCell], CompositeCell], skip_validation: bool | None=None) -> Callable[[ArcTable], None]:
        def _arrow793(table: ArcTable) -> None:
            new_table: ArcTable = table.Copy()
    ...
    def AddColumnFill(self, header: CompositeHeader, cell: CompositeCell, index: int | None=None, force_replace: bool | None=None) -> None:
        this: ArcTable = self
        def _arrow796(_arg: int) -> CompositeCell:
            return cell.Copy()

        cells: Array[CompositeCell] = initialize(this.RowCount, _arrow796, None)
    ...
    def add_column_fill(header: CompositeHeader, cell: CompositeCell, index: int | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow797(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def append_column(header: CompositeHeader, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow800(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveColumns(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow803(index: int) -> None:
            SanityChecks_validateColumnIndex(index, this.ColumnCount, False)

        iterate_2(_arrow803, index_arr)
        def _arrow804(index_1: int) -> None:
        ...
        iterate_2(_arrow804, sort_descending(index_arr, ObjectExpr805()))
    ...
    def GetColumn(self, column_index: int) -> CompositeColumn:
        ...
        def _arrow808(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow807(i: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow807, range_big_int(0, 1, this.RowCount - 1))

        cells: Array[CompositeCell] = to_array(delay(_arrow808))
        return CompositeColumn.create(h, cells)

    @staticmethod
    def get_column(index: int) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow809(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow810(table: ArcTable) -> CompositeColumn | None:
    ...
    def try_get_column_by_header_by(header_predicate: Callable[[CompositeHeader], bool]) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow811(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_column_by_header(header: CompositeHeader) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow812(table: ArcTable) -> CompositeColumn:
    ...
    def try_get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn | None]:
        def _arrow813(table: ArcTable) -> CompositeColumn | None:
    ...
    def get_input_column(__unit: None=None) -> Callable[[ArcTable], CompositeColumn]:
        def _arrow814(table: ArcTable) -> CompositeColumn:
    ...
    def AddRow(self, cells: Array[CompositeCell] | None=None, index: int | None=None) -> None:
        ...
        def _arrow819(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow818(column_index: int) -> IEnumerable_1[CompositeCell]:
            ...
            return collect(_arrow818, range_big_int(0, 1, this.ColumnCount - 1))

        cells_1: Array[CompositeCell] = to_array(delay(_arrow819)) if (cells is None) else value_3(cells)
    ...
    def insert_row(index: int, cells: Array[CompositeCell] | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow823(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
            new_table.AddRow(cells, index)
            return new_table
    ...
    def AddRowsEmpty(self, row_count: int, index: int | None=None) -> None:
        this: ArcTable = self
        def _arrow826(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow825(column_index: int) -> IEnumerable_1[CompositeCell]:
                return singleton(Unchecked_getEmptyCellForHeader(this.Headers[column_index], Unchecked_tryGetCellAt(column_index, 0, this.Values)))

            return collect(_arrow825, range_big_int(0, 1, this.ColumnCount - 1))

        row: Array[CompositeCell] = to_array(delay(_arrow826))
        def _arrow827(_arg: int) -> Array[CompositeCell]:
            return row

        rows: Array[Array[CompositeCell]] = initialize(row_count, _arrow827, None)
    ...
    def remove_row(index: int) -> Callable[[ArcTable], ArcTable]:
        def _arrow829(table: ArcTable) -> ArcTable:
            new_table: ArcTable = table.Copy()
    ...
    def RemoveRows(self, index_arr: Array[int]) -> None:
        this: ArcTable = self
        def _arrow830(index: int) -> None:
            SanityChecks_validateRowIndex(index, this.RowCount, False)

        iterate_2(_arrow830, index_arr)
        def _arrow831(index_1: int) -> None:
        ...
        iterate_2(_arrow831, sort_descending(index_arr, ObjectExpr832()))
    ...
    def GetRow(self, row_index: int, SkipValidation: bool | None=None) -> Array[CompositeCell]:
        ...
        def _arrow835(__unit: None=None) -> IEnumerable_1[CompositeCell]:
            def _arrow834(column_index: int) -> CompositeCell:
                return value_3(this.TryGetCellAt(column_index, row_index))

            return map(_arrow834, range_big_int(0, 1, this.ColumnCount - 1))

        return to_array(delay(_arrow835))

    @staticmethod
    def get_row(index: int) -> Callable[[ArcTable], Array[CompositeCell]]:
        def _arrow836(table: ArcTable) -> Array[CompositeCell]:
    ...
    def join(table: ArcTable, index: int | None=None, join_options: str | None=None, force_replace: bool | None=None) -> Callable[[ArcTable], ArcTable]:
        def _arrow837(this: ArcTable) -> ArcTable:
    ...
    def SplitByColumnValues(column_index: int) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow839(table: ArcTable) -> Array[ArcTable]:
            ...
            return map_indexed(mapping_3, map_1(mapping_1, Array_groupBy(projection, indexed(table.GetColumn(column_index).Cells), ObjectExpr838()), None), None)

        return _arrow839

    @staticmethod
    def SplitByColumnValuesByHeader(header: CompositeHeader) -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow840(table: ArcTable) -> Array[ArcTable]:
            def predicate(x: CompositeHeader) -> bool:
                return equals(x, header)
    ...
    def SplitByProtocolREF() -> Callable[[ArcTable], Array[ArcTable]]:
        def _arrow841(table: ArcTable) -> Array[ArcTable]:
    ...
    def append(table1: ArcTable, table2: ArcTable) -> ArcTable:
        def get_list(t: ArcTable) -> FSharpList[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
            def _arrow845(__unit: None=None, t: Any=t) -> IEnumerable_1[FSharpList[tuple[CompositeHeader, CompositeCell]]]:
                def _arrow844(row: int) -> FSharpList[tuple[CompositeHeader, CompositeCell]]:
                    def _arrow843(__unit: None=None) -> IEnumerable_1[tuple[CompositeHeader, CompositeCell]]:
                        def _arrow842(col: int) -> tuple[CompositeHeader, CompositeCell]:
                            return (t.Headers[col], get_item_from_dict(t.Values, (col, row)))

                        return map(_arrow842, range_big_int(0, 1, t.ColumnCount - 1))

                    return to_list(delay(_arrow843))

                return map(_arrow844, range_big_int(0, 1, t.RowCount - 1))

            return to_list(delay(_arrow845))
    ...
    def __str__(self, __unit: None=None) -> str:
        ...
        def _arrow854(__unit: None=None) -> IEnumerable_1[str]:
            def _arrow853(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow852(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow851(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow846(row_i: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i)))

                        def _arrow849(__unit: None=None) -> IEnumerable_1[str]:
                            def _arrow848(__unit: None=None) -> IEnumerable_1[str]:
                                def _arrow847(row_i_1: int) -> str:
                                    return join("\t|\t", map(to_string, this.GetRow(row_i_1)))

                                return map(_arrow847, range_big_int(row_count - 20, 1, row_count - 1))

                            return append_1(singleton("..."), delay(_arrow848))

                        def _arrow850(row_i_2: int) -> str:
                            return join("\t|\t", map(to_string, this.GetRow(row_i_2)))

                        return append_1(map(_arrow846, range_big_int(0, 1, 19)), delay(_arrow849)) if (row_count > 50) else (singleton("No rows") if (row_count == 0) else map(_arrow850, range_big_int(0, 1, row_count - 1)))

                    return append_1(singleton(join("\t|\t", map(to_string, this.Headers))), delay(_arrow851))

                return append_1(singleton("-------------"), delay(_arrow852))

            return append_1(singleton(("Table: " + this.Name) + ""), delay(_arrow853))

        return join("\n", to_list(delay(_arrow854)))
    ...
    def StructurallyEquals(self, other: ArcTable) -> bool:
        ...
        def sort(arg: Any) -> Array[Any]:
            ...
            return sort_by(projection, list(arg), ObjectExpr855())

        def _arrow858(__unit: None=None) -> bool:
            ...
            def _arrow857(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow856(i: int) -> bool:
                    return equals(item(i, a), item(i, b))

                return map(_arrow856, range_big_int(0, 1, length(a) - 1))

            return fold(folder, True, to_list(delay(_arrow857))) if (length(a) == length(b)) else False

        if _arrow858() if (this.Name == other.Name) else False:
            ...
            def _arrow860(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow859(i_1: int) -> bool:
                    return equals(item(i_1, a_1), item(i_1, b_1))

                return map(_arrow859, range_big_int(0, 1, length(a_1) - 1))

            return fold(folder_1, True, to_list(delay(_arrow860))) if (length(a_1) == length(b_1)) else False
