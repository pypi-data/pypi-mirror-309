...
def _arrow2345(Item: Sample) -> ProcessInput:
    return ProcessInput(1, Item)


def _arrow2346(Item_1: Source) -> ProcessInput:
    return ProcessInput(0, Item_1)


def _arrow2347(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2348(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2345, ROCrate_decoder_1), map(_arrow2346, ROCrate_decoder_2), map(_arrow2347, ROCrate_decoder_3), map(_arrow2348, ROCrate_decoder_4)]))
...
def _arrow2350(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2351(Item_1: Sample) -> ProcessInput:
...
ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2350, ISAJson_decoder_1), map(_arrow2351, ISAJson_decoder_2), map(_arrow2352, ISAJson_decoder_3), map(_arrow2353, ISAJson_decoder_4)]))
