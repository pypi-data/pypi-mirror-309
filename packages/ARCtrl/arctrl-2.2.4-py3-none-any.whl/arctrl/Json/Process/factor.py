...
def encoder(id_map: Any | None, value: Factor) -> IEncodable:
    def f_1(value_1: Factor, id_map: Any=id_map, value: Any=value) -> IEncodable:
        ...
        def _arrow1985(value_2: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow1990(value_4: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow1992(oa: OntologyAnnotation, value_1: Any=value_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        def _arrow1994(comment: Comment, value_1: Any=value_1) -> IEncodable:
            return ISAJson_encoder(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1985, gen_id(value_1)), try_include("factorName", _arrow1990, value_1.Name), try_include("factorType", _arrow1992, value_1.FactorType), try_include_seq("comments", _arrow1994, default_arg(value_1.Comments, []))]))
    ...
    if id_map is not None:
        def _arrow1998(f_2: Factor, id_map: Any=id_map, value: Any=value) -> str:
            return gen_id(f_2)

        return encode(_arrow1998, f_1, value, id_map)
...
def _arrow2007(get: IGetters) -> Factor:
    def _arrow2001(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("factorName", string)

    def _arrow2003(__unit: None=None) -> OntologyAnnotation | None:
    ...
    return Factor(_arrow2001(), _arrow2003(), _arrow2005())


decoder: Decoder_1[Factor] = object(_arrow2007)
