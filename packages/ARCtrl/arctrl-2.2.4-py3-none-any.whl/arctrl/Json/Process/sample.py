...
def _arrow2369(get: IGetters) -> Sample:
    ...
    def _arrow2366(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("@id", Decode_uri)

    def _arrow2367(__unit: None=None) -> str | None:
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("name", string)

    def _arrow2368(__unit: None=None) -> FSharpList[Source] | None:
        arg_15: Decoder_1[FSharpList[Source]] = list_1_3(ROCrate_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("derivesFrom", arg_15)

    return Sample(_arrow2366(), _arrow2367(), pattern_input[0], pattern_input[1], _arrow2368())


ROCrate_decoder: Decoder_1[Sample] = object(_arrow2369)
...
def ISAJson_encoder(id_map: Any | None, oa: Sample) -> IEncodable:
    def f(oa_1: Sample, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2373(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2375(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2376(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        def _arrow2377(fv: FactorValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, fv)

        def _arrow2378(oa_3: Source, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, oa_3)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2373, ROCrate_genID(oa_1)), try_include("name", _arrow2375, oa_1.Name), try_include_list_opt("characteristics", _arrow2376, oa_1.Characteristics), try_include_list_opt("factorValues", _arrow2377, oa_1.FactorValues), try_include_list_opt("derivesFrom", _arrow2378, oa_1.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2380(s_1: Sample, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2380, f, oa, id_map)
...
def _arrow2392(get: IGetters) -> Sample:
    ...
    def _arrow2387(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    def _arrow2388(__unit: None=None) -> FSharpList[FactorValue] | None:
        arg_7: Decoder_1[FSharpList[FactorValue]] = list_1_3(ISAJson_decoder_2)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("factorValues", arg_7)

    def _arrow2391(__unit: None=None) -> FSharpList[Source] | None:
        arg_9: Decoder_1[FSharpList[Source]] = list_1_3(ISAJson_decoder_3)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("derivesFrom", arg_9)

    return Sample(_arrow2383(), _arrow2385(), _arrow2387(), _arrow2388(), _arrow2391())


ISAJson_decoder: Decoder_1[Sample] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2392)
