...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr1807(), None)
            ...
            pattern_input_1 = (ObjectExpr1809(), None)

        elif v.tag == 0:
            oa_1: OntologyAnnotation = v.fields[0]
            def _arrow1812(value_3: str, pv: Any=pv) -> IEncodable:
            ...
            def _arrow1814(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow1812, oa_1.Name), map(_arrow1814, oa_1.TermAccessionNumber))
            ...
            pattern_input_1 = (ObjectExpr1815(), None)
