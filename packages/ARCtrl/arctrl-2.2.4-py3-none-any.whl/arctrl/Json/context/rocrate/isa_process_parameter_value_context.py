...
IContext_reflection = _expr1588

def _arrow1599(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1589()), ("additionalType", ObjectExpr1590()), ("ProcessParameterValue", ObjectExpr1591()), ("category", ObjectExpr1592()), ("categoryCode", ObjectExpr1593()), ("value", ObjectExpr1594()), ("valueCode", ObjectExpr1595()), ("unit", ObjectExpr1596()), ("unitCode", ObjectExpr1597())])
...
context_jsonvalue: IEncodable = _arrow1599()
