...
def _arrow1506(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1500()), ("arc", ObjectExpr1501()), ("MaterialAttribute", ObjectExpr1502()), ("ArcMaterialAttribute", ObjectExpr1503()), ("characteristicType", ObjectExpr1504())])
