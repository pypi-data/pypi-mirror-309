...
def _arrow1481(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1470()), ("FactorValue", ObjectExpr1471()), ("additionalType", ObjectExpr1472()), ("category", ObjectExpr1473()), ("categoryName", ObjectExpr1474()), ("categoryCode", ObjectExpr1475()), ("value", ObjectExpr1476()), ("valueCode", ObjectExpr1477()), ("unit", ObjectExpr1478()), ("unitCode", ObjectExpr1479())])
