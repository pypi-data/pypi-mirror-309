...
IContext_reflection = _expr1574

def _arrow1587(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1575()), ("bio", ObjectExpr1576()), ("Process", ObjectExpr1577()), ("name", ObjectExpr1578()), ("executesProtocol", ObjectExpr1579()), ("parameterValues", ObjectExpr1580()), ("performer", ObjectExpr1581()), ("date", ObjectExpr1582()), ("inputs", ObjectExpr1583()), ("outputs", ObjectExpr1584()), ("comments", ObjectExpr1585())])
...
context_jsonvalue: IEncodable = _arrow1587()
