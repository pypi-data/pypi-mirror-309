...
IContext_reflection = _expr1438

def _arrow1448(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1439()), ("Component", ObjectExpr1440()), ("category", ObjectExpr1441()), ("categoryCode", ObjectExpr1442()), ("value", ObjectExpr1443()), ("valueCode", ObjectExpr1444()), ("unit", ObjectExpr1445()), ("unitCode", ObjectExpr1446())])
    ...
    return ObjectExpr1447()


context_jsonvalue: IEncodable = _arrow1448()
