...
IContext_reflection = _expr1650

def _arrow1667(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1651()), ("Study", ObjectExpr1652()), ("identifier", ObjectExpr1653()), ("title", ObjectExpr1654()), ("additionalType", ObjectExpr1655()), ("description", ObjectExpr1656()), ("submissionDate", ObjectExpr1657()), ("publicReleaseDate", ObjectExpr1658()), ("publications", ObjectExpr1659()), ("people", ObjectExpr1660()), ("assays", ObjectExpr1661()), ("filename", ObjectExpr1662()), ("comments", ObjectExpr1663()), ("processSequence", ObjectExpr1664()), ("studyDesignDescriptors", ObjectExpr1665())])
    ...
    return ObjectExpr1666()


context_jsonvalue: IEncodable = _arrow1667()
