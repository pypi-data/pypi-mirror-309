...
def _arrow2560(arg: Organisation) -> IEncodable:
...
Template_Organisation_encoder: Callable[[Organisation], IEncodable] = _arrow2560
...
def Template_encoder(template: Template) -> IEncodable:
    def _arrow2566(__unit: None=None, template: Any=template) -> IEncodable:
        value_1: str
    ...
    def _arrow2570(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    def _arrow2572(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2566()), ("table", encoder(template.Table)), ("name", _arrow2570()), ("description", _arrow2572()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2577()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", date_time(template.LastUpdated))])
