...
def encoder(inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2855(__unit: None=None, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2857(value_1: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2859(value_3: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2861(value_5: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2863(value_7: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2864(osr: OntologySourceReference, inv: Any=inv) -> IEncodable:
        return encoder_1(osr)

    def _arrow2865(oa: Publication, inv: Any=inv) -> IEncodable:
        return encoder_2(oa)

    def _arrow2866(person: Person, inv: Any=inv) -> IEncodable:
        return encoder_3(person)

    def _arrow2867(assay: ArcAssay, inv: Any=inv) -> IEncodable:
        return encoder_4(assay)

    def _arrow2868(study: ArcStudy, inv: Any=inv) -> IEncodable:
        return encoder_5(study)

    def _arrow2870(value_9: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2872(comment: Comment, inv: Any=inv) -> IEncodable:
        return encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2855()), try_include("Title", _arrow2857, inv.Title), try_include("Description", _arrow2859, inv.Description), try_include("SubmissionDate", _arrow2861, inv.SubmissionDate), try_include("PublicReleaseDate", _arrow2863, inv.PublicReleaseDate), try_include_seq("OntologySourceReferences", _arrow2864, inv.OntologySourceReferences), try_include_seq("Publications", _arrow2865, inv.Publications), try_include_seq("Contacts", _arrow2866, inv.Contacts), try_include_seq("Assays", _arrow2867, inv.Assays), try_include_seq("Studies", _arrow2868, inv.Studies), try_include_seq("RegisteredStudyIdentifiers", _arrow2870, inv.RegisteredStudyIdentifiers), try_include_seq("Comments", _arrow2872, inv.Comments)]))
...
def _arrow2894(get: IGetters) -> ArcInvestigation:
    ...
    def _arrow2882(__unit: None=None) -> str | None:
    ...
    return ArcInvestigation(_arrow2881(), _arrow2882(), _arrow2883(), _arrow2885(), _arrow2886(), _arrow2887(), _arrow2888(), _arrow2889(), _arrow2890(), _arrow2891(), _arrow2892(), _arrow2893())
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2900(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2902(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2904(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2906(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2907(osr: OntologySourceReference, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_1(osr)

    def _arrow2908(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_2(oa)

    def _arrow2909(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_3(person)

    def _arrow2910(assay: ArcAssay, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, assay)

    def _arrow2911(study: ArcStudy, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, study)

    def _arrow2913(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2914(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2898()), try_include("Title", _arrow2900, inv.Title), try_include("Description", _arrow2902, inv.Description), try_include("SubmissionDate", _arrow2904, inv.SubmissionDate), try_include("PublicReleaseDate", _arrow2906, inv.PublicReleaseDate), try_include_seq("OntologySourceReferences", _arrow2907, inv.OntologySourceReferences), try_include_seq("Publications", _arrow2908, inv.Publications), try_include_seq("Contacts", _arrow2909, inv.Contacts), try_include_seq("Assays", _arrow2910, inv.Assays), try_include_seq("Studies", _arrow2911, inv.Studies), try_include_seq("RegisteredStudyIdentifiers", _arrow2913, inv.RegisteredStudyIdentifiers), try_include_seq("Comments", _arrow2914, inv.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcInvestigation]:
    def _arrow2928(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcInvestigation:
        def _arrow2916(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)
        ...
        def _arrow2921(__unit: None=None) -> Array[OntologySourceReference] | None:
            arg_11: Decoder_1[Array[OntologySourceReference]] = resize_array(decoder_3)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("OntologySourceReferences", arg_11)

        def _arrow2922(__unit: None=None) -> Array[Publication] | None:
            arg_13: Decoder_1[Array[Publication]] = resize_array(decoder_4)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Publications", arg_13)
        ...
        def _arrow2924(__unit: None=None) -> Array[ArcAssay] | None:
            arg_17: Decoder_1[Array[ArcAssay]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Assays", arg_17)

        def _arrow2925(__unit: None=None) -> Array[ArcStudy] | None:
            arg_19: Decoder_1[Array[ArcStudy]] = resize_array(decoder_compressed_2(string_table, oa_table, cell_table))
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("Studies", arg_19)

        def _arrow2926(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredStudyIdentifiers", arg_21)

        def _arrow2927(__unit: None=None) -> Array[Comment] | None:
            arg_23: Decoder_1[Array[Comment]] = resize_array(decoder_8)
            object_arg_11: IOptionalGetter = get.Optional
            return object_arg_11.Field("Comments", arg_23)

        return ArcInvestigation(_arrow2916(), _arrow2917(), _arrow2918(), _arrow2919(), _arrow2920(), _arrow2921(), _arrow2922(), _arrow2923(), _arrow2924(), _arrow2925(), _arrow2926(), _arrow2927())

    return object(_arrow2928)
...
def ROCrate_encoder(oa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2932(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2936(__unit: None=None, oa: Any=oa) -> IEncodable:
        value_3: str = oa.Identifier
        class ObjectExpr2935(IEncodable):
            def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                return helpers_3.encode_string(value_3)

        return ObjectExpr2935()

    def _arrow2938(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2940(value_5: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2942(value_7: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2944(value_9: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2946(value_11: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2947(osr: OntologySourceReference, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(osr)

    def _arrow2948(oa_1: Publication, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(oa_1)

    def _arrow2949(oa_2: Person, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_3(oa_2)

    def _arrow2950(s: ArcStudy, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_4(None, s)

    def _arrow2951(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2932()), ("@type", ObjectExpr2933()), ("additionalType", ObjectExpr2934()), ("identifier", _arrow2936()), ("filename", _arrow2938()), try_include("title", _arrow2940, oa.Title), try_include("description", _arrow2942, oa.Description), try_include("submissionDate", _arrow2944, oa.SubmissionDate), try_include("publicReleaseDate", _arrow2946, oa.PublicReleaseDate), try_include_seq("ontologySourceReferences", _arrow2947, oa.OntologySourceReferences), try_include_seq("publications", _arrow2948, oa.Publications), try_include_seq("people", _arrow2949, oa.Contacts), try_include_seq("studies", _arrow2950, oa.Studies), try_include_seq("comments", _arrow2951, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2964(get: IGetters) -> ArcInvestigation:
    identifier: str
    ...
    def _arrow2953(__unit: None=None) -> FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]] | None:
    ...
    pattern_input: tuple[FSharpList[ArcStudy], FSharpList[FSharpList[ArcAssay]]] = unzip(default_arg(_arrow2953(), empty()))
    studies_raw: FSharpList[ArcStudy] = pattern_input[0]
    def projection(a: ArcAssay) -> str:
        return a.Identifier

    class ObjectExpr2955:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow2954(x: str, y: str) -> bool:
                return x == y
    ...
    assays: Array[ArcAssay] = list(distinct_by(projection, concat(pattern_input[1]), ObjectExpr2955()))
    ...
    def _arrow2960(__unit: None=None) -> Array[OntologySourceReference] | None:
    ...
    def _arrow2961(__unit: None=None) -> Array[Publication] | None:
        arg_15: Decoder_1[Array[Publication]] = resize_array(ROCrate_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("publications", arg_15)

    def _arrow2962(__unit: None=None) -> Array[Person] | None:
        arg_17: Decoder_1[Array[Person]] = resize_array(ROCrate_decoder_4)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("people", arg_17)

    def _arrow2963(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_5)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return ArcInvestigation(identifier, _arrow2956(), _arrow2957(), _arrow2958(), _arrow2959(), _arrow2960(), _arrow2961(), _arrow2962(), assays, studies, study_identifiers, _arrow2963())


ROCrate_decoder: Decoder_1[ArcInvestigation] = object(_arrow2964)
...
def ROCrate_encodeRoCrate(oa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2968(value: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2970(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2971(oa_1: ArcInvestigation, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@type", _arrow2968, "CreativeWork"), try_include("@id", _arrow2970, "ro-crate-metadata.json"), try_include("about", _arrow2971, oa), ("conformsTo", conforms_to_jsonvalue), ("@context", context_jsonvalue_1)]))
...
def ISAJson_encoder(id_map: Any | None, inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2976(__unit: None=None, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2978(__unit: None=None, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2980(__unit: None=None, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2983(value_3: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2986(value_5: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2990(value_7: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2993(value_9: str, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2994(osr: OntologySourceReference, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_1(id_map, osr)

    def _arrow2998(oa: Publication, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_2(id_map, oa)

    def _arrow3000(person: Person, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_3(id_map, person)

    def _arrow3001(s: ArcStudy, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_4(id_map, None, s)

    def _arrow3002(comment: Comment, id_map: Any=id_map, inv: Any=inv) -> IEncodable:
        return ISAJson_encoder_5(id_map, comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2976()), ("filename", _arrow2978()), ("identifier", _arrow2980()), try_include("title", _arrow2983, inv.Title), try_include("description", _arrow2986, inv.Description), try_include("submissionDate", _arrow2990, inv.SubmissionDate), try_include("publicReleaseDate", _arrow2993, inv.PublicReleaseDate), try_include_seq("ontologySourceReferences", _arrow2994, inv.OntologySourceReferences), try_include_seq("publications", _arrow2998, inv.Publications), try_include_seq("people", _arrow3000, inv.Contacts), try_include_seq("studies", _arrow3001, inv.Studies), try_include_seq("comments", _arrow3002, inv.Comments)]))
...
def _arrow3028(get: IGetters) -> ArcInvestigation:
    identifer: str
    match_value: str | None
    object_arg: IOptionalGetter = get.Optional
    match_value = object_arg.Field("identifier", string)
    identifer = create_missing_identifier() if (match_value is None) else match_value
    def _arrow3014(__unit: None=None) -> FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]] | None:
        arg_3: Decoder_1[FSharpList[tuple[ArcStudy, FSharpList[ArcAssay]]]] = list_1_1(ISAJson_decoder_1)
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("studies", arg_3)

    pattern_input: tuple[FSharpList[ArcStudy], FSharpList[FSharpList[ArcAssay]]] = unzip(default_arg(_arrow3014(), empty()))
    studies_raw: FSharpList[ArcStudy] = pattern_input[0]
    def projection(a: ArcAssay) -> str:
        return a.Identifier

    class ObjectExpr3016:
        @property
        def Equals(self) -> Callable[[str, str], bool]:
            def _arrow3015(x: str, y: str) -> bool:
                return x == y
    ...
    assays: Array[ArcAssay] = list(distinct_by(projection, concat(pattern_input[1]), ObjectExpr3016()))
    studies: Array[ArcStudy] = list(studies_raw)
    def mapping(a_1: ArcStudy) -> str:
        return a_1.Identifier
    ...
    def _arrow3019(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("description", string)

    def _arrow3020(__unit: None=None) -> str | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("submissionDate", string)

    def _arrow3022(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("publicReleaseDate", string)

    def _arrow3023(__unit: None=None) -> Array[OntologySourceReference] | None:
        arg_13: Decoder_1[Array[OntologySourceReference]] = resize_array(ISAJson_decoder_2)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("ontologySourceReferences", arg_13)

    def _arrow3025(__unit: None=None) -> Array[Publication] | None:
        arg_15: Decoder_1[Array[Publication]] = resize_array(ISAJson_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("publications", arg_15)

    def _arrow3026(__unit: None=None) -> Array[Person] | None:
        arg_17: Decoder_1[Array[Person]] = resize_array(ISAJson_decoder_4)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("people", arg_17)

    def _arrow3027(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return ArcInvestigation(identifer, _arrow3018(), _arrow3019(), _arrow3020(), _arrow3022(), _arrow3023(), _arrow3025(), _arrow3026(), assays, studies, study_identifiers, _arrow3027())


ISAJson_decoder: Decoder_1[ArcInvestigation] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow3028)
