...
def encode(encoder: Callable[[Any, Any, Any, _A], IEncodable], obj: Any) -> IEncodable:
    ...
    oa_table: Any = Dictionary([], ObjectExpr3156())
    ...
    cell_table: Any = Dictionary([], ObjectExpr3157())
...
def decode(decoder: Callable[[Array[str], Array[OntologyAnnotation], Array[CompositeCell]], __A]) -> Decoder_1[Any]:
    def _arrow3160(get: IGetters, decoder: Any=decoder) -> __B:
        ...
        def _arrow3159(__unit: None=None) -> Array[CompositeCell]:
