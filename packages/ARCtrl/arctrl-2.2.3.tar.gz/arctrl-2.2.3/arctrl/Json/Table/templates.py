...
def _arrow2574(arg: Organisation) -> IEncodable:
...
Template_Organisation_encoder: Callable[[Organisation], IEncodable] = _arrow2574
...
def Template_encoder(template: Template) -> IEncodable:
    def _arrow2576(__unit: None=None, template: Any=template) -> IEncodable:
        value_1: str
    ...
    def _arrow2580(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    def _arrow2582(__unit: None=None, template: Any=template) -> IEncodable:
    ...
    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2576()), ("table", encoder(template.Table)), ("name", _arrow2578()), ("description", _arrow2580()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2582()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", date_time(template.LastUpdated))])
...
def _arrow2594(get: IGetters) -> Template:
    def _arrow2584(__unit: None=None) -> str:
        object_arg: IRequiredGetter = get.Required
        return object_arg.Field("id", guid)

    def _arrow2585(__unit: None=None) -> ArcTable:
    ...
    def _arrow2590(__unit: None=None) -> Array[Person] | None:
        arg_13: Decoder_1[Array[Person]] = resize_array(decoder_2)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("authors", arg_13)

    def _arrow2591(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2592(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2593(__unit: None=None) -> Any:
        object_arg_9: IRequiredGetter = get.Required
        return object_arg_9.Field("last_updated", Decode_datetime)

    return Template.create(_arrow2584(), _arrow2585(), _arrow2586(), _arrow2587(), _arrow2588(), _arrow2589(), _arrow2590(), _arrow2591(), _arrow2592(), _arrow2593())


Template_decoder: Decoder_1[Template] = object(_arrow2594)

def Template_encoderCompressed(string_table: Any, oa_table: Any, cell_table: Any, template: Template) -> IEncodable:
    def _arrow2596(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_1: str
        copy_of_struct: str = template.Id
        value_1 = str(copy_of_struct)
    ...
    def _arrow2598(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_3: str = template.Name
    ...
    def _arrow2600(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_4: str = template.Description
    ...
    def _arrow2602(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
        value_5: str = template.Version
    ...
    def _arrow2604(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, template: Any=template) -> IEncodable:
    ...
    values_3: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("id", _arrow2596()), ("table", encoder_compressed(string_table, oa_table, cell_table, template.Table)), ("name", _arrow2598()), ("description", _arrow2600()), ("organisation", Template_Organisation_encoder(template.Organisation)), ("version", _arrow2602()), ("authors", seq(map(mapping, template.Authors))), ("endpoint_repositories", seq(map(mapping_1, template.EndpointRepositories))), ("tags", seq(map(mapping_2, template.Tags))), ("last_updated", _arrow2604())])
...
def Template_decoderCompressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[Template]:
    def _arrow2616(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> Template:
        ...
        def _arrow2607(__unit: None=None) -> ArcTable:
        ...
        def _arrow2609(__unit: None=None) -> str:
            object_arg_3: IRequiredGetter = get.Required
            return object_arg_3.Field("description", string)

        def _arrow2610(__unit: None=None) -> Organisation:
            object_arg_4: IRequiredGetter = get.Required
            return object_arg_4.Field("organisation", Template_Organisation_decoder)
        ...
        def _arrow2612(__unit: None=None) -> Array[Person] | None:
            arg_13: Decoder_1[Array[Person]] = resize_array(decoder_2)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("authors", arg_13)

        def _arrow2613(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_15: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("endpoint_repositories", arg_15)
        ...
        return Template.create(_arrow2606(), _arrow2607(), _arrow2608(), _arrow2609(), _arrow2610(), _arrow2611(), _arrow2612(), _arrow2613(), _arrow2614(), _arrow2615())
