...
def OntologyAnnotation_encoder(oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1736(value: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1738(value_2: str, oa: Any=oa) -> IEncodable:
        class ObjectExpr1737(IEncodable):
            def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                return helpers_1.encode_string(value_2)

        return ObjectExpr1737()

    def _arrow1740(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1741(comment: Comment, oa: Any=oa) -> IEncodable:
        return encoder(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("annotationValue", _arrow1736, oa.Name), try_include("termSource", _arrow1738, oa.TermSourceREF), try_include("termAccession", _arrow1740, oa.TermAccessionNumber), try_include_seq("comments", _arrow1741, oa.Comments)]))
...
def _arrow1747(get: IGetters) -> OntologyAnnotation:
    ...
    return OntologyAnnotation.create(_arrow1743(), _arrow1744(), _arrow1745(), _arrow1746())


OntologyAnnotation_decoder: Decoder_1[OntologyAnnotation] = object(_arrow1747)
...
def OntologyAnnotation_compressedEncoder(string_table: Any, oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1749(s: str, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encode_string(string_table, s)

    def _arrow1750(s_1: str, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encode_string(string_table, s_1)

    def _arrow1751(s_2: str, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encode_string(string_table, s_2)

    def _arrow1752(comment: Comment, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encoder(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("a", _arrow1749, oa.Name), try_include("ts", _arrow1750, oa.TermSourceREF), try_include("ta", _arrow1751, oa.TermAccessionNumber), try_include_seq("comments", _arrow1752, oa.Comments)]))
    ...
    return ObjectExpr1753()


def OntologyAnnotation_compressedDecoder(string_table: Array[str]) -> Decoder_1[OntologyAnnotation]:
    def _arrow1758(get: IGetters, string_table: Any=string_table) -> OntologyAnnotation:
        ...
        return OntologyAnnotation(_arrow1754(), _arrow1755(), _arrow1756(), _arrow1757())
...
def OntologyAnnotation_ROCrate_encoderDefinedTerm(oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1762(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1765(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1767(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1769(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1770(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1762()), ("@type", ObjectExpr1763()), try_include("annotationValue", _arrow1765, oa.Name), try_include("termSource", _arrow1767, oa.TermSourceREF), try_include("termAccession", _arrow1769, oa.TermAccessionNumber), try_include_seq("comments", _arrow1770, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow1776(get: IGetters) -> OntologyAnnotation:
    ...
    def _arrow1775(__unit: None=None) -> Array[Comment] | None:
        arg_7: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoderDisambiguatingDescription)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("comments", arg_7)

    return OntologyAnnotation.create(_arrow1772(), _arrow1773(), _arrow1774(), _arrow1775())


OntologyAnnotation_ROCrate_decoderDefinedTerm: Decoder_1[OntologyAnnotation] = object(_arrow1776)
...
def OntologyAnnotation_ROCrate_encoderPropertyValue(oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1780(__unit: None=None, oa: Any=oa) -> IEncodable:
        value: str = OntologyAnnotation_ROCrate_genID(oa)
    ...
    def _arrow1783(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1785(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1786(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1780()), ("@type", ObjectExpr1781()), try_include("category", _arrow1783, oa.Name), try_include("categoryCode", _arrow1785, oa.TermAccessionNumber), try_include_seq("comments", _arrow1786, oa.Comments), ("@context", context_jsonvalue_1)]))
...
def _arrow1791(get: IGetters) -> OntologyAnnotation:
    def _arrow1788(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("category", string)

    def _arrow1789(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("categoryCode", string)

    def _arrow1790(__unit: None=None) -> Array[Comment] | None:
    ...
    return OntologyAnnotation.create(_arrow1788(), None, _arrow1789(), _arrow1790())


OntologyAnnotation_ROCrate_decoderPropertyValue: Decoder_1[OntologyAnnotation] = object(_arrow1791)
...
def OntologyAnnotation_ISAJson_encoder(id_map: Any | None, oa: OntologyAnnotation) -> IEncodable:
    def f(oa_1: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow1795(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1797(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1799(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1801(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1802(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return encoder(comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1795, OntologyAnnotation_ROCrate_genID(oa_1)), try_include("annotationValue", _arrow1797, oa_1.Name), try_include("termSource", _arrow1799, oa_1.TermSourceREF), try_include("termAccession", _arrow1801, oa_1.TermAccessionNumber), try_include_seq("comments", _arrow1802, comments)]))
    ...
    if id_map is not None:
        def _arrow1804(o: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> str:
            return OntologyAnnotation_ROCrate_genID(o)

        return encode(_arrow1804, f, oa, id_map)
