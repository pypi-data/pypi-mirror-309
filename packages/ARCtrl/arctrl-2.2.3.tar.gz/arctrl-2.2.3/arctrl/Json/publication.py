...
def ROCrate_encoder(oa: Publication) -> IEncodable:
    ...
    def _arrow2002(value_6: str, oa: Any=oa) -> IEncodable:
...
def _arrow2022(get: IGetters) -> Publication:
    ...
    def _arrow2018(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("status", OntologyAnnotation_ROCrate_decoderDefinedTerm)

    def _arrow2021(__unit: None=None) -> Array[Comment] | None:
        arg_11: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoderDisambiguatingDescription)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_11)

    return Publication(_arrow2013(), _arrow2014(), _arrow2016(), _arrow2017(), _arrow2018(), _arrow2021())


ROCrate_decoder: Decoder_1[Publication] = object(_arrow2022)
