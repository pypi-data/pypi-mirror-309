...
IContext_reflection = _expr1493

def _arrow1506(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1497()), ("arc", ObjectExpr1499()), ("MaterialAttribute", ObjectExpr1500()), ("ArcMaterialAttribute", ObjectExpr1503()), ("characteristicType", ObjectExpr1504())])
...
context_jsonvalue: IEncodable = _arrow1506()
