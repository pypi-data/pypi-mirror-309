...
IContext_reflection = _expr1460

def _arrow1481(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1463()), ("FactorValue", ObjectExpr1465()), ("additionalType", ObjectExpr1467()), ("category", ObjectExpr1468()), ("categoryName", ObjectExpr1470()), ("categoryCode", ObjectExpr1471()), ("value", ObjectExpr1473()), ("valueCode", ObjectExpr1475()), ("unit", ObjectExpr1478()), ("unitCode", ObjectExpr1479())])
    ...
    return ObjectExpr1480()


context_jsonvalue: IEncodable = _arrow1481()
