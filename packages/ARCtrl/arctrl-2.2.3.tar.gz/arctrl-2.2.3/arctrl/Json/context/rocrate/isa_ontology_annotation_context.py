...
IContext_reflection = _expr1528

def _arrow1536(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1529()), ("OntologyAnnotation", ObjectExpr1530()), ("annotationValue", ObjectExpr1531()), ("termSource", ObjectExpr1532()), ("termAccession", ObjectExpr1533()), ("comments", ObjectExpr1534())])
    ...
    return ObjectExpr1535()


context_jsonvalue: IEncodable = _arrow1536()
