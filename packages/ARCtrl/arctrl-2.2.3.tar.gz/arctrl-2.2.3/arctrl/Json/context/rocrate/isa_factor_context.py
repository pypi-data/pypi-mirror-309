...
def _arrow1477(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1461()), ("Factor", ObjectExpr1462()), ("factorName", ObjectExpr1464()), ("annotationValue", ObjectExpr1466()), ("termSource", ObjectExpr1469()), ("termAccession", ObjectExpr1472()), ("comments", ObjectExpr1474())])
    ...
    return ObjectExpr1476()


context_jsonvalue: IEncodable = _arrow1477()
