...
def encoder(inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2876(person: Person, inv: Any=inv) -> IEncodable:
        return encoder_3(person)

    def _arrow2877(assay: ArcAssay, inv: Any=inv) -> IEncodable:
        return encoder_4(assay)

    def _arrow2879(study: ArcStudy, inv: Any=inv) -> IEncodable:
        return encoder_5(study)

    def _arrow2882(value_9: str, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2883(comment: Comment, inv: Any=inv) -> IEncodable:
        return encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2864()), try_include("Title", _arrow2866, inv.Title), try_include("Description", _arrow2868, inv.Description), try_include("SubmissionDate", _arrow2870, inv.SubmissionDate), try_include("PublicReleaseDate", _arrow2872, inv.PublicReleaseDate), try_include_seq("OntologySourceReferences", _arrow2873, inv.OntologySourceReferences), try_include_seq("Publications", _arrow2874, inv.Publications), try_include_seq("Contacts", _arrow2876, inv.Contacts), try_include_seq("Assays", _arrow2877, inv.Assays), try_include_seq("Studies", _arrow2879, inv.Studies), try_include_seq("RegisteredStudyIdentifiers", _arrow2882, inv.RegisteredStudyIdentifiers), try_include_seq("Comments", _arrow2883, inv.Comments)]))
...
def _arrow2914(get: IGetters) -> ArcInvestigation:
    ...
    return ArcInvestigation(_arrow2892(), _arrow2894(), _arrow2895(), _arrow2896(), _arrow2897(), _arrow2900(), _arrow2906(), _arrow2907(), _arrow2909(), _arrow2910(), _arrow2911(), _arrow2912())


decoder: Decoder_1[ArcInvestigation] = object(_arrow2914)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, inv: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2921(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        value: str = inv.Identifier
    ...
    def _arrow2926(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        class ObjectExpr2925(IEncodable):
            def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                return helpers_1.encode_string(value_1)

        return ObjectExpr2925()

    def _arrow2934(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2936(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2938(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2939(osr: OntologySourceReference, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_1(osr)
    ...
    def _arrow2943(study: ArcStudy, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, study)

    def _arrow2945(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
    ...
    def _arrow2946(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, inv: Any=inv) -> IEncodable:
        return encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2921()), try_include("Title", _arrow2926, inv.Title), try_include("Description", _arrow2934, inv.Description), try_include("SubmissionDate", _arrow2936, inv.SubmissionDate), try_include("PublicReleaseDate", _arrow2938, inv.PublicReleaseDate), try_include_seq("OntologySourceReferences", _arrow2939, inv.OntologySourceReferences), try_include_seq("Publications", _arrow2940, inv.Publications), try_include_seq("Contacts", _arrow2941, inv.Contacts), try_include_seq("Assays", _arrow2942, inv.Assays), try_include_seq("Studies", _arrow2943, inv.Studies), try_include_seq("RegisteredStudyIdentifiers", _arrow2945, inv.RegisteredStudyIdentifiers), try_include_seq("Comments", _arrow2946, inv.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcInvestigation]:
    def _arrow2965(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcInvestigation:
        ...
        def _arrow2955(__unit: None=None) -> str | None:
            object_arg_3: IOptionalGetter = get.Optional
            return object_arg_3.Field("SubmissionDate", string)
        ...
        def _arrow2957(__unit: None=None) -> Array[OntologySourceReference] | None:
            arg_11: Decoder_1[Array[OntologySourceReference]] = resize_array(decoder_3)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("OntologySourceReferences", arg_11)

        def _arrow2958(__unit: None=None) -> Array[Publication] | None:
            arg_13: Decoder_1[Array[Publication]] = resize_array(decoder_4)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Publications", arg_13)

        def _arrow2959(__unit: None=None) -> Array[Person] | None:
            arg_15: Decoder_1[Array[Person]] = resize_array(decoder_5)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("Contacts", arg_15)

        def _arrow2961(__unit: None=None) -> Array[ArcAssay] | None:
            arg_17: Decoder_1[Array[ArcAssay]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Assays", arg_17)

        def _arrow2962(__unit: None=None) -> Array[ArcStudy] | None:
            arg_19: Decoder_1[Array[ArcStudy]] = resize_array(decoder_compressed_2(string_table, oa_table, cell_table))
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("Studies", arg_19)

        def _arrow2963(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredStudyIdentifiers", arg_21)
        ...
        return ArcInvestigation(_arrow2948(), _arrow2953(), _arrow2954(), _arrow2955(), _arrow2956(), _arrow2957(), _arrow2958(), _arrow2959(), _arrow2961(), _arrow2962(), _arrow2963(), _arrow2964())

    return object(_arrow2965)
...
def ROCrate_encoder(oa: ArcInvestigation) -> IEncodable:
    ...
    def _arrow2969(__unit: None=None, oa: Any=oa) -> IEncodable:
