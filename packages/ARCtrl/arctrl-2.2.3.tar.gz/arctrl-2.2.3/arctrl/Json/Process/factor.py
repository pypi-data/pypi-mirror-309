...
def encoder(id_map: Any | None, value: Factor) -> IEncodable:
    def f_1(value_1: Factor, id_map: Any=id_map, value: Any=value) -> IEncodable:
        ...
        def _arrow2005(value_2: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow2008(value_4: str, value_1: Any=value_1) -> IEncodable:
        ...
        def _arrow2009(oa: OntologyAnnotation, value_1: Any=value_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        def _arrow2010(comment: Comment, value_1: Any=value_1) -> IEncodable:
            return ISAJson_encoder(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2005, gen_id(value_1)), try_include("factorName", _arrow2008, value_1.Name), try_include("factorType", _arrow2009, value_1.FactorType), try_include_seq("comments", _arrow2010, default_arg(value_1.Comments, []))]))
    ...
    if id_map is not None:
        def _arrow2015(f_2: Factor, id_map: Any=id_map, value: Any=value) -> str:
            return gen_id(f_2)

        return encode(_arrow2015, f_1, value, id_map)
...
def _arrow2024(get: IGetters) -> Factor:
    ...
    return Factor(_arrow2019(), _arrow2020(), _arrow2023())


decoder: Decoder_1[Factor] = object(_arrow2024)
