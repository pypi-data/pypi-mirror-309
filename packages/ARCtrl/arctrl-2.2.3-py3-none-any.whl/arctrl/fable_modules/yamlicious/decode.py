...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        ...
        def _arrow445(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr444(IMultipleOptionalGetter):
        ...
        self.multiple_optional: IMultipleOptionalGetter = _arrow445()
        def _arrow448(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr447(IOverflowGetter):
            ...
            return ObjectExpr447()

        self.overflow: IOverflowGetter = _arrow448()
