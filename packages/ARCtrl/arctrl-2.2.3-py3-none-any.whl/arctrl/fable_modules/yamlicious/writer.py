...
def detokenize(ele: YAMLElement) -> PreprocessorElement:
    def loop(ele_1: YAMLElement, ele: Any=ele) -> PreprocessorElement:
        if ele_1.tag == 0:
            ...
            def _arrow348(__unit: None=None, ele_1: Any=ele_1) -> IEnumerable_1[PreprocessorElement]:
                return map_2(loop, ele_1.fields[0])

            return PreprocessorElement(0, to_list(delay(_arrow348)))

        elif ele_1.tag == 2:
            def _arrow350(__unit: None=None, ele_1: Any=ele_1) -> IEnumerable_1[PreprocessorElement]:
                def _arrow349(ele_3: YAMLElement) -> IEnumerable_1[PreprocessorElement]:
                ...
                return collect(_arrow349, ele_1.fields[0])

            return PreprocessorElement(0, to_list(delay(_arrow350)))
