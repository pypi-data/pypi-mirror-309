...
class MaterialAttributeValue(Record):
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        return ("" if (value is None) else _arrow651()) if (category is None) else (_arrow652() if (value is None) else _arrow653())
...
MaterialAttributeValue_reflection = _expr654
...
def MaterialAttributeValue__SetCategory_ZDED3A0F(this: MaterialAttributeValue, c: OntologyAnnotation) -> MaterialAttributeValue:
    def _arrow655(__unit: None=None, this: Any=this, c: Any=c) -> MaterialAttribute | None:
    ...
    return MaterialAttributeValue(this.ID, _arrow655(), this.Value, this.Unit)
