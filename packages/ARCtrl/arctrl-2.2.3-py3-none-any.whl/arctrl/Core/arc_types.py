...
class ArcInvestigation:
    ...
    def GetStudyIndex(self, study_identifier: str) -> int:
        this: ArcInvestigation = self
        def _arrow1040(s: ArcStudy) -> bool:
            return s.Identifier == study_identifier

        index: int = find_index(_arrow1040, this.Studies) or 0
        if index == -1:
    ...
    def get_study_index(study_identifier: str) -> Callable[[ArcInvestigation], int]:
        def _arrow1041(inv: ArcInvestigation) -> int:
    ...
    def get_study_at(index: int) -> Callable[[ArcInvestigation], ArcStudy]:
        def _arrow1042(inv: ArcInvestigation) -> ArcStudy:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def get_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcStudy]:
        def _arrow1043(inv: ArcInvestigation) -> ArcStudy:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def try_get_study(study_identifier: str) -> Callable[[ArcInvestigation], ArcStudy | None]:
        def _arrow1044(inv: ArcInvestigation) -> ArcStudy | None:
            new_inv: ArcInvestigation = inv.Copy()
    ...
    def contains_study(study_identifier: str) -> Callable[[ArcInvestigation], bool]:
        def _arrow1045(inv: ArcInvestigation) -> bool:
    ...
    def deregister_assay(study_identifier: str, assay_identifier: str) -> Callable[[ArcInvestigation], ArcInvestigation]:
        def _arrow1049(inv: ArcInvestigation) -> ArcInvestigation:
            copy: ArcInvestigation = inv.Copy()
    ...
    def DeregisterStudy(self, study_identifier: str) -> None:
        ...
        ignore(remove_in_place(study_identifier, this.RegisteredStudyIdentifiers, ObjectExpr1051()))
    ...
    def GetAllPersons(self, __unit: None=None) -> Array[Person]:
        ...
        return Array_distinct(list(persons), ObjectExpr1053())
    ...
    def GetAllPublications(self, __unit: None=None) -> Array[Publication]:
        ...
        return Array_distinct(list(pubs), ObjectExpr1054())
                ...
                try: 
                    while enumerator_1.System_Collections_IEnumerator_MoveNext():
                        ...
                        class ObjectExpr1056:
                            @property
                            def Equals(self) -> Callable[[str, str], bool]:
                                def _arrow1055(x: str, y: str) -> bool:
                                    return x == y
                        ...
                        if not contains(registered_assay, existing_assays, ObjectExpr1056()):
    ...
    def UpdateIOTypeByEntityID(self, __unit: None=None) -> None:
        this: ArcInvestigation = self
        def _arrow1061(__unit: None=None) -> IEnumerable_1[ArcTable]:
            def _arrow1058(study: ArcStudy) -> IEnumerable_1[ArcTable]:
                return study.Tables

            def _arrow1060(__unit: None=None) -> IEnumerable_1[ArcTable]:
                def _arrow1059(assay: ArcAssay) -> IEnumerable_1[ArcTable]:
                    return assay.Tables

                return collect(_arrow1059, this.Assays)

            return append_3(collect(_arrow1058, this.Studies), delay(_arrow1060))

        io_map: Any = ArcTablesAux_getIOMap(list(to_list(delay(_arrow1061))))
        enumerator: Any = get_enumerator(this.Studies)
        try: 
            while enumerator.System_Collections_IEnumerator_MoveNext():
    ...
    def StructurallyEquals(self, other: ArcInvestigation) -> bool:
        ...
        def _arrow1076(__unit: None=None) -> bool:
            ...
            def _arrow1075(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1074(i_5: int) -> bool:
                    return equals(item(i_5, a_4), item(i_5, b_4))

                return map_1(_arrow1074, range_big_int(0, 1, length(a_4) - 1))

            return fold(folder_4, True, to_list(delay(_arrow1075))) if (length(a_4) == length(b_4)) else False
        ...
        def _arrow1079(__unit: None=None) -> bool:
            ...
            def _arrow1078(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1077(i_6: int) -> bool:
                    return item(i_6, a_5) == item(i_6, b_5)

                return map_1(_arrow1077, range_big_int(0, 1, length(a_5) - 1))

            return fold(folder_5, True, to_list(delay(_arrow1078))) if (length(a_5) == length(b_5)) else False
        ...
        def _arrow1082(__unit: None=None) -> bool:
            ...
            def _arrow1081(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1080(i_7: int) -> bool:
                    return equals(item(i_7, a_6), item(i_7, b_6))

                return map_1(_arrow1080, range_big_int(0, 1, length(a_6) - 1))

            return fold(folder_6, True, to_list(delay(_arrow1081))) if (length(a_6) == length(b_6)) else False
        ...
        def _arrow1085(__unit: None=None) -> bool:
            ...
            def _arrow1084(__unit: None=None) -> IEnumerable_1[bool]:
                def _arrow1083(i_8: int) -> bool:
                    return equals(item(i_8, a_7), item(i_8, b_7))

                return map_1(_arrow1083, range_big_int(0, 1, length(a_7) - 1))

            return fold(folder_7, True, to_list(delay(_arrow1084))) if (length(a_7) == length(b_7)) else False

        return for_all(predicate, to_enumerable([this.Identifier == other.Identifier, equals(this.Title, other.Title), equals(this.Description, other.Description), equals(this.SubmissionDate, other.SubmissionDate), equals(this.PublicReleaseDate, other.PublicReleaseDate), _arrow1064(), _arrow1067(), _arrow1070(), _arrow1073(), _arrow1076(), _arrow1079(), _arrow1082(), _arrow1085()]))
...
ArcInvestigation_reflection = _expr1086
