...
def _arrow527(value_1: YAMLElement) -> tuple[CWLType, bool]:
    def getter(get: IGetters) -> tuple[CWLType, bool]:
        ...
        if cwl_type is None:
            def _arrow526(__unit: None=None, get: Any=get) -> CWLType:
                object_arg_1: IRequiredGetter = get.Required
                return object_arg_1.Field("type", Decode_cwlArrayTypeDecoder)

            return (_arrow526(), False)
...
Decode_cwlTypeDecoder: Callable[[YAMLElement], tuple[CWLType, bool]] = _arrow527

def _arrow534(value_2: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow533(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLOutput]:
            def _arrow532(key: str) -> IEnumerable_1[CWLOutput]:
                ...
                def _arrow531(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                    ...
                    def _arrow530(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                        return singleton(output)

                    return append(_expr529() if (output_source is not None) else empty_1(), delay(_arrow530))

                return append(_expr528() if (output_binding is not None) else empty_1(), delay(_arrow531))

            return collect(_arrow532, dict_1.keys())

        return list(to_array(delay(_arrow533)))

    return object(getter, value_2)


Decode_outputArrayDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow534

def _arrow535(value: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        object_arg: IRequiredGetter = get.Required
...
Decode_outputsDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow535
...
def Decode_dockerRequirementDecoder(get: IGetters) -> DockerRequirement:
    ...
    def _arrow538(__unit: None=None, get: Any=get) -> Any | None:
        object_arg_1: IOptionalGetter = get.Optional
        def arg_3(value_1: YAMLElement) -> Any:
            def key_decoder(x: str, value_1: Any=value_1) -> str:
                return x

            def _arrow537(value_2: YAMLElement, value_1: Any=value_1) -> str:
                return string(value_2)

            return map_1(key_decoder, _arrow537, value_1)
    ...
    return DockerRequirement(_arrow536(), _arrow538(), _arrow539())
    ...
    def arg_1(value_3: YAMLElement, get: Any=get) -> Array[EnvironmentDef]:
        def decoder(value_2: YAMLElement, value_3: Any=value_3) -> EnvironmentDef:
            def getter(get2: IGetters, value_2: Any=value_2) -> EnvironmentDef:
                def _arrow540(__unit: None=None, get2: Any=get2) -> str:
                ...
                return EnvironmentDef(_arrow540(), _arrow541())
    ...
    def arg_1(value_6: YAMLElement, get: Any=get) -> Array[SoftwarePackage]:
        def decoder(value_5: YAMLElement, value_6: Any=value_6) -> SoftwarePackage:
            def getter(get2: IGetters, value_5: Any=value_5) -> SoftwarePackage:
                ...
                def _arrow544(__unit: None=None, get2: Any=get2) -> Array[str] | None:
                    ...
                    def arg_5(value_1: YAMLElement) -> Array[str]:
                        ...
                        return resizearray(_arrow543, value_1)
                ...
                return SoftwarePackage(_arrow542(), _arrow544(), _arrow547())
...
def Decode_resourceRequirementDecoder(get: IGetters) -> ResourceRequirementInstance:
    def _arrow548(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg: IOptionalGetter = get.Optional
    ...
    def _arrow549(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg_1: IOptionalGetter = get.Optional
    ...
    return ResourceRequirementInstance__ctor_D76FC00(some(_arrow548()), some(_arrow549()), some(_arrow550()), some(_arrow551()), some(_arrow552()), some(_arrow553()), some(_arrow554()), some(_arrow555()))
...
def Decode_schemaDefRequirementDecoder(get: IGetters) -> Array[SchemaDefRequirementType]:
    ...
    def _arrow557(__unit: None=None, get: Any=get) -> Array[Any]:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value_2: YAMLElement) -> Array[Any]:
            def decoder(value: YAMLElement, value_2: Any=value_2) -> Any:
                ...
                def _arrow556(value_1: YAMLElement, value: Any=value) -> str:
                    return string(value_1)

                return map_1(key_decoder, _arrow556, value)

            return resizearray(decoder, value_2)

        return object_arg.Field("types", arg_1)

    return ResizeArray_map(f, _arrow557())
...
def _arrow558(value_2: YAMLElement) -> Array[Requirement]:
...
Decode_requirementArrayDecoder: Callable[[YAMLElement], Array[Requirement]] = _arrow558

def _arrow559(value: YAMLElement) -> Array[Requirement] | None:
...
Decode_requirementsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow559

def _arrow560(value: YAMLElement) -> Array[Requirement] | None:
    def getter(get: IGetters) -> Array[Requirement] | None:
        object_arg: IOptionalGetter = get.Optional
...
Decode_hintsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow560
    ...
    def getter_1(get: IGetters) -> InputBinding | None:
        ...
        def arg_1(value_4: YAMLElement, get: Any=get) -> InputBinding:
            def getter(get_0027: IGetters, value_4: Any=value_4) -> InputBinding:
                def _arrow561(__unit: None=None, get_0027: Any=get_0027) -> str | None:
                ...
                return InputBinding(_arrow561(), _arrow564(), _arrow565(), _arrow566())
