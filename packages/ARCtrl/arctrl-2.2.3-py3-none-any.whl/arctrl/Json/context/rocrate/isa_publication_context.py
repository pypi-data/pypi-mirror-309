...
def _arrow1633(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1624()), ("Publication", ObjectExpr1625()), ("pubMedID", ObjectExpr1626()), ("doi", ObjectExpr1627()), ("title", ObjectExpr1628()), ("status", ObjectExpr1629()), ("authorList", ObjectExpr1630()), ("comments", ObjectExpr1631())])
