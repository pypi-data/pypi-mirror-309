...
def _arrow1415(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1402()), ("additionalType", ObjectExpr1403()), ("alternateName", ObjectExpr1404()), ("measurementMethod", ObjectExpr1405()), ("description", ObjectExpr1406()), ("category", ObjectExpr1407()), ("categoryCode", ObjectExpr1408()), ("value", ObjectExpr1409()), ("valueCode", ObjectExpr1410()), ("unit", ObjectExpr1411()), ("unitCode", ObjectExpr1412()), ("comments", ObjectExpr1413())])
