...
def _arrow1502(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1483()), ("Investigation", ObjectExpr1484()), ("identifier", ObjectExpr1485()), ("title", ObjectExpr1486()), ("additionalType", ObjectExpr1487()), ("description", ObjectExpr1488()), ("submissionDate", ObjectExpr1489()), ("publicReleaseDate", ObjectExpr1490()), ("publications", ObjectExpr1491()), ("people", ObjectExpr1492()), ("studies", ObjectExpr1494()), ("ontologySourceReferences", ObjectExpr1495()), ("comments", ObjectExpr1496()), ("filename", ObjectExpr1498())])
