...
def _arrow1679(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1672()), ("arc", ObjectExpr1673()), ("CreativeWork", ObjectExpr1674()), ("about", ObjectExpr1675()), ("conformsTo", ObjectExpr1677())])
