...
def _arrow1649(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1643()), ("bio", ObjectExpr1644()), ("Source", ObjectExpr1645()), ("name", ObjectExpr1646()), ("characteristics", ObjectExpr1647())])
...
context_jsonvalue: IEncodable = _arrow1649()
