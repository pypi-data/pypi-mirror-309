...
IContext_reflection = _expr1615

def _arrow1622(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1616()), ("arc", ObjectExpr1617()), ("ProtocolParameter", ObjectExpr1618()), ("ArcProtocolParameter", ObjectExpr1619()), ("parameterName", ObjectExpr1620())])
    ...
    return ObjectExpr1621()


context_jsonvalue: IEncodable = _arrow1622()
