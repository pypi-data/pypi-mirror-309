...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    def _arrow1818(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1820(value_11: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1822(value_13: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1824(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1826(value_17: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1828(value_19: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1829(x: IEncodable, pv: Any=pv) -> IEncodable:
        return x

    def _arrow1830(x_1: IEncodable, pv: Any=pv) -> IEncodable:
        return x_1

    def _arrow1833(value_21: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1837(value_23: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1815()), ("@type", ObjectExpr1816()), ("additionalType", _arrow1818()), try_include("alternateName", _arrow1820, pv.AlternateName()), try_include("measurementMethod", _arrow1822, pv.MeasurementMethod()), try_include("description", _arrow1824, pv.Description()), try_include("category", _arrow1826, pattern_input[0]), try_include("categoryCode", _arrow1828, pattern_input[1]), try_include("value", _arrow1829, pattern_input_1[0]), try_include("valueCode", _arrow1830, pattern_input_1[1]), try_include("unit", _arrow1833, pattern_input_2[0]), try_include("unitCode", _arrow1837, pattern_input_2[1]), ("@context", context_jsonvalue)]))
