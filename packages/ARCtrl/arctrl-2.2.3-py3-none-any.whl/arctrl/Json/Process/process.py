...
def _arrow2431(get: IGetters) -> Process:
    ...
    def _arrow2428(__unit: None=None) -> FSharpList[ProcessOutput] | None:
    ...
    return Process(_arrow2420(), _arrow2421(), _arrow2422(), _arrow2424(), _arrow2425(), _arrow2426(), None, None, _arrow2427(), _arrow2428(), _arrow2430())


ROCrate_decoder: Decoder_1[Process] = object(_arrow2431)
