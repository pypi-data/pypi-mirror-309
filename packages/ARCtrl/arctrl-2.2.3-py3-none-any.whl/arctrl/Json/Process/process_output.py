...
def _arrow2373(Item_2: Material) -> ProcessOutput:
    return ProcessOutput(2, Item_2)


ISAJson_decoder: Decoder_1[ProcessOutput] = one_of(of_array([map(_arrow2371, ISAJson_decoder_1), map(_arrow2372, ISAJson_decoder_2), map(_arrow2373, ISAJson_decoder_3)]))
