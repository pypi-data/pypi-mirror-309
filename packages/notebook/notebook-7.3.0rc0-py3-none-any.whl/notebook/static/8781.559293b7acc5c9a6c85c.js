...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(88606);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(58244),
    __webpack_require__(81913),
  ...
  let baseMods = [
      __webpack_require__(26257),
  __webpack_require__(25576),
  __webpack_require__(72916),
  __webpack_require__(65226),
  __webpack_require__(74570),
  __webpack_require__(5981),
  __webpack_require__(15443),
  
      (__webpack_require__(28557)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(90868)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      (__webpack_require__(50320)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(21055)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(76514),
  
      (__webpack_require__(22944)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(55488)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(78190)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(47810)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(42194)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(46162),
  __webpack_require__(28451),
  __webpack_require__(52754),
  
      (__webpack_require__(13387)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(70811),
  __webpack_require__(28158),
  __webpack_require__(75263),
  
      (__webpack_require__(99663)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(98263),
  __webpack_require__(44989),
  __webpack_require__(4817),
  __webpack_require__(47307),
  __webpack_require__(36898),
  __webpack_require__(91579),
  __webpack_require__(73913),
  __webpack_require__(95781),
  __webpack_require__(45649),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(74205),
  
      (__webpack_require__(60001)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(60522),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(84889),
  __webpack_require__(98190),
  
      (__webpack_require__(51300)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(49130)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(92191)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(59486).NotebookApp);
...
//# sourceMappingURL=8781.559293b7acc5c9a6c85c.js.map?v=559293b7acc5c9a6c85c