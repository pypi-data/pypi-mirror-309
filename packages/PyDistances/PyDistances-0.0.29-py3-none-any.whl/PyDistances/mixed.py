...
dist_matrix['matching'] = hamming_dist_matrix
...
def get_dist_matrices(X, p1, p2, p3, d1='euclidean', d2='sokal', d3='matching', q=1, 
                      method='trimmed', epsilon=0.05, alpha=0.05, n_iters=20, weights=None):
    """
    ...
    if p1 > 0:
        if d1 == 'minkowski':
            ...
            S_robust_ = S_robust(X=X_quant, method=method, alpha=alpha,
...
def vg_ggower_estimation(X, p1, p2, p3, d1='euclidean', d2='sokal', d3='matching', 
                         q=1, method='trimmed', epsilon=0.05, alpha=0.05, 
    ...
    get_dist_matrices_ = get_dist_matrices(p1=p1, p2=p2, p3=p3, d1=d1, d2=d2, d3=d3,
                                           q=q, method=method, epsilon=epsilon,
...
def vg_ggower_fast_estimation(X, p1, p2, p3, d1='euclidean', d2='sokal', d3='matching',
                         method='trimmed', epsilon=0.05, alpha=0.05, n_iters=20, q=1,
    ...
    for i in range(0, VG_n_samples) :
        ...
        VG1, VG2, VG3 = vg_ggower_estimation(X=X_sample, p1=p1, p2=p2, p3=p3, d1=d1, d2=d2, d3=d3, q=q,
                                            method=method, epsilon=epsilon, alpha=alpha, 
    ...
    def fit(self, X) :
        ...
        if d1 in ['robust_mahalanobis', 'mahalanobis']:
            ...
            if X is None: 
                ...
                self.VG1, self.VG2, self.VG3 = vg_ggower_fast_estimation(X=X, p1=p1, p2=p2, p3=p3, d1=d1, d2=d2, d3=d3, method=self.method, 
