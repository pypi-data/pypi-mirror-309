"""
Assistant response functionality for the LION communication system.

This module provides functionality for handling responses from AI assistants,
supporting both direct responses and structured model outputs while maintaining
a clean interface for accessing the content.
"""
