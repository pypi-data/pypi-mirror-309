...
from grapepi.utils.config import load_cfg
from torch_geometric.graphgym.utils.comp_budget import params_count
from torch_geometric.graphgym.utils.device import auto_select_device

from grapepi.custom_graphgym import logger
import pandas as pd
from grapepi.custom_graphgym.loader.protein import ProteinDataset
from grapepi.custom_graphgym.logger import set_printing
...
def main():
    ...
    parser.add_argument('--override', dest='override', type=str, default=None,
                        help='Override the configuration file with a new configuration file.')
