...
class GenerativevalidationGenerativeValidationResult(object):
    ...
    def __init__(self, id=None, attack_technique=None, attack_objective=None, objective_sub_category=None, severity=None, owasp_standards=None, nist_standards=None, mitre_standards=None, threat=None, skipped_reason=None, test_run_id=None, example=None, sequential_id=None):  # noqa: E501
