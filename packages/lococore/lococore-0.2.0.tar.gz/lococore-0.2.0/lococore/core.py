...
class LocoCore(ABC):
    ...
    def _load_translations(self, locale: str) -> None:
        ...
        from a specific file format (e.g., JSON, TOML, YAML or other). The method
        should read the translation file for the given locale, parse its contents,
        and store the translations in the `self.translations` dictionary. If the
