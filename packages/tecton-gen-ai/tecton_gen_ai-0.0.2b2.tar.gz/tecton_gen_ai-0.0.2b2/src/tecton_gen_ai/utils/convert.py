...
def tecton_type_to_python_type(dtype: Union[SdkDataType, DataType]) -> Any:
    ...
    if String.tecton_type == tp:
        ...
        return List[tecton_type_to_python_type(dtype.element_type)]
    elif isinstance(dtype, (Map, MapType)):
        return Dict[
            tecton_type_to_python_type(tp.key_type),
            tecton_type_to_python_type(tp.value_type),
        ]
