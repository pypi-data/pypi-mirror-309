...
class ObjectDetection:
    def __init__(self, num_classes=6, pretrained=True, device="cuda"):
        ...
        if num_classes != 91:
            in_features = self.model.head.classification_head.classification_head[0].in_channels
            self.model.head.classification_head = nn.Conv2d(in_features, num_classes, kernel_size=1)
