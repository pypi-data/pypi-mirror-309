...
class ModelHandler:
    ...
    def evaluate(self, test_dataset, batch_size: int = 4, device: str = "cuda"):
        """
        Evaluate a saved model using IoU, Precision, Recall, and F1 Score.

        :param model_path: Path to the saved model file.
        :param test_dataset: Dataset object for evaluation.
        :param batch_size: Batch size for evaluation DataLoader.
        ...
        #dataloader = DataLoader(test_dataset, batch_size=batch_size, shuffle=False, collate_fn=self._collate_fn)
