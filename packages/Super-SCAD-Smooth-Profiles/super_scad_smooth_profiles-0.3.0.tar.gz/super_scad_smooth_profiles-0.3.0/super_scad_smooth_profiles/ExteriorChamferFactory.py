...
class ExteriorChamferFactory(SmoothProfileFactory):
    """
    A factory that produces exterior chamfer smoothing profiles.
    """
    ...
    def create_smooth_profile(self, *, params: SmoothProfileParams, child: ScadWidget) -> ScadSingleChildParent:
        ...
        """
        return ExteriorChamfer(skew_length=self._skew_length,
