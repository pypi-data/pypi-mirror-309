...
PYRAMID_OPENAPI3_VERSION = importlib.metadata.version("pyramid-openapi3")
...
class ApiBinaryTC(ApiBaseTC):
    ...
    @pytest.mark.skipif(
        PYRAMID_OPENAPI3_VERSION == "0.19",
        reason="""
        a bug in pyramid-openapi3 emits the wrong field on successive validation errors.
    """,
    )
