...
from openfund.version.version_selector import VersionSelector
...
class UpCommand(InstallerCommand):
    ...
    def handle(self) -> int:
        ...
        selector = VersionSelector(self.openfund.pool)
        pyproject_content = self.openfund.file.read()
        original_pyproject_content = self.openfund.file.read()
        ...
        self.openfund.file.write(pyproject_content)
        self.reset_openfund()
        ...
        try:
            ...
            self.openfund.file.write(original_pyproject_content)
            raise e
        return 0
    ...
    def get_groups(self) -> Iterable[DependencyGroup]:
        ...
        for group in self.activated_groups:
            yield self.openfund.package.dependency_group(group)
