...
var de = K(S, "WeakMap"), He = Object.create, $n = /* @__PURE__ */ function() {
  function e() {
  }
  return function(t) {
    if (!B(t))
...
var ye = K(S, "DataView"), be = K(S, "Promise"), he = K(S, "Set"), tt = "[object Map]", zi = "[object Object]", nt = "[object Promise]", rt = "[object Set]", it = "[object WeakMap]", ot = "[object DataView]", Hi = D(ye), qi = D(Y), Yi = D(be), Xi = D(he), Ji = D(de), P = N;
...
function k(e, t, n, r, i, o) {
  ...
  var u = c ? l ? Kt : _e : l ? Se : J, g = p ? void 0 : u(e);
...
function Ba(e, t, n) {
  ...
  const kt = $a();
  return e.$$set = (_) => {
    t = _t(_t({}, t), Ma(_)), n(23, i = yt(t, r)), "gradio" in _ && n(5, d = _.gradio), "props" in _ && n(6, y = _.props), "_internal" in _ && n(7, u = _._internal), "colors" in _ && n(8, g = _.colors), "label" in _ && n(9, f = _.label), "default_open" in _ && n(10, m = _.default_open), "as_item" in _ && n(11, T = _.as_item), "visible" in _ && n(12, L = _.visible), "elem_id" in _ && n(13, $ = _.elem_id), "elem_classes" in _ && n(14, C = _.elem_classes), "elem_style" in _ && n(15, W = _.elem_style), "$$scope" in _ && n(19, p = _.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    64 && b.update((_) => ({
      ..._,
  ...
  }, [s, b, Ne, De, Ke, d, y, u, g, f, m, T, L, $, C, W, o, a, l, p, c];
}
class qa extends Ca {
  constructor(t) {
