...
def handle_single_decl(source_snippet: str, assignment: Dict[str, Any]) -> LocalAssignmentFinderData:
    ...
    if is_unsupported_type(type_string):
        ...
        lhs_for_inline_assembly_read = left_hand_side["name"]
        lhs_for_display = lhs_for_inline_assembly_read
        finder_prefix = ""
        finder_type = 0
...
def handle_single_def(source_snippet: str, finder_running_id: int, assignment: Dict[str, Any],
    ...
    if left_hand_side_node_type == "Identifier":
        ...
        if is_unsupported_type(type_string):
            ...
            lhs_for_inline_assembly_read = left_hand_side["name"]
            lhs_for_display = lhs_for_inline_assembly_read
            return LocalAssignmentFinderData("", lhs_for_inline_assembly_read, lhs_for_display, 0, False)
    ...
    for c in sdc.contracts:
        ...
        for assignment in assignment_nodes:
            ...
            # Now deal with single decls/defs
                ...
                lafd = handle_single_decl(source_snippet, assignment)
