...
original = img_as_float(io.imread('./examples/noise.png')[100:250, 50:300])
...
ax[1, 2].imshow(denoise_bilateral(noisy, sigma_color=0.1, sigma_spatial=15, multichannel=False))
ax[1, 2].axis('off')
ax[1, 2].set_title('(more) Bilateral')
ax[1, 3].imshow(denoise_wavelet(noisy, convert2ycbcr=True, multichannel=False))
ax[1, 3].axis('off')
