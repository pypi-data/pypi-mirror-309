...
class XDataArray:
    ...
    def plot(self, title=None, figsize=None, ax=None, latlon_range=None, add_clabels=False, clevels=None, clabel_kwargs=None,
             ...
             site_marker_dict=None, site_color_dict=None, count_site_num=False, lgd_kws=None, **kws):
        ...
        if ndim == 2 and 'lat' in da.coords and 'lon' in da.coords:
            ...
            CS = self.da.plot.contourf(ax=ax, **_plt_kws)
            if add_clabels:
                # _contour_kws = {
                ...
                #     'colors': 'k',
                # }
                # CS = self.da.plot.contour(ax=ax, **_contour_kws)
                ...
                clbs = ax.clabel(CS, clevels, zorder=99, **_clabel_kwargs)
                for txt in clbs:
