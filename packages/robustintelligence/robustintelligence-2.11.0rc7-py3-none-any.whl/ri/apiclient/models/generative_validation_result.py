...
class GenerativeValidationResult(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["attackObjective", "attackTechnique", "example", "id", "mitreStandards", "nistStandards", "objectiveSubCategory", "owaspStandards", "sequentialId", "severity", "skippedReason", "testRunId", "threat"]
