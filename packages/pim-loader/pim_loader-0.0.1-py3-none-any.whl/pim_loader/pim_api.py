...
from rusta_tools import constants as const
...
try:
    ...
    fh = logger.FileHandler("pim_loader.log")
...
def load_pim_data():
    ...
    for index, article in enumerate(articles):
        ...
        ready_pim.append({ 
            ...
            const.ITEM_LONG_COPY_NO: item_long_copy.get("no-NO", ""),
            ...
            const.OPTION_LONG_COPY_NO: option_long_copy.get("no-NO", ""),
            ...
            "INSERT_DATE": time.strftime("%Y-%m-%d", time.localtime())
