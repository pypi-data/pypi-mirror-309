...
class NativeInboundWithCustomDataTypeAsyncBase(AbstractPipelineStep):
    ...
    async def execute_step(self, inbound: CustomData) -> None:
        """
        Executes this step.
        """
        start = time_ns()
    ...
    @abstractmethod
    async def execute_step_impl(self, inbound: CustomData) -> None:
        """
    ...
    def check_and_apply_encryption_policy(self, inbound: CustomData) -> None:
        """
    ...
    def apply_encryption_to_dataset(self, inbound: CustomData, fields_to_update: List[str], algorithm: str) -> CustomData:
        '''
    ...
    def get_fields_list(self, inbound: CustomData) -> List[str]:
        '''
