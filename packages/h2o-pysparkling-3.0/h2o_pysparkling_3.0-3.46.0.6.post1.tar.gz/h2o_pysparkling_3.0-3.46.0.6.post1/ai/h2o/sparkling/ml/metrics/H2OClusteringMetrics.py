...
class H2OClusteringMetrics(H2OCommonMetrics):

    def __init__(self, java_obj):
        self._java_obj = java_obj

    def getTotWithinss(self):
        """
        Within Cluster Sum of Square Error.
        """
        value = self._java_obj.getTotWithinss()
        return value
    ...
    def getTotss(self):
        ...
        """
        value = self._java_obj.getTotss()
        return value

    def getBetweenss(self):
        """
        Between Cluster Sum of Square Error.
        """
        value = self._java_obj.getBetweenss()
        return value

    def getCentroidStats(self):
        """
        Centroid Statistics.
        """
        value = self._java_obj.getCentroidStats()
