...
def calc_well_record_quality(
    ...
    if dt_col == "obs_date":
        logger.warning(
            "When testing obs_in_yearX, aggregation is being done via the year of the observation, instead of the season_year. Set dt_col = 'season_year' to avoid this warning."
        )
