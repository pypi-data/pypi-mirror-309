...
from openfund.utils.env import ephemeral_environment
from openfund.utils.helpers import extractall
from openfund.utils.setup_reader import SetupReader
...
class PackageInfo:
    ...
    def from_setup_files(cls, path: Path) -> PackageInfo:
        ...
        the implementation at `openfund.utils.setup_reader.SetupReader` in order to parse
