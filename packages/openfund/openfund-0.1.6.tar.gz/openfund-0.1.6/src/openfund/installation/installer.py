...
from openfund.installation.executor import Executor
...
from openfund.repositories import Repository
from openfund.repositories import RepositoryPool
from openfund.repositories.installed_repository import InstalledRepository
from openfund.repositories.lockfile_repository import LockfileRepository
from openfund.utils.extras import get_extra_package_names
...
if TYPE_CHECKING:
    ...
    from openfund.packages import Locker
...
class Installer:
    ...
    def _do_refresh(self) -> int:
        from openfund.puzzle.solver import Solver
    ...
    def _do_install(self) -> int:
        ...
        if not self._requires_synchronization:
            ...
            from openfund.puzzle.transaction import Transaction
