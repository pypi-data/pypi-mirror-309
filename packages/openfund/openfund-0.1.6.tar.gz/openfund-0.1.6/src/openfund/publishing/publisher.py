...
from openfund.publishing.uploader import Uploader
...
class Publisher:
    ...
    def __init__(
        self, openfund: Openfund, io: IO, dist_dir: Path | None = None
    ) -> None:
        self._poetry = openfund
        self._package = openfund.package
        self._io = io
        self._uploader = Uploader(openfund, io, dist_dir)
        self._authenticator = Authenticator(openfund.config, self._io)
