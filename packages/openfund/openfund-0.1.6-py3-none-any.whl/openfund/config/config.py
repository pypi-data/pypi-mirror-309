...
from openfund.config.dict_config_source import DictConfigSource
from openfund.config.file_config_source import FileConfigSource
from openfund.locations import CONFIG_DIR
from openfund.locations import DEFAULT_CACHE_DIR
...
class Config:
    ...
    def merge(self, config: dict[str, Any]) -> None:
        from openfund.utils.helpers import merge_dicts
