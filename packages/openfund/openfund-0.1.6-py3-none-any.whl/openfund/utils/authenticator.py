...
from openfund.utils.constants import RETRY_AFTER_HEADER
from openfund.utils.constants import STATUS_FORCELIST
from openfund.utils.password_manager import HTTPAuthCredential
...
class Authenticator:
    def __init__(
        ...
        self._user_agent = user_agent("openfund", __version__)
    ...
    def request(
        ...
        raise OpenfundException("Failed HTTP {} request", method.upper())
