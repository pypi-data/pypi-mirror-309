...
DISTNAME = 'jbeval'
DESCRIPTION = "Jupyter Notebook Evaluation"
MAINTAINER =  "Nikesh Bajaj"
MAINTAINER_EMAIL =  "nikesh.bajaj@qmul.ac.uk"
AUTHER_EMAIL = "nikkeshbajaj@gmail.com"
AUTHER = "Nikesh Bajaj"
URL = 'https://JBEval.github.io'
LICENSE = 'BSD-3-Clause'
GITHUB_URL= 'https://github.com/JBEval'
...
if os.path.isfile(os.path.join(top_dir, 'Version')):
    ...
    import urllib
    Vpath = 'https://raw.githubusercontent.com/Nikeshbajaj/JBEval/master/Version'
...
if __name__ == "__main__":
    ...
    setuptools.setup(
        ...
        url=URL,
        download_url = 'https://github.com/Nikeshbajaj/JBEval/tarball/' + version,
        ...
        project_urls={
        'Documentation': 'https://JBEval.readthedocs.io/',
        'Say Thanks!': 'https://github.com/Nikeshbajaj',
        'Source': 'https://github.com/Nikeshbajaj/JBEval',
        'Tracker': 'https://github.com/Nikeshbajaj/JBEval/issues',
        },
