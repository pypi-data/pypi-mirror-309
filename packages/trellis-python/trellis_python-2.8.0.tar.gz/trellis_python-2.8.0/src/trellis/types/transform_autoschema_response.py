...
class DataOperationOperation(BaseModel):
    ...
    column_type: Literal["text", "integer", "numeric", "boolean", "list", "object", "string", "number", "enum"]
    """An enumeration."""
    ...
    Defines the structure of object or list properties. If column_type is `list`,
    then properties should only be of length 1 since `list` can only be of one type.
    If column_type is `object`, then properties can be longer of length one (and
