...
class MaestroTemplates(MaestroMacros, MaestroMeta):
    ...
    def dump_to_js_config(self, base_url=None, page=None):
        """
        ...
        with MaestroTemplates._to_dumpable_state(self, base_url, page):
    ...
    @staticmethod
    @contextmanager
    def _to_dumpable_state(maestro: Optional['PyodideMacrosPlugin'], base_url:Optional[Page], page:Optional[Page]):
        """
        ...
        if not maestro:
            ...
            maestro.setup_ctx(base_url, page)
