...
class SimpleHTTPRequestHandlerWithUpload(SimpleHTTPRequestHandler):
    ...
    def generate_qr_code(self):
        ...
        try:
            ...
            # Save as an SVG or simple string if Pillow is not available
            qr_path = os.path.join(STATIC_DIR, 'qr_code.svg')  # Save as SVG file
            img = qr.make_image(fill='black', back_color='white')

            # Save QR code as an SVG instead of PNG
            img.save(qr_path)
            return qr_path
...
def main():
    ...
    print("Welcome to FileDrop! (v1.0.2)")
