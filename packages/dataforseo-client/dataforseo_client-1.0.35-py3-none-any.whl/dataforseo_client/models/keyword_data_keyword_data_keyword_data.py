...
class KeywordDataKeywordDataKeywordData(BaseModel):
    """
    KeywordDataKeywordDataKeywordData
    """ # noqa: E501
    ...
    keyword_info: Optional[ItemsKeywordKeywordInfo] = None
    ...
    items: Optional[List[ItemsKeywordDataInfo]] = Field(default=None, description="contains")
    __properties: ClassVar[List[str]] = ["se_type", "keyword", "location_code", "language_code", "keyword_info", "keyword_info_normalized_with_bing", "keyword_info_normalized_with_clickstream", "clickstream_keyword_info", "keyword_properties", "impressions_info", "serp_info", "avg_backlinks_info", "search_intent_info", "asin", "total_count", "items_count", "items"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeywordDataKeywordDataKeywordData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeywordDataKeywordDataKeywordData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "keyword_info": ItemsKeywordKeywordInfo.from_dict(obj["keyword_info"]) if obj.get("keyword_info") is not None else None,
            ...
            "items": [ItemsKeywordDataInfo.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
