...
class AppIntersectionGoogleDataforseoLabsAvailableFiltersGoogleInfo(BaseModel):
    """
    AppIntersectionGoogleDataforseoLabsAvailableFiltersGoogleInfo
    """ # noqa: E501
    ...
    intersection_result_app_id_developer: Optional[StrictStr] = Field(default=None, alias="intersection_result.$app_id.developer")
    intersection_result_app_id_developer_url: Optional[StrictStr] = Field(default=None, alias="intersection_result.$app_id.developer_url")
    __properties: ClassVar[List[str]] = ["keyword_data.keyword", "keyword_data.keyword_info.last_updated_time", "keyword_data.keyword_info.search_volume", "keyword_data.serp_info.check_url", "keyword_data.serp_info.se_results_count", "keyword_data.serp_info.last_updated_time", "keyword_data.serp_info.previous_updated_time", "intersection_result.$app_id.type", "intersection_result.$app_id.rank_group", "intersection_result.$app_id.rank_absolute", "intersection_result.$app_id.position", "intersection_result.$app_id.title", "intersection_result.$app_id.url", "intersection_result.$app_id.reviews_count", "intersection_result.$app_id.is_free", "intersection_result.$app_id.developer", "intersection_result.$app_id.developer_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppIntersectionGoogleDataforseoLabsAvailableFiltersGoogleInfo from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if intersection_result_app_id_developer (nullable) is None
        # and model_fields_set contains the field
        if self.intersection_result_app_id_developer is None and "intersection_result_app_id_developer" in self.model_fields_set:
            _dict['intersection_result.$app_id.developer'] = None

        # set to None if intersection_result_app_id_developer_url (nullable) is None
        # and model_fields_set contains the field
        if self.intersection_result_app_id_developer_url is None and "intersection_result_app_id_developer_url" in self.model_fields_set:
            _dict['intersection_result.$app_id.developer_url'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppIntersectionGoogleDataforseoLabsAvailableFiltersGoogleInfo from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "intersection_result.$app_id.developer": obj.get("intersection_result.$app_id.developer"),
            "intersection_result.$app_id.developer_url": obj.get("intersection_result.$app_id.developer_url")
        })
        return _obj
