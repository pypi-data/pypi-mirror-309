...
class TestKeywordDataKeywordData(unittest.TestCase):
    """KeywordDataKeywordData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeywordDataKeywordData:
        """Test KeywordDataKeywordData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeywordDataKeywordData`
        """
        model = KeywordDataKeywordData()
        if include_optional:
            return KeywordDataKeywordData(
                se_type = '',
                keyword = '',
                location_code = 56,
                language_code = '',
                ...
                search_intent_info = dataforseo_client.models.search_intent_info.SearchIntentInfo(
                    ...
                    last_updated_time = '', ),
                seed_keyword = '',
                seed_keyword_data = dataforseo_client.models.seed_keyword_data_keyword_info.SeedKeywordDataKeywordInfo(
                    se_type = '', 
                    keyword = '', 
                    location_code = 56, 
                    language_code = '', ),
    ...
    def testKeywordDataKeywordData(self):
        """Test KeywordDataKeywordData"""
