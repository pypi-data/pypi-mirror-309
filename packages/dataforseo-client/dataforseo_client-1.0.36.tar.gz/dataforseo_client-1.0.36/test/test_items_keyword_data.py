...
class TestItemsKeywordData(unittest.TestCase):
    """ItemsKeywordData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemsKeywordData:
        """Test ItemsKeywordData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemsKeywordData`
        """
        model = ItemsKeywordData()
        if include_optional:
            return ItemsKeywordData(
                se_type = '',
                keyword = '',
                location_code = 56,
                language_code = '',
