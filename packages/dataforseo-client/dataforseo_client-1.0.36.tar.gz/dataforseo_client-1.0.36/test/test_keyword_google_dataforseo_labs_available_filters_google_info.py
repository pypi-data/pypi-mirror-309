...
class TestKeywordGoogleDataforseoLabsAvailableFiltersGoogleInfo(unittest.TestCase):
    """KeywordGoogleDataforseoLabsAvailableFiltersGoogleInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeywordGoogleDataforseoLabsAvailableFiltersGoogleInfo:
        """Test KeywordGoogleDataforseoLabsAvailableFiltersGoogleInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeywordGoogleDataforseoLabsAvailableFiltersGoogleInfo`
        """
        model = KeywordGoogleDataforseoLabsAvailableFiltersGoogleInfo()
        if include_optional:
            return KeywordGoogleDataforseoLabsAvailableFiltersGoogleInfo(
                keyword = '',
    ...
    def testKeywordGoogleDataforseoLabsAvailableFiltersGoogleInfo(self):
        """Test KeywordGoogleDataforseoLabsAvailableFiltersGoogleInfo"""
