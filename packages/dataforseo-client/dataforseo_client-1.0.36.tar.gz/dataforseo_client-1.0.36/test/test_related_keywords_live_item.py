...
class TestRelatedKeywordsLiveItem(unittest.TestCase):
    """RelatedKeywordsLiveItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedKeywordsLiveItem:
        """Test RelatedKeywordsLiveItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedKeywordsLiveItem`
        """
        model = RelatedKeywordsLiveItem()
        if include_optional:
            return RelatedKeywordsLiveItem(
                se_type = '',
    ...
    def testRelatedKeywordsLiveItem(self):
        """Test RelatedKeywordsLiveItem"""
