...
class SerpGoogleAutocompleteLiveAdvancedResultInfo(BaseModel):
    ...
    refinement_chips: Optional[Dict[str, Any]] = Field(default=None, description="search refinement chips")
    ...
    items: Optional[List[SerpGoogleAutocompleteeAdvancedItem]] = Field(default=None, description="items of the element")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if refinement_chips (nullable) is None
        # and model_fields_set contains the field
        if self.refinement_chips is None and "refinement_chips" in self.model_fields_set:
            _dict['refinement_chips'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "refinement_chips": obj.get("refinement_chips"),
