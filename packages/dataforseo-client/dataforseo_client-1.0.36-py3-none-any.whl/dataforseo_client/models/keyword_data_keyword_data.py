...
class KeywordDataKeywordData(BaseModel):
    """
    KeywordDataKeywordData
    """ # noqa: E501
    ...
    seed_keyword_data: Optional[SeedKeywordDataKeywordInfo] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeywordDataKeywordData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeywordDataKeywordData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "seed_keyword_data": SeedKeywordDataKeywordInfo.from_dict(obj["seed_keyword_data"]) if obj.get("seed_keyword_data") is not None else None,
