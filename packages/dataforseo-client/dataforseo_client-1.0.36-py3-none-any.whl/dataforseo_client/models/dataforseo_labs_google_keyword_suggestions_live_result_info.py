...
class DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo(BaseModel):
    ...
    tasks: Optional[List[DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo]] = Field(default=None, description="array of tasks")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj

# TODO: Rewrite to not use raise_errors
DataforseoLabsGoogleKeywordSuggestionsLiveResultInfo.model_rebuild(raise_errors=False)
