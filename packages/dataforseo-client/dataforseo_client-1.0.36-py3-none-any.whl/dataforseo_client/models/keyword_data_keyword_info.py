...
class KeywordDataKeywordInfo(BaseModel):
    """
    KeywordDataKeywordInfo
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["se_type", "keyword", "location_code", "language_code", "keyword_info_normalized_with_bing", "keyword_info_normalized_with_clickstream", "clickstream_keyword_info", "keyword_properties", "impressions_info", "serp_info", "avg_backlinks_info", "search_intent_info"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KeywordDataKeywordInfo from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KeywordDataKeywordInfo from a dict"""
        if obj is None:
            return None
