...
class DataforseoLabsGoogleKeywordsForSiteLiveResultInfo(BaseModel):
    ...
    items: Optional[List[KeywordData]] = Field(default=None, description="contains keyword ideas and related data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [KeywordData.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
