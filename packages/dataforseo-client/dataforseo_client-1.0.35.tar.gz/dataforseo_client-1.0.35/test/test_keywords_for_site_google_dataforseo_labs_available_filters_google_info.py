...
class TestKeywordsForSiteGoogleDataforseoLabsAvailableFiltersGoogleInfo(unittest.TestCase):
    """KeywordsForSiteGoogleDataforseoLabsAvailableFiltersGoogleInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeywordsForSiteGoogleDataforseoLabsAvailableFiltersGoogleInfo:
        """Test KeywordsForSiteGoogleDataforseoLabsAvailableFiltersGoogleInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeywordsForSiteGoogleDataforseoLabsAvailableFiltersGoogleInfo`
        """
        model = KeywordsForSiteGoogleDataforseoLabsAvailableFiltersGoogleInfo()
        if include_optional:
            return KeywordsForSiteGoogleDataforseoLabsAvailableFiltersGoogleInfo(
                keyword = '',
                ...
                impressions_info_last_updated_time = '',
    ...
    def testKeywordsForSiteGoogleDataforseoLabsAvailableFiltersGoogleInfo(self):
        """Test KeywordsForSiteGoogleDataforseoLabsAvailableFiltersGoogleInfo"""
