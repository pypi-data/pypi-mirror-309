...
class TestEsGoogleDataforseoLabsAvailableFiltersGoogleInfo(unittest.TestCase):
    """EsGoogleDataforseoLabsAvailableFiltersGoogleInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EsGoogleDataforseoLabsAvailableFiltersGoogleInfo:
        """Test EsGoogleDataforseoLabsAvailableFiltersGoogleInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EsGoogleDataforseoLabsAvailableFiltersGoogleInfo`
        """
        model = EsGoogleDataforseoLabsAvailableFiltersGoogleInfo()
        if include_optional:
            return EsGoogleDataforseoLabsAvailableFiltersGoogleInfo(
                keyword = '',
    ...
    def testEsGoogleDataforseoLabsAvailableFiltersGoogleInfo(self):
        """Test EsGoogleDataforseoLabsAvailableFiltersGoogleInfo"""
