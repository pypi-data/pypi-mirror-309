...
class TestKeywordDataKeywordInfo(unittest.TestCase):
    """KeywordDataKeywordInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> KeywordDataKeywordInfo:
        """Test KeywordDataKeywordInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `KeywordDataKeywordInfo`
        """
        model = KeywordDataKeywordInfo()
        if include_optional:
            return KeywordDataKeywordInfo(
                se_type = '',
                keyword = '',
                location_code = 56,
                language_code = '',
    ...
    def testKeywordDataKeywordInfo(self):
        """Test KeywordDataKeywordInfo"""
