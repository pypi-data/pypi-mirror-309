...
class TestRelatedKeywordsInfo(unittest.TestCase):
    """RelatedKeywordsInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RelatedKeywordsInfo:
        """Test RelatedKeywordsInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RelatedKeywordsInfo`
        """
        model = RelatedKeywordsInfo()
        if include_optional:
            return RelatedKeywordsInfo(
    ...
    def testRelatedKeywordsInfo(self):
        """Test RelatedKeywordsInfo"""
