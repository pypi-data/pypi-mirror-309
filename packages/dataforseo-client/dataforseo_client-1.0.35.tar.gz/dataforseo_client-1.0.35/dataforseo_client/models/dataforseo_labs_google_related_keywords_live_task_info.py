...
class DataforseoLabsGoogleRelatedKeywordsLiveTaskInfo(BaseModel):
    ...
    tasks: Optional[List[DataforseoLabsGoogleRelatedKeywordsLiveResultInfo]] = Field(default=None, description="array of tasks")
    __properties: ClassVar[List[str]] = ["id", "status_code", "status_message", "time", "cost", "result_count", "path", "data", "version", "tasks_count", "tasks_error", "tasks"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tasks": [DataforseoLabsGoogleRelatedKeywordsLiveResultInfo.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None
        })
        return _obj
