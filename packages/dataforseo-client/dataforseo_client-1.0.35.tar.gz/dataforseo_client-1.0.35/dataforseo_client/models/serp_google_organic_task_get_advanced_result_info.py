...
class SerpGoogleOrganicTaskGetAdvancedResultInfo(BaseModel):
    ...
    refinement_chips: Optional[RefinementChips] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "refinement_chips": RefinementChips.from_dict(obj["refinement_chips"]) if obj.get("refinement_chips") is not None else None,
