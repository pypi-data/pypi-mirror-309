...
class TestMoons(TestCase):
    ...
    def test_no_crash_cycles_before_full_empty_moon(self):
        ...
        _ = metenox_moon.cycles_before_full

    # def test_create_region_moons(self):
    #     self.assertEqual(MetenoxMoon.objects.all().count(), 0)
    #
    #     load_region_moons(10000033)

    #     self.assertEqual(MetenoxMoon.objects.all().count(), 1)
