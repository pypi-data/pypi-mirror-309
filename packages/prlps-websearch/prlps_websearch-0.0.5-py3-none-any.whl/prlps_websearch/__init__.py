from asyncio import CancelledError, FIRST_COMPLETED, Task, create_task, gather, run as asyncio_run, wait
...
def sync_websearch(
    ...
    try:
        nest_asyncio_apply()
        result = asyncio_run(async_websearch(query, time_range, category, num_pages))
        return result
    except Exception as exc:
        return None
