...
from murnitur.annotation.evaluation.evaluate import execute_test_cases
...
try:
    ...
    class DeepEvalHuggingFaceCallback(TrainerCallback):
        ...
        def _aggregate_scores(self, scores: Dict[str, List[float]]) -> Dict[str, float]:
            """
        ...
        def on_epoch_end(
            ...
            **kwargs,
            ...
            self.rich_manager.change_spinner_text(self.task_descriptions["generating"])
