...
from murnitur.annotation.evaluation.tracing import (
    trace_manager,
    get_trace_stack,
    BaseTrace,
    LlmTrace,
...
from murnitur.annotation.evaluation.utils import dataclass_to_dict
...
class LlamaIndexCallbackHandler(BaseCallbackHandler):
    ...
    def update_trace_instance(
        ...
        trace_instance.executionTime = perf_counter() - trace_instance.executionTime
    ...
    def convert_event_type_to_deepeval_trace_type(self, event_type: CBEventType):
        # TODO: add more types
