...
from murnitur.annotation.evaluation.test_case import ConversationalTestCase
from murnitur.annotation.evaluation.metrics import BaseConversationalMetric
...
from murnitur.annotation.evaluation.metrics.knowledge_retention.template import (
...
class KnowledgeRetentionMetric(BaseConversationalMetric):
    ...
    def measure(self, test_case: ConversationalTestCase):
        ...
        with metric_progress_indicator(self):
            ...
            self.verdicts: List[KnowledgeRetentionVerdict] = self._generate_verdicts(
                test_case
            )
