...
from murnitur.annotation.evaluation.api import Api, Endpoints
from murnitur.annotation.evaluation.dataset.utils import (
    convert_test_cases_to_goldens,
    convert_goldens_to_test_cases,
    convert_convo_goldens_to_convo_test_cases,
)
from murnitur.annotation.evaluation.dataset.api import (
    APIDataset,
    CreateDatasetHttpResponse,
    DatasetHttpResponse,
)
from murnitur.annotation.evaluation.dataset.golden import Golden, ConversationalGolden
from murnitur.annotation.evaluation.test_case import LLMTestCase, ConversationalTestCase
from murnitur.annotation.evaluation.utils import (
    convert_keys_to_snake_case,
    is_confident,
)
from murnitur.annotation.evaluation.synthesizer.base_synthesizer import BaseSynthesizer
...
class EvaluationDataset:
    ...
    @test_cases.setter
    def test_cases(self, test_cases: List[Union[LLMTestCase, ConversationalTestCase]]):
    ...
    def add_test_case(self, test_case: Union[LLMTestCase, ConversationalTestCase]):
        validate_test_case_type(test_case, subject="test cases")
    ...
    def push(self, alias: str, overwrite: Optional[bool] = None):
        ...
        if is_confident():
            ...
            raise Exception(
                "To push dataset to Confident AI, run `murnitur.annotation.evaluation login`"
            )
    ...
    def pull(self, alias: str, auto_convert_goldens_to_test_cases: bool = True):
        if is_confident():
            ...
            with Progress(
                ...
                for cg in convert_keys_to_snake_case(result["conversationalGoldens"]):
                    if "goldens" in cg:
            ...
            raise Exception(
                "Run `murnitur.annotation.evaluation login` to pull dataset from Murnitur AI"
            )
    ...
    def generate_goldens(
        ...
        from murnitur.annotation.evaluation.synthesizer import Synthesizer
