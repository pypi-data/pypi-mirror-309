...
class Site(BaseModel):
    ...
    interval_length: float = Field(default=..., alias="intervalLength", description="Length of interval that you will be billed on. 5 or 30 minutes.")
    __properties = ["id", "nmi", "channels", "network", "status", "activeFrom", "closedOn", "intervalLength"]
    ...
    def from_dict(cls, obj: dict) -> Site:
        ...
        _obj = Site.parse_obj({
            ...
            "interval_length": obj.get("intervalLength") if obj.get("intervalLength") is not None else 30
        })
        return _obj
