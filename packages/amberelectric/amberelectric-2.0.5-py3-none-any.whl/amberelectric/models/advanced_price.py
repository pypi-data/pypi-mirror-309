...
class AdvancedPrice(BaseModel):
    ...
    predicted: float = Field(default=..., description="The predicted price. Use this if you need a single number to forecast against. Price includes network and market fees. (c/kWh).")
