...
if __name__ == "__main__":
    host = "192.168.167.164"
    user = "POSTGRES_USER"
    password = "E@y123degT"
    dbname = "postgres"
    table_name = "tax_cloud_target.target_fiscal_calender"
    data_file = "/Users/lidaoran/Downloads/"

    # export_data_postgresql(
    #     host, user, password, dbname,data_file, port=15432,
    #     delimiter=",", null_str="\\N", header=True,
    #     quote='"', escape="\\", encoding="UTF8", format="csv",
    #     table_name='tax_cloud_target.target_fiscal_calender'
    # )

    pg_dump(host,user,password,dbname,data_file,port = 15432,column_inserts =False,compress = True,include_schema = ["tax_cloud_target"],include_table = ["tax_cloud_target.target_fiscal_calender"],)
