...
from airosentris.runner.MessageReceive import MessageReceive, AgentStatusRequest
...
class Runner:
    ...
    def __init__(self):
        ...
        self.agent_query_queue = 'request-status-{}'.format(str(self.agent['id']))
        self.on_request_agent_info = None
