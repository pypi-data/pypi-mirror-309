...
class baseline_electricity_179d():
    ...
    def create_input_array(self, calculator_user_inputs):
        ...
        [cooling_cop,heating_cop] = ccf.calculate_cooling_and_heating_cop(calculator_user_inputs)
        ...
        if "HP" in calculator_user_inputs["hvac_system"]:
    ...
    def estimate_annual_electricity(self, calculator_user_inputs):
        ...
        baseline_electricity_179d_value = self.baseline_electricity_model.predict(
            input_array
        )[0][0]
