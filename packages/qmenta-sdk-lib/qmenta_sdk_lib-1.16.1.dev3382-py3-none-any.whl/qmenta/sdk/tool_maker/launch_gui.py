...
def gui_tkinter():
    ...
    window.title("Tool Creator (1.2)")
    # image
    img = ImageTk.PhotoImage(Image.open(os.path.join(os.path.dirname(__file__), "templates_tool_maker", "qmenta.png")))
    image_label = ttk.Label(master=window, image=img)
