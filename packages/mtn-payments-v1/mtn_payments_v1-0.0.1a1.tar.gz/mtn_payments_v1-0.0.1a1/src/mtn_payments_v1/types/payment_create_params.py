...
class PaymentCreateParams(TypedDict, total=False):
    ...
    transaction_type: Required[
        Annotated[Literal["Payment", "Debit", "Transfer", "Refund"], PropertyInfo(alias="transactionType")]
    ]
    ...
    calling_system: Annotated[Literal["ECW", "AYO", "POS", "IVR"], PropertyInfo(alias="callingSystem")]
    ...
    target_system: Annotated[Literal["ECW", "AYO", "EWP", "OCC", "CPG", "CELD"], PropertyInfo(alias="targetSystem")]
