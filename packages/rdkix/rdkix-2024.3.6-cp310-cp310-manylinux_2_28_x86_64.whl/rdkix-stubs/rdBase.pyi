...
import typing
__all__ = ['AttachFileToLog', 'BlockLogs', 'DisableLog', 'EnableLog', 'LogDebugMsg', 'LogErrorMsg', 'LogInfoMsg', 'LogMessage', 'LogStatus', 'LogToCppStreams', 'LogToPythonLogger', 'LogToPythonStderr', 'LogWarningMsg', 'SeedRandomNumberGenerator', 'WrapLogs', 'boostVersion', 'ostream', 'rdkixBuild', 'rdkixVersion', 'std_ostream', 'streambuf']
...
rdkixBuild: str = 'Linux|6.5.0-1025-azure|UNIX|GNU|64-bit'
rdkixVersion: str = '2024.03.6'
