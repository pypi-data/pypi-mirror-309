...
class AtomPairsParameters(Boost.Python.instance):
    ...
    atomTypes: typing.ClassVar[rdkix.rdBase._vectunsigned int]  # value = <rdkix.rdBase._vectunsigned int object at 0x0000022DFC2AD6C0>
...
class Properties(Boost.Python.instance):
    ...
    def RegisterProperty(propertyFunctor: PropertyFunctor) -> int:
        """
            ...
            C++ signature :
                int RegisterProperty(struct RDKix::Descriptors::PropertyFunctor * __ptr64)
        """
    @staticmethod
    def __reduce__(*args, **kwargs):
        ...
