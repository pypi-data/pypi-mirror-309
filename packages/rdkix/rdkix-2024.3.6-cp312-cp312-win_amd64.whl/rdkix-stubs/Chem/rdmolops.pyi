...
class AromaticityModel(Boost.Python.enum):
    ...
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'AROMATICITY_DEFAULT': rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_DEFAULT, 'AROMATICITY_RDKIX': rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_RDKIX, 'AROMATICITY_SIMPLE': rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_SIMPLE, 'AROMATICITY_MDL': rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_MDL, 'AROMATICITY_CUSTOM': rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_CUSTOM}
    values: typing.ClassVar[dict]  # value = {0: rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_DEFAULT, 1: rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_RDKIX, 2: rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_SIMPLE, 4: rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_MDL, 268435455: rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_CUSTOM}
...
def CombineMols(mol1: Mol, mol2: Mol, offset: Point3D = ...) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 CombineMols(class RDKix::ROMol,class RDKix::ROMol [,class RDGeom::Point3D=<rdkix.Geometry.rdGeometry.Point3D object at 0x000001CFB7E35F40>])
    """
...
def molzip(a: Mol, b: Mol, params: MolzipParams = ...) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 molzip(class RDKix::ROMol,class RDKix::ROMol [,struct RDKix::MolzipParams=<rdkix.Chem.rdmolops.MolzipParams object at 0x000001CFB654F480>])
    """
@typing.overload
def molzip(a: Mol, params: MolzipParams = ...) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 molzip(class RDKix::ROMol [,struct RDKix::MolzipParams=<rdkix.Chem.rdmolops.MolzipParams object at 0x000001CFB654F530>])
    """
@typing.overload
def molzip(row: dict, params: MolzipParams = ...) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 molzip(class boost::python::dict [,struct RDKix::MolzipParams=<rdkix.Chem.rdmolops.MolzipParams object at 0x000001CFB654F690>])
    """
def molzipFragments(mols: typing.Any, params: MolzipParams = ...) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 molzipFragments(class boost::python::api::object {lvalue} [,struct RDKix::MolzipParams=<rdkix.Chem.rdmolops.MolzipParams object at 0x000001CFB654F5E0>])
    """
